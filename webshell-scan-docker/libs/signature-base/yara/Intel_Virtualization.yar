...
//===SUCCESS===
rule DarkenCode_Intel_Virtualization_Intel_Virtualization_Wizard_exe {
  meta:
...
//===SUCCESS===
rule DarkenCode_Intel_Virtualization_Intel_Virtualization_Wizard_dll {
  meta:
    author = "cabrel@zerklabs.com"
  ...
  condition:
    ($a and $b) and DarkenCode_Intel_Virtualization_Intel_Virtualization_Wizard_exe
}

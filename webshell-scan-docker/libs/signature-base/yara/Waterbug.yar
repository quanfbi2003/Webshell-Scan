...
//===SUCCESS===
rule DarkenCode_Waterbug_WaterBug_wipbot_2013_core_PDF {
	meta:
...
//===SUCCESS===
rule DarkenCode_Waterbug_WaterBug_wipbot_2013_dll {
	meta:
...
//===SUCCESS===
rule DarkenCode_Waterbug_WaterBug_wipbot_2013_core {
	meta:
...
//===SUCCESS===
rule DarkenCode_Waterbug_WaterBug_turla_dropper {
	meta:
...
//===SUCCESS===
rule DarkenCode_Waterbug_WaterBug_fa_malware { 
	meta: 
...
//===SUCCESS===
rule DarkenCode_Waterbug_WaterBug_sav {
	meta: 

...
rule Neo23x0_gen_loaders_ReflectiveLoader {
   ...
   condition:
      uint16(0) == 0x5a4d and (
            1 of ($x*) or
            pe.exports("Neo23x0_gen_loaders_ReflectiveLoader") or
            pe.exports("_ReflectiveLoader@4") or
            pe.exports("?Neo23x0_gen_loaders_ReflectiveLoader@@YGKPAX@Z")
         )
      and not 1 of ($fp*)
}
   ...
   condition:
      ( uint16(0) == 0x5a4d and
        ...
        (
           ...
           pe.exports("?Neo23x0_gen_loaders_ReflectiveLoader@@YA_KPEAX@Z") or
           ( 1 of ($x*) or 2 of them )
        )
      ) or ( 2 of them )
}

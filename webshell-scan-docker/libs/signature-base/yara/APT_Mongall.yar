...
//===SUCCESS===
rule DarkenCode_APT_Mongall_Backdoor_APT_Mongal
{
meta:
...
//===SUCCESS===
rule DarkenCode_APT_Mongall_MongalCode : Mongal Family 
{
    meta:
...
//===SUCCESS===
rule DarkenCode_APT_Mongall_MongalStrings : Mongal Family
{
    meta:
...
//===SUCCESS===
rule DarkenCode_APT_Mongall_Mongal : Family
{
    meta:
        description = "Mongal"
        author = "Seth Hardy"
    ...
    condition:
        DarkenCode_APT_Mongall_MongalCode or DarkenCode_APT_Mongall_MongalStrings
}

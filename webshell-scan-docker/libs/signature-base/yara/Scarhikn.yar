...
//===SUCCESS===
rule DarkenCode_Scarhikn_ScarhiknStrings : Scarhikn Family
{
    meta:
...
//===SUCCESS===
rule DarkenCode_Scarhikn_ScarhiknCode : Scarhikn Family 
{
    meta:
...
//===SUCCESS===
rule DarkenCode_Scarhikn_Scarhikn : Family
{
    meta:
    ...
    condition:
        DarkenCode_Scarhikn_ScarhiknCode or DarkenCode_Scarhikn_ScarhiknStrings
}

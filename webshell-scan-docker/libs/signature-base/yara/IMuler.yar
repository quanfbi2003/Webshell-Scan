...
//===SUCCESS===
rule DarkenCode_IMuler_IMulerCode : IMuler Family 
{
    meta:
...
//===SUCCESS===
rule DarkenCode_IMuler_IMulerStrings : IMuler Family
{
    meta:
...
//===SUCCESS===
rule DarkenCode_IMuler_IMuler : Family
{
    meta:
        description = "IMuler"
        author = "Seth Hardy"
    ...
    condition:
        DarkenCode_IMuler_IMulerCode or DarkenCode_IMuler_IMulerStrings
}

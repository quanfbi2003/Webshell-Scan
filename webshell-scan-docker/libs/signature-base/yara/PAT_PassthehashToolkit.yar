...
//===SUCCESS===
rule DarkenCode_PAT_PassthehashToolkit_whosthere_alt {
	meta:
...
//===SUCCESS===
rule DarkenCode_PAT_PassthehashToolkit_iam_alt_iam_alt {
	meta:
...
//===SUCCESS===
rule DarkenCode_PAT_PassthehashToolkit_genhash_genhash {
	meta:
...
//===SUCCESS===
rule DarkenCode_PAT_PassthehashToolkit_iam_iamdll {
	meta:
...
//===SUCCESS===
rule DarkenCode_PAT_PassthehashToolkit_iam_iam {
	meta:
...
//===SUCCESS===
rule DarkenCode_PAT_PassthehashToolkit_whosthere_alt_pth {
	meta:
...
//===SUCCESS===
rule DarkenCode_PAT_PassthehashToolkit_whosthere {
	meta:

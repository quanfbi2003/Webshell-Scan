...
rule nsacyber_extended_webshell_detection_SolarWindsArtifacts
{
    ...
    condition:
        nsacyber_extended_webshell_detection_APT_Backdoor_MSIL_SUNBURST_1 
        or nsacyber_extended_webshell_detection_APT_Backdoor_MSIL_SUNBURST_2 
        or nsacyber_extended_webshell_detection_APT_Backdoor_MSIL_SUNBURST_3 
        or nsacyber_extended_webshell_detection_APT_Backdoor_MSIL_SUNBURST_4 
        or nsacyber_extended_webshell_detection_APT_Dropper_Raw64_TEARDROP_1 

...
//===SUCCESS===
rule DarkenCode_APT_c16_apt_c16_win_memory_pcclient
{
  meta:
...
//===SUCCESS===
rule DarkenCode_APT_c16_apt_c16_win_disk_pcclient
{
  meta:
    author = "@dragonthreatlab"
...
//===SUCCESS===
rule DarkenCode_APT_c16_apt_c16_win32_dropper
{
  meta:
    author = "@dragonthreatlab"
...
//===SUCCESS===
rule DarkenCode_APT_c16_apt_c16_win_swisyn
{
  meta:
    author = "@dragonthreatlab"
...
//===SUCCESS===
rule DarkenCode_APT_c16_apt_c16_win_wateringhole
{
  meta:
    author = "@dragonthreatlab"
...
//===SUCCESS===
rule DarkenCode_APT_c16_apt_c16_win64_dropper
{
    meta:
        author      = "@dragonthreatlab"
        date        = "2015/01/11" 

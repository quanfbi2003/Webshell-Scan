...
//===SUCCESS===
rule DarkenCode_APT_Careto_Careto_SGH {
	meta:
...
//===SUCCESS===
rule DarkenCode_APT_Careto_Careto_OSX_SBD {
	meta:
		author = "AlienVault (Alberto Ortega)"
...
//===SUCCESS===
rule DarkenCode_APT_Careto_Careto_CnC {
	meta:
		author = "AlienVault (Alberto Ortega)"
...
//===SUCCESS===
rule DarkenCode_APT_Careto_Careto_CnC_domains {
	meta:
		author = "AlienVault (Alberto Ortega)"

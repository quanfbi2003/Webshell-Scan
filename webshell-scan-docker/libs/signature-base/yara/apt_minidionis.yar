/*
<<<<<<< Updated upstream:libs/signature-base/yara/apt_minidionis.yar
	Yara Rule Set
	Author: Florian Roth
	Date: 2015-07-20
...
//===SUCCESS===
rule DarkenCode_APT_Minidionis_MiniDionis_readerView {
>>>>>>> Stashed changes:webshell-scan-docker/libs/signature-base/yara/apt_minidionis.yar
	meta:
...
=======
//===SUCCESS===
rule DarkenCode_APT_Minidionis_Malicious_SFX1 {
>>>>>>> Stashed changes:webshell-scan-docker/libs/signature-base/yara/apt_minidionis.yar
	meta:
...
=======
//===SUCCESS===
rule DarkenCode_APT_Minidionis_Malicious_SFX2 {
>>>>>>> Stashed changes:webshell-scan-docker/libs/signature-base/yara/apt_minidionis.yar
	meta:
...
=======
//===SUCCESS===
rule DarkenCode_APT_Minidionis_MiniDionis_VBS_Dropped {
>>>>>>> Stashed changes:webshell-scan-docker/libs/signature-base/yara/apt_minidionis.yar
	meta:

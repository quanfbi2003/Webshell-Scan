...
//===SUCCESS===
rule DarkenCode_NSFree_NSFreeCode : NSFree Family 
{
    meta:
...
//===SUCCESS===
rule DarkenCode_NSFree_NSFreeStrings : NSFree Family
{
    meta:
...
//===SUCCESS===
rule DarkenCode_NSFree_NSFree : Family
{
    meta:
        description = "NSFree"
        author = "Seth Hardy"
    ...
    condition:
        DarkenCode_NSFree_NSFreeCode or DarkenCode_NSFree_NSFreeStrings
}

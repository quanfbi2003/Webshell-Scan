<<<<<<< Updated upstream:libs/signature-base/yara/susp_email_redirection_spoofing.yar
...
>>>>>>> Stashed changes:webshell-scan-docker/libs/signature-base/yara/susp_email_redirection_spoofing.yar
   meta:

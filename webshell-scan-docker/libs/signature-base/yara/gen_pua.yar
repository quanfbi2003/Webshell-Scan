<<<<<<< Updated upstream:libs/signature-base/yara/gen_pua.yar
rule WinDivert_Driver {
=======
//===SUCCESS===
rule Neo23x0_gen_pua_WinDivert_Driver {
>>>>>>> Stashed changes:webshell-scan-docker/libs/signature-base/yara/gen_pua.yar
   meta:

...
//===SUCCESS===
rule DarkenCode_Olyx_OlyxCode : Olyx Family 
{
    meta:
...
//===SUCCESS===
rule DarkenCode_Olyx_OlyxStrings : Olyx Family
{
    meta:
...
//===SUCCESS===
rule DarkenCode_Olyx_Olyx : Family
{
    meta:
        description = "Olyx"
        author = "Seth Hardy"
    ...
    condition:
        DarkenCode_Olyx_OlyxCode or DarkenCode_Olyx_OlyxStrings
}

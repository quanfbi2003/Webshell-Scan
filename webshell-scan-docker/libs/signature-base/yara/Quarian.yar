...
//===SUCCESS===
rule DarkenCode_Quarian_QuarianStrings : Quarian Family
{
    meta:
...
//===SUCCESS===
rule DarkenCode_Quarian_QuarianCode : Quarian Family 
{
    meta:
...
//===SUCCESS===
rule DarkenCode_Quarian_Quarian : Family
{
    meta:
        description = "Quarian"
        author = "Seth Hardy"
    ...
    condition:
        DarkenCode_Quarian_QuarianCode or DarkenCode_Quarian_QuarianStrings
}

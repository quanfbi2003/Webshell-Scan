...
<<<<<<< Updated upstream:libs/signature-base/yara/apt_cmstar.yar
...
//===SUCCESS===
rule Neo23x0_apt_cmstar_CMStar_Malware_Sep17 {
>>>>>>> Stashed changes:webshell-scan-docker/libs/signature-base/yara/apt_cmstar.yar
   meta:

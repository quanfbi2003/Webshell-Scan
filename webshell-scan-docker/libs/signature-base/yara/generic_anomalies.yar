...
// whitelist-approach failed : reworked in Neo23x0_generic_anomalies_SUSP_Known_Type_Cloaked_as_JPG
...
//===SUCCESS===
rule Neo23x0_generic_anomalies_SUSP_Known_Type_Cloaked_as_JPG {
   meta:
...
*/
//===SUCCESS===
rule Neo23x0_generic_anomalies_Suspicious_Size_explorer_exe {
   meta:
...
//===SUCCESS===
rule Neo23x0_generic_anomalies_Suspicious_Size_chrome_exe {
   meta:
...
//===SUCCESS===
rule Neo23x0_generic_anomalies_Suspicious_Size_csrss_exe {
   meta:
...
//===SUCCESS===
rule Neo23x0_generic_anomalies_Suspicious_Size_iexplore_exe {
   meta:
...
//===SUCCESS===
rule Neo23x0_generic_anomalies_Suspicious_Size_firefox_exe {
   meta:
...
//===SUCCESS===
rule Neo23x0_generic_anomalies_Suspicious_Size_java_exe {
   meta:
...
//===SUCCESS===
rule Neo23x0_generic_anomalies_Suspicious_Size_lsass_exe {
   meta:
...
//===SUCCESS===
rule Neo23x0_generic_anomalies_Suspicious_Size_svchost_exe {
   meta:
...
//===SUCCESS===
rule Neo23x0_generic_anomalies_Suspicious_Size_winlogon_exe {
   meta:
...
//===SUCCESS===
rule Neo23x0_generic_anomalies_Suspicious_Size_igfxhk_exe {
   meta:
...
//===SUCCESS===
rule Neo23x0_generic_anomalies_Suspicious_Size_servicehost_dll {
   meta:
...
//===SUCCESS===
rule Neo23x0_generic_anomalies_Suspicious_Size_rundll32_exe {
   meta:
...
//===SUCCESS===
rule Neo23x0_generic_anomalies_Suspicious_Size_taskhost_exe {
   meta:
...
//===SUCCESS===
rule Neo23x0_generic_anomalies_Suspicious_Size_spoolsv_exe {
   meta:
...
//===SUCCESS===
rule Neo23x0_generic_anomalies_Suspicious_Size_smss_exe {
   meta:
...
//===SUCCESS===
rule Neo23x0_generic_anomalies_Suspicious_Size_wininit_exe {
   meta:
...
//===SUCCESS===
rule Neo23x0_generic_anomalies_Suspicious_AutoIt_by_Microsoft {
   meta:
...
//===SUCCESS===
rule Neo23x0_generic_anomalies_SUSP_Size_of_ASUS_TuningTool {
   meta:
...
//===SUCCESS===
rule Neo23x0_generic_anomalies_SUSP_PiratedOffice_2007 {
   meta:
...
//===SUCCESS===
rule Neo23x0_generic_anomalies_SUSP_Scheduled_Task_BigSize {
   meta:
...
//===SUCCESS===
rule Neo23x0_generic_anomalies_SUSP_Putty_Unnormal_Size {
   meta:
...
//===SUCCESS===
rule Neo23x0_generic_anomalies_SUSP_RTF_Header_Anomaly {
   meta:
...
//===SUCCESS===
rule Neo23x0_generic_anomalies_WEBSHELL_ASPX_ProxyShell_Aug21_1 {
   meta:

...
//===SUCCESS===
rule DarkenCode_APT_Terracota_Apolmy_Privesc_Trojan {
	meta:
...
//===SUCCESS===
rule DarkenCode_APT_Terracota_Mithozhan_Trojan {
	meta:
...
//===SUCCESS===
rule DarkenCode_APT_Terracota_RemoteExec_Tool {
	meta:
...
/* Super Rules ------------------------------------------------------------- */
//===SUCCESS===
rule DarkenCode_APT_Terracota_LiuDoor_Malware_1 {
	meta:
...
//===SUCCESS===
rule DarkenCode_APT_Terracota_LiuDoor_Malware_2 {
	meta:
		description = "Liudoor Trojan used in Terracotta APT"
		author = "Florian Roth"
		reference = "https://blogs.rsa.com/terracotta-vpn-enabler-of-advanced-threat-anonymity/"

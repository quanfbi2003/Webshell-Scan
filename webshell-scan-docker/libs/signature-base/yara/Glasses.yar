...
//===SUCCESS===
rule DarkenCode_Glasses_GlassesCode : Glasses Family 
{
    meta:
...
//===SUCCESS===
rule DarkenCode_Glasses_GlassesStrings : Glasses Family
{
    meta:
...
//===SUCCESS===
rule DarkenCode_Glasses_Glasses : Family
{
    meta:
    ...
    condition:
        DarkenCode_Glasses_GlassesCode or DarkenCode_Glasses_GlassesStrings

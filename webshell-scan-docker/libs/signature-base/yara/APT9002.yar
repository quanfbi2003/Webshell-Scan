...
//===SUCCESS===
rule DarkenCode_APT9002_APT9002Code : APT9002 Family 
{
    meta:
...
//===SUCCESS===
rule DarkenCode_APT9002_APT9002Strings : APT9002 Family
{
    meta:
...
//===SUCCESS===
rule DarkenCode_APT9002_APT9002 : Family
{
    meta:
        description = "9002"
        author = "Seth Hardy"
    ...
    condition:
        DarkenCode_APT9002_APT9002Code or DarkenCode_APT9002_APT9002Strings
}
//===SUCCESS===
rule DarkenCode_APT9002_FE_APT_9002 : RAT
{
    meta:
        Author      = "FireEye Labs"
        Date        = "2013/11/10"

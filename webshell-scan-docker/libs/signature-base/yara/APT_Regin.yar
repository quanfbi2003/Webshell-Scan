...
//===SUCCESS===
rule DarkenCode_APT_Regin_Regin_APT_KernelDriver_Generic_A {
	meta:
...
//===SUCCESS===
rule DarkenCode_APT_Regin_Regin_APT_KernelDriver_Generic_B {
	meta:
		description = "Generic rule for Regin APT kernel driver Malware - Symantec http://t.co/qu53359Cb2"
		author = "@Malwrsignatures - included in APT Scanner THOR"
		date = "23.11.14"
...
//===SUCCESS===
rule DarkenCode_APT_Regin_Regin_APT_KernelDriver_Generic_C {
	meta:
		description = "Generic rule for Regin APT kernel driver Malware - Symantec http://t.co/qu53359Cb2"
		author = "@Malwrsignatures - included in APT Scanner THOR"
		date = "23.11.14"
...
/* Update 27.11.14 */
//===SUCCESS===
rule DarkenCode_APT_Regin_Regin_sig_svcsstat {
	meta:
...
//===SUCCESS===
rule DarkenCode_APT_Regin_Regin_Sample_1 {
	meta:
...
//===SUCCESS===
rule DarkenCode_APT_Regin_Regin_Sample_2 {
	meta:
...
//===SUCCESS===
rule DarkenCode_APT_Regin_Regin_Sample_3 {
	meta:
...
//===SUCCESS===
rule DarkenCode_APT_Regin_Regin_Sample_Set_1 {
	meta:
...
//===SUCCESS===
rule DarkenCode_APT_Regin_Regin_Sample_Set_2 {
	meta:
...
//===SUCCESS===
rule DarkenCode_APT_Regin_apt_regin_legspin {
	meta:
...
//===SUCCESS===
rule DarkenCode_APT_Regin_apt_regin_hopscotch {
	meta:
	    copyright = "Kaspersky Lab"
...
//===SUCCESS===
rule DarkenCode_APT_Regin_apt_regin_2011_32bit_stage1 {
meta:
copyright = "Kaspersky Lab"
...
//===SUCCESS===
rule DarkenCode_APT_Regin_apt_regin_rc5key {
meta:
copyright = "Kaspersky Lab"
...
//===SUCCESS===
rule DarkenCode_APT_Regin_apt_regin_vfs {
meta:
	copyright = "Kaspersky Lab"
...
//===SUCCESS===
rule DarkenCode_APT_Regin_apt_regin_dispatcher_disp_dll {
...
//===SUCCESS===
rule DarkenCode_APT_Regin_apt_regin_2013_64bit_stage1 {
meta:
copyright = "Kaspersky Lab"

...
//===SUCCESS===
rule DarkenCode_APT_Hellsing_apt_hellsing_implantstrings : PE
{ 
	meta:
...
//===SUCCESS===
rule DarkenCode_APT_Hellsing_apt_hellsing_installer : PE
{
	meta:
		Author		= "Costin Raiu, Kaspersky Lab"
		Date		= "2015-04-07"
...
//===SUCCESS===
rule DarkenCode_APT_Hellsing_apt_hellsing_proxytool : PE
{
	meta:
		Author		= "Costin Raiu, Kaspersky Lab"
		Date		= "2015-04-07"
...
//===SUCCESS===
rule DarkenCode_APT_Hellsing_apt_hellsing_xkat : PE
{
	meta:
		Author		= "Costin Raiu, Kaspersky Lab"
		Date		= "2015-04-07"
...
//===SUCCESS===
rule DarkenCode_APT_Hellsing_apt_hellsing_msgertype2 : PE
{
	meta:
		Author		= "Costin Raiu, Kaspersky Lab"
		Date		= "2015-04-07"
...
//===SUCCESS===
rule DarkenCode_APT_Hellsing_apt_hellsing_irene : PE
{
	meta:
		Author		= "Costin Raiu, Kaspersky Lab"
		Date		= "2015-04-07"

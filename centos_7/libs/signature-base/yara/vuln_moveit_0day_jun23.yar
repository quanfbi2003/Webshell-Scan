...
rule Neo23x0_vul_WEBSHELL_ASPX_DLL_MOVEit_Jun23_1 {
   meta:
...
rule Neo23x0_vul_WEBSHELL_ASPX_MOVEit_Jun23_1 {
   meta:
...
rule Neo23x0_vul_LOG_EXPL_MOVEit_Exploitation_Indicator_Jun23_1 {
   meta:
...
rule Neo23x0_vul_LOG_EXPL_MOVEit_Exploitation_Indicator_Jun23_2 {
   meta:
      description = "Detects a potential compromise indicator found in MOVEit Transfer logs"
      author = "Florian Roth"
      reference = "https://www.huntress.com/blog/moveit-transfer-critical-vulnerability-rapid-response"
...
rule Neo23x0_vul_LOG_EXPL_MOVEit_Exploitation_Indicator_Jun23_3 {
   meta:

...
rule Neo23x0_apt_IronPanda_DNSTunClient {
	meta:
...
rule Neo23x0_apt_IronPanda_Malware1 {
	meta:
...
rule Neo23x0_apt_IronPanda_Webshell_JSP {
	meta:
...
rule Neo23x0_apt_IronPanda_Malware_Htran {
	meta:
...
rule Neo23x0_apt_IronPanda_Malware2 {
	meta:
		description = "Iron Panda Malware"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_IronPanda_Malware3 {
	meta:
		description = "Iron Panda Malware"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_IronPanda_Malware4 {
	meta:
		description = "Iron Panda Malware"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"

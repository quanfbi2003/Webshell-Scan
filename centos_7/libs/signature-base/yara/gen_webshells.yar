...
rule Neo23x0_gen_WEBSHELL_PHP_Generic_Callback
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_PHP_Base64_Encoded_Payloads : FILE {
    meta:
...
rule Neo23x0_gen_WEBSHELL_PHP_Unknown_1
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_PHP_Generic_Eval
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_PHP_Double_Eval_Tiny
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_PHP_OBFUSC
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_PHP_OBFUSC_Encoded
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_PHP_OBFUSC_Encoded_Mixed_Dec_And_Hex
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_PHP_OBFUSC_Tiny
{
    meta:
        description = "PHP webshell obfuscated"
        license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
...
rule Neo23x0_gen_WEBSHELL_PHP_OBFUSC_Str_Replace
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_PHP_OBFUSC_Fopo
{
    meta:
        description = "PHP webshell which eval()s obfuscated string"
        license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
...
rule Neo23x0_gen_WEBSHELL_PHP_Gzinflated
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_PHP_OBFUSC_3
{
    meta:
        description = "PHP webshell which eval()s obfuscated string"
        license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
...
rule Neo23x0_gen_WEBSHELL_PHP_Includer_Eval
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_PHP_Includer_Tiny
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_PHP_Dynamic
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_PHP_Dynamic_Big
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_PHP_Generic_Backticks
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_PHP_Generic_Backticks_OBFUSC
{
    meta:
        description = "Generic PHP webshell which uses backticks directly on user input"
        license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
...
rule Neo23x0_gen_WEBSHELL_PHP_By_String_Known_Webshell
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_PHP_Strings_SUSP
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_PHP_In_Htaccess
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_PHP_Function_Via_Get
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_PHP_Writer
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_ASP_Writer
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_ASP_OBFUSC
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_ASP_Generic_Eval_On_Input
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_ASP_Nano
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_ASP_Encoded
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_ASP_Encoded_AspCoding
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_ASP_By_String
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_ASP_Sniffer
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_ASP_Generic_Tiny
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_ASP_Generic : FILE {
    meta:
...
rule Neo23x0_gen_WEBSHELL_ASP_Generic_Registry_Reader
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_ASPX_Regeorg_CSHARP
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_CSHARP_Generic
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_ASP_Runtime_Compile : FILE {
    meta:
...
rule Neo23x0_gen_WEBSHELL_ASP_SQL
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_ASP_Scan_Writable
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_JSP_ReGeorg
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_JSP_HTTP_Proxy
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_JSP_Writer_Nano
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_JSP_Generic_Base64
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_JSP_Generic_ProcessBuilder
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_JSP_Generic_Reflection
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_JSP_Generic_Classloader
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_JSP_Generic_Encoded_Shell
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_JSP_NetSpy
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_JSP_By_String
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_JSP_Input_Upload_Write
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_Generic_OS_Strings : FILE {
    meta:
...
rule Neo23x0_gen_WEBSHELL_In_Image
{
    meta:
...
rule Neo23x0_gen_WEBSHELL_Mixed_OBFUSC {
   meta:
...
rule Neo23x0_gen_WEBSHELL_Cookie_Post_Obfuscation {
    meta:

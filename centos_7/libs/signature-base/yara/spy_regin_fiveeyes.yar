...
rule Neo23x0_spy_Regin_APT_KernelDriver_Generic_A {
	meta:
...
rule Neo23x0_spy_Regin_APT_KernelDriver_Generic_B {
	meta:
		description = "Generic rule for Regin APT kernel driver Malware - Symantec http://t.co/qu53359Cb2"
		author = "@Malwrsignatures - included in APT Scanner THOR"
		date = "23.11.14"
...
rule Neo23x0_spy_Regin_APT_KernelDriver_Generic_C {
	meta:
		description = "Generic rule for Regin APT kernel driver Malware - Symantec http://t.co/qu53359Cb2"
		author = "@Malwrsignatures - included in APT Scanner THOR"
		date = "23.11.14"
...
rule Neo23x0_spy_Regin_sig_svcsstat {
	meta:
...
rule Neo23x0_spy_Regin_Sample_1 {
   meta:
...
rule Neo23x0_spy_Regin_Sample_2 {
	meta:
...
rule Neo23x0_spy_Regin_Sample_3 {
	meta:
...
rule Neo23x0_spy_Regin_Sample_Set_2 {
	meta:
...
rule Neo23x0_spy_Regin_Sample_Set_1 {
	meta:
...
rule Neo23x0_spy_apt_regin_legspin {
	meta:
...
rule Neo23x0_spy_apt_regin_hopscotch {
	meta:
	    copyright = "Kaspersky Lab"
...
rule Neo23x0_spy_Regin_Related_Malware {
	meta:

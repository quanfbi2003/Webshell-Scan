...
rule Neo23x0_cri_Fireball_de_svr {
   meta:
...
rule Neo23x0_cri_Fireball_lancer {
   meta:
...
rule Neo23x0_cri_Fireball_regkey {
   meta:
...
rule Neo23x0_cri_Fireball_winsap {
   meta:
...
rule Neo23x0_cri_Fireball_archer {
   meta:
...
rule Neo23x0_cri_Fireball_gubed {
   meta:

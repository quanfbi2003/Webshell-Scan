...
rule DarkenCode_Equ_apt_equation_exploitlib_mutexes {
    meta:
...
rule DarkenCode_Equ_apt_equation_doublefantasy_genericresource {
    meta:
        copyright = "Kaspersky Lab"
...
rule DarkenCode_Equ_apt_equation_equationlaser_runtimeclasses {
	meta:
	    copyright = "Kaspersky Lab"
...
rule DarkenCode_Equ_apt_equation_cryptotable {
	meta:
	    copyright = "Kaspersky Lab"
...
rule DarkenCode_Equ_Equation_Kaspersky_TripleFantasy_1 {
	meta:
...
rule DarkenCode_Equ_Equation_Kaspersky_DoubleFantasy_1 {
	meta:
...
rule DarkenCode_Equ_Equation_Kaspersky_GROK_Keylogger {
	meta:
...
rule DarkenCode_Equ_Equation_Kaspersky_GreyFishInstaller {
	meta:
...
rule DarkenCode_Equ_Equation_Kaspersky_EquationDrugInstaller {
	meta:
...
rule DarkenCode_Equ_Equation_Kaspersky_EquationLaserInstaller {
	meta:
...
rule DarkenCode_Equ_Equation_Kaspersky_FannyWorm {
	meta:
...
rule DarkenCode_Equ_Equation_Kaspersky_HDD_reprogramming_module {
	meta:
...
rule DarkenCode_Equ_Equation_Kaspersky_EOP_Package {
	meta:
...
rule DarkenCode_Equ_Equation_Kaspersky_TripleFantasy_Loader {
	meta:
...
rule DarkenCode_Equ_Equation_Kaspersky_SuspiciousString {
	meta:
...
rule DarkenCode_Equ_EquationDrug_NetworkSniffer1 {
	meta:
...
rule DarkenCode_Equ_EquationDrug_CompatLayer_UnilayDLL {
	meta:
...
rule DarkenCode_Equ_EquationDrug_HDDSSD_Op {
	meta:
...
rule DarkenCode_Equ_EquationDrug_NetworkSniffer2 {
	meta:
...
rule DarkenCode_Equ_EquationDrug_NetworkSniffer3 {
	meta:
		description = "EquationDrug - Network Sniffer - tdip.sys"
		author = "Florian Roth @4nc4p"
		reference = "http://securelist.com/blog/research/69203/inside-the-equationdrug-espionage-platform/"
...
rule DarkenCode_Equ_EquationDrug_VolRec_Driver {
	meta:
...
rule DarkenCode_Equ_EquationDrug_KernelRootkit {
	meta:
...
rule DarkenCode_Equ_EquationDrug_Keylogger {
	meta:
...
rule DarkenCode_Equ_EquationDrug_NetworkSniffer4 {
	meta:
...
rule DarkenCode_Equ_EquationDrug_PlatformOrchestrator {
	meta:
...
rule DarkenCode_Equ_EquationDrug_NetworkSniffer5 {
	meta:
		description = "EquationDrug - Network-sniffer/patcher - atmdkdrv.sys"
		author = "Florian Roth @4nc4p"
		reference = "http://securelist.com/blog/research/69203/inside-the-equationdrug-espionage-platform/"
...
rule DarkenCode_Equ_EquationDrug_FileSystem_Filter {
	meta:

...
rule Neo23x0_mal_MAL_RANSOM_SH_ESXi_Attacks_Feb23_1 {
   meta:
...
rule Neo23x0_mal_MAL_RANSOM_ELF_ESXi_Attacks_Feb23_1 {
   meta:
...
rule Neo23x0_mal_APT_PY_ESXi_Backdoor_Dec22 {
   meta:
...
rule Neo23x0_mal_APT_SH_ESXi_Backdoor_Dec22 {
   meta:
...
rule Neo23x0_mal_MAL_RANSOM_SH_ESXi_Attacks_Feb23_2 {
   meta:
...
rule Neo23x0_mal_SUSP_ESXiArgs_Endpoint_Conf_Aug23 {
   meta:

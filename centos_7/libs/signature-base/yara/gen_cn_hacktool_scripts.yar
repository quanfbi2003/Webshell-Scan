...
rule Neo23x0_gen_CN_Tools_xbat {
    meta:
...
rule Neo23x0_gen_CN_Tools_Temp {
    meta:
...
rule Neo23x0_gen_CN_Tools_srss {
    meta:
...
rule Neo23x0_gen_sql1433_creck {
    meta:
...
rule Neo23x0_gen_sql1433_Start {
    meta:

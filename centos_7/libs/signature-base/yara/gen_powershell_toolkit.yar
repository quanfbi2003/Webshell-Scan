...
rule Neo23x0_gen_ps1_toolkit_PowerUp {
	meta:
...
rule Neo23x0_gen_ps1_toolkit_Inveigh_BruteForce {
	meta:
...
rule Neo23x0_gen_ps1_toolkit_Invoke_Shellcode {
	meta:
...
rule Neo23x0_gen_ps1_toolkit_Invoke_Mimikatz {
	meta:
...
rule Neo23x0_gen_ps1_toolkit_Invoke_RelfectivePEInjection {
	meta:
...
rule Neo23x0_gen_ps1_toolkit_Persistence {
	meta:
...
rule Neo23x0_gen_ps1_toolkit_Invoke_Mimikatz_RelfectivePEInjection {
	meta:
...
rule Neo23x0_gen_ps1_toolkit_Inveigh_BruteForce_2 {
	meta:
...
rule Neo23x0_gen_ps1_toolkit_PowerUp_2 {
	meta:
...
rule Neo23x0_gen_ps1_toolkit_Persistence_2 {
	meta:
...
rule Neo23x0_gen_ps1_toolkit_Inveigh_BruteForce_3 {
	meta:
		description = "Auto-generated rule - from files Inveigh-BruteForce.ps1"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"

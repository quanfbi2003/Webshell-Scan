...
rule DarkenCode_POS_blackpos_v2
{
meta:
...
rule DarkenCode_POS_regexpr_pos
{
meta:
	author = "@patrickrolsen"
...
rule DarkenCode_POS_monitor_tool_pos
{
meta:
	author = "@patrickrolsen"
...
rule DarkenCode_POS_keyfinder_tool
{
meta:
	author = "@patrickrolsen"
...
rule DarkenCode_POS_memdump_diablo
{
meta:
	author = "@patrickrolsen"
...
rule DarkenCode_POS_blazingtools
{
meta:
	author = "@patrickrolsen"
...
rule DarkenCode_POS_lacy_keylogger
{
meta:
	author = "@patrickrolsen"
...
rule DarkenCode_POS_searchinject
{
meta:
	author = "@patrickrolsen"
...
rule DarkenCode_POS_heistenberg_pos
{
meta:
	author = "@patrickrolsen"
	reference = "POS Malware"
...
rule DarkenCode_POS_pos_memory_scrapper_
{
meta:
	author = "@patrickrolsen"
...
rule DarkenCode_POS_pos_malwre_dexter_stardust
{
meta:
	author = "@patrickrolsen"
...
rule DarkenCode_POS_pos_malware_project_hook
{
meta:
	author = "@patrickrolsen"
...
rule DarkenCode_POS_pdb_strings_Rescator
{
meta:
	author = "@patrickrolsen"
...
rule DarkenCode_POS_pos_uploader
{
meta:
	author = "@patrickrolsen"
	maltype = "Point of Sale (POS) Malware"
...
rule DarkenCode_POS_winxml_dll
{
meta:
	author = "@patrickrolsen"
	maltype = "Point of Sale (POS) Malware"
...
rule DarkenCode_POS_pos_chewbacca
{
meta:
	author = "@patrickrolsen"
	maltype = "Point of Sale (POS) Malware"

...
rule Neo23x0_apt_StuxNet_Malware_1 {
	meta:
...
rule Neo23x0_apt_Stuxnet_Malware_2 {
	meta:
...
rule Neo23x0_apt_Stuxnet_Shortcut_to {
	meta:
...
rule Neo23x0_apt_Stuxnet_Malware_3 {
	meta:
...
rule Neo23x0_apt_Stuxnet_Malware_4 {
	meta:
		description = "Stuxnet Sample"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_Stuxnet_maindll_decrypted_unpacked {
	meta:
...
rule Neo23x0_apt_Stuxnet_s7hkimdb {
	meta:

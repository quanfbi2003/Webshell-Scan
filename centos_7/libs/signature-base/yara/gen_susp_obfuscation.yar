...
rule Neo23x0_gen_SUSP_Base64_Encoded_Hex_Encoded_Code {
   meta:
...
rule Neo23x0_gen_SUSP_Double_Base64_Encoded_Executable {
   meta:
...
rule Neo23x0_gen_SUSP_Reversed_Base64_Encoded_EXE : FILE {
   meta:
...
rule Neo23x0_gen_SUSP_Script_Base64_Blocks_Jun20_1 {
   meta:
...
rule Neo23x0_gen_SUSP_Reversed_Hacktool_Author : FILE {
   meta:
...
rule Neo23x0_gen_SUSP_Base64_Encoded_Hacktool_Dev {
   meta:

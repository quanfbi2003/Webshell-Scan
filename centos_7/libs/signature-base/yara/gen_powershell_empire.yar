...
rule Neo23x0_gen_Empire_Invoke_BypassUAC {
	meta:
...
rule Neo23x0_gen_Empire_lib_modules_trollsploit_message {
	meta:
...
rule Neo23x0_gen_Empire_Persistence {
	meta:
...
rule Neo23x0_gen_Empire_portscan {
	meta:
...
rule Neo23x0_gen_Empire_Invoke_Shellcode {
	meta:
...
rule Neo23x0_gen_Empire_Invoke_Mimikatz {
	meta:
...
rule Neo23x0_gen_Empire_lib_modules_credentials_mimikatz_pth {
	meta:
...
rule Neo23x0_gen_Empire_Write_HijackDll {
	meta:
...
rule Neo23x0_gen_Empire_skeleton_key {
	meta:
...
rule Neo23x0_gen_Empire_invoke_wmi {
	meta:

...
rule Neo23x0_apt_WEBSHELL_ASP_Embedded_Mar21_1 {
   meta:
...
rule Neo23x0_apt_APT_WEBSHELL_HAFNIUM_SecChecker_Mar21_1 {
   meta:
...
rule Neo23x0_apt_APT_HAFNIUM_Forensic_Artefacts_Mar21_1 {
   meta:
...
rule Neo23x0_apt_APT_WEBSHELL_HAFNIUM_Chopper_WebShell: APT Hafnium WebShell {
   meta:
...
rule Neo23x0_apt_APT_WEBSHELL_Tiny_WebShell : APT Hafnium WebShell {
   meta:
...
rule Neo23x0_apt_HKTL_PS1_PowerCat_Mar21 {
   meta:
...
rule Neo23x0_apt_HKTL_Nishang_PS1_Invoke_PowerShellTcpOneLine {
   meta:
...
rule Neo23x0_apt_WEBSHELL_ASPX_SimpleSeeSharp : Webshell Unclassified {
   meta:
...
rule Neo23x0_apt_WEBSHELL_ASPX_reGeorgTunnel : Webshell Commodity {
   meta:
      author = "threatintel@volexity.com"
      date = "2021-03-01"
...
rule Neo23x0_apt_WEBSHELL_ASPX_SportsBall {
   meta:
      author = "threatintel@volexity.com"
      date = "2021-03-01"
...
rule Neo23x0_apt_WEBSHELL_CVE_2021_27065_Webshells {
   meta:
...
rule Neo23x0_apt_APT_MAL_ASPX_HAFNIUM_Chopper_Mar21_3 {
   meta:
...
rule Neo23x0_apt_APT_MAL_ASPX_HAFNIUM_Chopper_Mar21_4 {
   meta:
      description = "Detects HAFNIUM ASPX files dropped on compromised servers"
      author = "Florian Roth (Nextron Systems)"
      reference = "https://www.microsoft.com/security/blog/2021/03/02/hafnium-targeting-exchange-servers/"
...
rule Neo23x0_apt_APT_HAFNIUM_ForensicArtefacts_WER_Mar21_1 {
   meta:
...
rule Neo23x0_apt_APT_HAFNIUM_ForensicArtefacts_Cab_Recon_Mar21_1 {
   meta:
...
rule Neo23x0_apt_WEBSHELL_Compiled_Webshell_Mar2021_1 {
   meta:
...
rule Neo23x0_apt_APT_MAL_ASP_DLL_HAFNIUM_Mar21_1 {
   meta:
...
rule Neo23x0_apt_WEBSHELL_HAFNIUM_CISA_10328929_01 : trojan webshell exploit CVE_2021_27065 {
   meta:
...
rule Neo23x0_apt_WEBSHELL_HAFNIUM_CISA_10328929_02 : trojan webshell exploit CVE_2021_27065 {
   meta:
       author = "CISA Code & Media Analysis"
       date = "2021-03-17"
...
rule Neo23x0_apt_WEBSHELL_ASPX_FileExplorer_Mar21_1 {
   meta:
...
rule Neo23x0_apt_WEBSHELL_ASPX_Chopper_Like_Mar21_1 {
   meta:
      description = "Detects Chopper like ASPX Webshells"
      author = "Florian Roth (Nextron Systems)"
      reference = "Internal Research"

...
rule Neo23x0_apt_GRIZZLY_STEPPE_Malware_1 {
   meta:
...
rule Neo23x0_apt_GRIZZLY_STEPPE_Malware_2 {
   meta:
...
rule Neo23x0_apt_PAS_TOOL_PHP_WEB_KIT_mod {
   meta:
...
rule Neo23x0_apt_WebShell_PHP_Web_Kit_v3 {
   meta:
      description = "Detects PAS Tool PHP Web Kit"
...
rule Neo23x0_apt_WebShell_PHP_Web_Kit_v4 {
   meta:
      description = "Detects PAS Tool PHP Web Kit"
      reference = "https://github.com/wordfence/grizzly"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
...
rule Neo23x0_apt_APT_APT29_wellmess_dotnet_unique_strings {
   meta:
...
rule Neo23x0_apt_APT_APT29_sorefang_encryption_key_schedule { 
   meta:
...
rule Neo23x0_apt_APT_APT29_sorefang_encryption_key_2b62 {
  meta:
...
rule Neo23x0_apt_APT_APT29_sorefang_directory_enumeration_output_strings { 
   meta:
...
rule Neo23x0_apt_APT_APT29_sorefang_command_elem_cookie_ga_boundary_string { 
   meta:
...
rule Neo23x0_apt_APT_APT29_sorefang_encryption_round_function { 
   meta:
...
rule Neo23x0_apt_APT_APT29_sorefang_add_random_commas_spaces { 
   meta:
...
rule Neo23x0_apt_APT_APT29_sorefang_modify_alphabet_custom_encode { 
   meta:
...
rule Neo23x0_apt_APT_APT29_sorefang_custom_encode_decode {
   meta:
...
rule Neo23x0_apt_APT_APT29_sorefang_remove_chars_comma_space_dot { 
   meta:
...
rule Neo23x0_apt_APT_APT29_sorefang_disk_enumeration_strings { 
   meta:

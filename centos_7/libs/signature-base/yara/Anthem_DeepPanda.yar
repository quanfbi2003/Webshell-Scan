...
rule DarkenCode_Ant_Anthem_DeepPanda_sl_txt_packed {
	meta:
...
rule DarkenCode_Ant_Anthem_DeepPanda_lot1 {
	meta:
...
rule DarkenCode_Ant_Anthem_DeepPanda_htran_exe {
	meta:
...
rule DarkenCode_Ant_Anthem_DeepPanda_Trojan_Kakfum {
	meta:

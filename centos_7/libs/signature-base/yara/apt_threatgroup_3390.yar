...
rule DarkenCode_APT_HttpBrowser_RAT_dropper_Gen1 {
	meta:
...
rule DarkenCode_APT_HttpBrowser_RAT_Sample1 {
	meta:
...
rule DarkenCode_APT_HttpBrowser_RAT_Sample2 {
	meta:
...
rule DarkenCode_APT_HttpBrowser_RAT_Gen {
	meta:
...
rule DarkenCode_APT_PlugX_NvSmartMax_Gen {
	meta:
...
rule DarkenCode_APT_HttpBrowser_RAT_dropper_Gen2 {
	meta:
		description = "Threat Group 3390 APT Sample - HttpBrowser RAT Dropper"
		author = "Florian Roth"
		reference = "http://snip.ly/giNB"
...
rule DarkenCode_APT_ThreatGroup3390_Strings {
	meta:
...
rule DarkenCode_APT_ThreatGroup3390_C2 {
	meta:

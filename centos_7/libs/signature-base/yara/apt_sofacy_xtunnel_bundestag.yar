...
rule DarkenCode_APT_apt_sofacy_xtunnel {
    meta:
...
rule DarkenCode_APT_Sofacy_Bundestag_Winexe {
    meta:
...
rule DarkenCode_APT_Sofacy_Bundestag_Mal2 {
    meta:
...
rule DarkenCode_APT_Sofacy_Bundestag_Mal3 {
    meta:
...
rule DarkenCode_APT_Sofacy_Bundestag_Batch {
    meta:

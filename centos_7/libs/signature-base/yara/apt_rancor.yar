...
rule Neo23x0_apt_APT_RANCOR_JS_Malware {
   meta:
...
rule Neo23x0_apt_APT_RANCOR_PLAINTEE_Variant {
   meta:
...
rule Neo23x0_apt_APT_RANCOR_PLAINTEE_Malware_Exports {
   meta:
      description = "Detects PLAINTEE malware"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_APT_RANCOR_DDKONG_Malware_Exports {
   meta:

...
rule Neo23x0_cri_Mirai_Botnet_Malware {
	meta:
...
rule Neo23x0_cri_Mirai_1_May17 {
   meta:
...
rule Neo23x0_cri_Miari_2_May17 {
   meta:
      description = "Detects Mirai Malware"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_cri_MAL_ELF_LNX_Mirai_Oct10_1 {
   meta:
...
rule Neo23x0_cri_MAL_ELF_LNX_Mirai_Oct10_2 {
   meta:
...
rule Neo23x0_cri_MAL_Mirai_Nov19_1 {
   meta:
      description = "Detects Mirai malware"
      author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_cri_MAL_ARM_LNX_Mirai_Mar13_2022 {
   meta:

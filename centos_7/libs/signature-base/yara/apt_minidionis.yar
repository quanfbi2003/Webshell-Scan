...
rule DarkenCode_APT_MiniDionis_readerView {
	meta:
...
rule DarkenCode_APT_Malicious_SFX1 {
	meta:
...
rule DarkenCode_APT_Malicious_SFX2 {
	meta:
...
rule DarkenCode_APT_MiniDionis_VBS_Dropped {
	meta:

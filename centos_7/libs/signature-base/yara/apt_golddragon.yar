...
rule Neo23x0_apt_GoldDragon_malware_Feb18_1 {
   meta:
...
rule Neo23x0_apt_GoldDragon_Aux_File {
   meta:
...
rule Neo23x0_apt_GoldDragon_Ghost419_RAT {
   meta:
...
rule Neo23x0_apt_GoldDragon_RunningRAT {
   meta:
...
rule Neo23x0_apt_GoldDragon_RunnignRAT {
   meta:

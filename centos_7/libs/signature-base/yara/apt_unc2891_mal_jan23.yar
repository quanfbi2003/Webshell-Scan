...
rule Neo23x0_apt_MAL_UNC2891_Caketap {
   meta:
...
rule Neo23x0_apt_MAL_UNC2891_Slapstick {
   meta:
...
rule Neo23x0_apt_MAL_UNC2891_Steelcorgi {
   meta:
...
rule Neo23x0_apt_MAL_UNC2891_Winghook {
   meta:

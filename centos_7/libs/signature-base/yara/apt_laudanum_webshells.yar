...
rule DarkenCode_APT_php_killnc {
	meta:
...
rule DarkenCode_APT_aspx_shell {
	meta:
...
rule DarkenCode_APT_php_reverse_shell {
	meta:
...
rule DarkenCode_APT_WEB_INF_web {
	meta:
...
rule DarkenCode_APT_warfiles_cmd {
	meta:
...
rule DarkenCode_APT_php_reverse_shell_2 {
	meta:
		description = "Laudanum Injector Tools - file php-reverse-shell.php"
		author = "Florian Roth"
		reference = "http://laudanum.inguardians.com/"
...
rule DarkenCode_APT_Laudanum_Tools_Generic {
	meta:

...
rule DarkenCode_Opc_OPCLEAVER_BackDoorLogger
{
	meta:
...
rule DarkenCode_Opc_OPCLEAVER_Jasus
{
	meta:
...
rule DarkenCode_Opc_OPCLEAVER_LoggerModule
{
	meta:
		description = "Keylogger used by attackers in Operation Cleaver"
		reference = "http://cylance.com/assets/Cleaver/Cylance_Operation_Cleaver_Report.pdf"
...
rule DarkenCode_Opc_OPCLEAVER_NetC
{
	meta:
...
rule DarkenCode_Opc_OPCLEAVER_ShellCreator2
{
	meta:
...
rule DarkenCode_Opc_OPCLEAVER_SmartCopy2
{
	meta:
...
rule DarkenCode_Opc_OPCLEAVER_SynFlooder
{
	meta:
		description = "Malware or hack tool used by attackers in Operation Cleaver"
		reference = "http://cylance.com/assets/Cleaver/Cylance_Operation_Cleaver_Report.pdf"
...
rule DarkenCode_Opc_OPCLEAVER_TinyZBot
{
	meta:
...
rule DarkenCode_Opc_OPCLEAVER_ZhoupinExploitCrew
{
	meta:
...
rule DarkenCode_Opc_OPCLEAVER_antivirusdetector
{
	meta:
...
rule DarkenCode_Opc_OPCLEAVER_csext
{
	meta:
...
rule DarkenCode_Opc_OPCLEAVER_kagent
{
	meta:
		description = "Backdoor used by attackers in Operation Cleaver"
		reference = "http://cylance.com/assets/Cleaver/Cylance_Operation_Cleaver_Report.pdf"
...
rule DarkenCode_Opc_OPCLEAVER_mimikatzWrapper
{
	meta:
...
rule DarkenCode_Opc_OPCLEAVER_pvz_in
{
	meta:
...
rule DarkenCode_Opc_OPCLEAVER_pvz_out
{
	meta:
		description = "Parviz tool used by attackers in Operation Cleaver"
		reference = "http://cylance.com/assets/Cleaver/Cylance_Operation_Cleaver_Report.pdf"
...
rule DarkenCode_Opc_OPCLEAVER_wndTest
{
	meta:
		description = "Backdoor used by attackers in Operation Cleaver"
		reference = "http://cylance.com/assets/Cleaver/Cylance_Operation_Cleaver_Report.pdf"
...
rule DarkenCode_Opc_OPCLEAVER_zhCat
{
	meta:
...
rule DarkenCode_Opc_OPCLEAVER_zhLookUp
{
	meta:
		description = "Hack tool used by attackers in Operation Cleaver"
		reference = "http://cylance.com/assets/Cleaver/Cylance_Operation_Cleaver_Report.pdf"
...
rule DarkenCode_Opc_OPCLEAVER_zhmimikatz
{
	meta:
		description = "Mimikatz wrapper used by attackers in Operation Cleaver"
		reference = "http://cylance.com/assets/Cleaver/Cylance_Operation_Cleaver_Report.pdf"
...
rule DarkenCode_Opc_OPCLEAVER_Parviz_Developer
{
	meta:
...
rule DarkenCode_Opc_OPCLEAVER_CCProxy_Config
{
	meta:

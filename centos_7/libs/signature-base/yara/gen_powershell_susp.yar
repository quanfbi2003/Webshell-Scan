...
rule Neo23x0_gen_WordDoc_PowerShell_URLDownloadToFile {
   meta:
...
rule Neo23x0_gen_Suspicious_PowerShell_Code_1 : FILE {
   meta:
...
rule Neo23x0_gen_Suspicious_PowerShell_WebDownload_1 : HIGHVOL FILE {
   meta:
...
rule Neo23x0_gen_PowerShell_in_Word_Doc {
   meta:
...
rule Neo23x0_gen_Susp_PowerShell_Sep17_1 {
   meta:
...
rule Neo23x0_gen_Susp_PowerShell_Sep17_2 {
   meta:
      description = "Detects suspicious PowerShell script in combo with VBS or JS "
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_gen_WScript_Shell_PowerShell_Combo {
   meta:
...
rule Neo23x0_gen_SUSP_PowerShell_String_K32_RemProcess {
   meta:
...
rule Neo23x0_gen_PowerShell_JAB_B64 {
   meta:
...
rule Neo23x0_gen_SUSP_PS1_FromBase64String_Content_Indicator : FILE {
   meta:

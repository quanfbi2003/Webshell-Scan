...
rule Neo23x0_apt_MAL_Shellcode_Loader_Apr23 {
   meta:
...
rule Neo23x0_apt_APT_MAL_Gopuram_Backdoor_Apr23 {
   meta:
      author = "X__Junior (Nextron Systems)"
      reference = "https://securelist.com/gopuram-backdoor-deployed-through-3cx-supply-chain-attack/109344/"
...
rule Neo23x0_apt_APT_NK_MAL_DLL_Apr23_1 {
   meta:
...
rule Neo23x0_apt_APT_UNC4736_NK_MAL_TAXHAUL_3CX_Apr23_1 {
   meta:

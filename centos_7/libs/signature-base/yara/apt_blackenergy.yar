...
rule Neo23x0_apt_BlackEnergy_BE_2 {
   meta:
...
rule Neo23x0_apt_BlackEnergy_VBS_Agent {
	meta:
...
rule Neo23x0_apt_DropBear_SSH_Server {
	meta:
...
rule Neo23x0_apt_BlackEnergy_BackdoorPass_DropBear_SSH {
	meta:
...
rule Neo23x0_apt_BlackEnergy_KillDisk_1 {
	meta:
...
rule Neo23x0_apt_BlackEnergy_KillDisk_2 {
	meta:
		description = "Detects KillDisk malware from BlackEnergy"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_BlackEnergy_Driver_USBMDM {
	meta:
...
rule Neo23x0_apt_BlackEnergy_Driver_AMDIDE {
	meta:

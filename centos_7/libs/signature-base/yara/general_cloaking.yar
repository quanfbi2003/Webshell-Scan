...
rule Neo23x0_gen_EXE_cloaked_as_TXT {
	meta:
...
rule Neo23x0_gen_EXE_extension_cloaking {
	meta:
...
rule Neo23x0_gen_Cloaked_RAR_File {
	meta:
...
rule Neo23x0_gen_Base64_encoded_Executable : FILE {
	meta:
...
rule Neo23x0_gen_Gen_Base64_EXE: HIGHVOL {
   meta:
...
rule Neo23x0_gen_Binary_Drop_Certutil {
	meta:
...
rule Neo23x0_gen_Obfuscated_VBS_April17 {
   meta:
...
rule Neo23x0_gen_Obfuscated_JS_April17 {
   meta:

...
rule Neo23x0_apt_Nanocore_RAT_Gen_1 {
   meta:
...
rule Neo23x0_apt_Nanocore_RAT_Gen_2 {
   meta:
...
rule Neo23x0_apt_Nanocore_RAT_Sample_1 {
   meta:
...
rule Neo23x0_apt_Nanocore_RAT_Sample_2 {
   meta:
      description = "Detetcs a certain Nanocore RAT sample"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_Nanocore_RAT_Feb18_1 {
   meta:
...
rule Neo23x0_apt_Nanocore_RAT_Feb18_2 {
   meta:
      description = "Detects Nanocore RAT"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"

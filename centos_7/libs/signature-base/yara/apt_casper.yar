...
rule Neo23x0_apt_Casper_Backdoor_x86 {
   meta:
...
rule Neo23x0_apt_Casper_EXE_Dropper {
	meta:
...
rule Neo23x0_apt_Casper_Included_Strings {
	meta:
...
rule Neo23x0_apt_Casper_SystemInformation_Output {
	meta:

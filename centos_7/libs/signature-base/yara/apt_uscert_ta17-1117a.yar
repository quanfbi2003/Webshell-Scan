...
rule Neo23x0_apt_Dropper_DeploysMalwareViaSideLoading {
    meta:
...
rule Neo23x0_apt_REDLEAVES_DroppedFile_ImplantLoader_Starburn {
    meta:
...
rule Neo23x0_apt_REDLEAVES_DroppedFile_ObfuscatedShellcodeAndRAT_handkerchief {
    meta:
...
rule Neo23x0_apt_REDLEAVES_CoreImplant_UniqueStrings {
    meta:
...
rule Neo23x0_apt_PLUGX_RedLeaves {
    meta:

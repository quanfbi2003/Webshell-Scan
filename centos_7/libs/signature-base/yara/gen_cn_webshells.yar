...
rule Neo23x0_gen_InjectionParameters {
    meta:
...
rule Neo23x0_gen_trigger_modify {
    meta:
...
rule Neo23x0_gen_reDuhServers_reDuh {
    meta:
...
rule Neo23x0_gen_reDuhServers_reDuh_2 {
    meta:
...
rule Neo23x0_gen_ChinaChopper_one {
    meta:
...
rule Neo23x0_gen_CN_Tools_item {
    meta:
...
rule Neo23x0_gen_ChinaChopper_temp {
    meta:
...
rule Neo23x0_gen_ChinaChopper_temp_2 {
    meta:
...
rule Neo23x0_gen_reDuhServers_reDuh_3 {
    meta:
...
rule Neo23x0_gen_ChinaChopper_temp_3 {
    meta:

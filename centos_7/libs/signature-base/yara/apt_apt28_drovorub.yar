...
rule Neo23x0_apt_APT_APT28_generic_poco_openssl {
    meta:
...
rule Neo23x0_apt_APT_APT28_drovorub_library_and_unique_strings {
    meta:
...
rule Neo23x0_apt_APT_APT28_drovorub_unique_network_comms_strings {
    meta:
...
rule Neo23x0_apt_APT_APT28_drovorub_kernel_module_unique_strings {
    meta:

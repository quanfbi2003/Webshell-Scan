...
rule Neo23x0_apt_EXT_NK_GOLDBACKDOOR_inital_shellcode {
    meta:
...
rule Neo23x0_apt_EXT_NK_GOLDBACKDOOR_injected_shellcode {
    meta:
        author= "Silas Cutler (silas@Stairwell.com)"
...
rule Neo23x0_apt_EXT_NK_GOLDBACKDOOR_generic_shellcode {
    meta:
        author= "Silas Cutler (silas@Stairwell.com)"

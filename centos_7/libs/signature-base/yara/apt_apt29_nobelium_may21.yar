...
rule Neo23x0_apt_APT_APT29_Win_FlipFlop_LDR : APT29 {
   meta:
...
rule Neo23x0_apt_APT_APT28_Win_FreshFire : APT29 {
   meta:
      author = "threatintel@volexity.com"
      date = "2021-05-27"
...
rule Neo23x0_apt_APT_APT29_NOBELIUM_JS_EnvyScout_May21_1 {
   meta:
...
rule Neo23x0_apt_APT_APT29_NOBELIUM_JS_EnvyScout_May21_2 {
   meta:
      description = "Detects EnvyScout deobfuscator code as used by NOBELIUM group"
      author = "Florian Roth (Nextron Systems)"
      reference = "https://www.microsoft.com/security/blog/2021/05/28/breaking-down-nobeliums-latest-early-stage-toolset/"
...
rule Neo23x0_apt_APT_APT29_NOBELIUM_LNK_NV_Link_May21_2 {
   meta:
...
rule Neo23x0_apt_APT_APT29_NOBELIUM_LNK_Samples_May21_1 {
   meta:
...
rule Neo23x0_apt_APT_APT29_NOBELIUM_BoomBox_May21_1 {
   meta:
...
rule Neo23x0_apt_APT_APT29_NOBELIUM_BoomBox_PDF_Masq_May21_1 {
   meta:
...
rule Neo23x0_apt_APT_APT29_NOBELIUM_NativeZone_Loader_May21_1 {
   meta:
...
rule Neo23x0_apt_APT_APT29_NOBELIUM_BoomBox_May21_2 {
   meta:
...
rule Neo23x0_apt_APT_APT29_NOBELIUM_Malware_May21_2 {
   meta:
...
rule Neo23x0_apt_APT_APT29_NOBELIUM_Stageless_Loader_May21_2 {
   meta:
...
rule Neo23x0_apt_APT_APT29_NOBELIUM_Malware_May21_3 {
   meta:
      description = "Detects malware used by APT29 / NOBELIUM"
      author = "Florian Roth (Nextron Systems)"
      reference = "https://www.microsoft.com/security/blog/2021/05/28/breaking-down-nobeliums-latest-early-stage-toolset/"
...
rule Neo23x0_apt_APT_APT29_NOBELIUM_Malware_May21_4 {
   meta:
      description = "Detects malware used by APT29 / NOBELIUM"
      author = "Florian Roth (Nextron Systems)"
      reference = "https://www.microsoft.com/security/blog/2021/05/28/breaking-down-nobeliums-latest-early-stage-toolset/"

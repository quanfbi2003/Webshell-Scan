...
rule Neo23x0_apt_APT_Project_Sauron_Scripts {
	meta:
...
rule Neo23x0_apt_APT_Project_Sauron_arping_module {
	meta:
...
rule Neo23x0_apt_APT_Project_Sauron_kblogi_module {
	meta:
...
rule Neo23x0_apt_APT_Project_Sauron_basex_module {
	meta:
...
rule Neo23x0_apt_APT_Project_Sauron_dext_module {
	meta:
...
rule Neo23x0_apt_Hacktool_This_Cruft {
	meta:
...
rule Neo23x0_apt_APT_Project_Sauron_Custom_M1 {
	meta:
...
rule Neo23x0_apt_APT_Project_Sauron_Custom_M2 {
	meta:
		description = "Detects malware from Project Sauron APT"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_APT_Project_Sauron_Custom_M3 {
	meta:
		description = "Detects malware from Project Sauron APT"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_APT_Project_Sauron_Custom_M4 {
	meta:
		description = "Detects malware from Project Sauron APT"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_APT_Project_Sauron_Custom_M6 {
	meta:
		description = "Detects malware from Project Sauron APT"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_APT_Project_Sauron_Custom_M7 {
	meta:
		description = "Detects malware from Project Sauron APT"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"

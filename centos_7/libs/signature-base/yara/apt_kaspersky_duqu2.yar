...
rule Neo23x0_apt_APT_apt_duqu2_loaders {
	meta:
...
rule Neo23x0_apt_APT_apt_duqu2_drivers {
	meta:
		copyright = "Kaspersky Lab"
...
rule Neo23x0_apt_Duqu2_Generic1 {
	meta:
...
rule Neo23x0_apt_APT_Kaspersky_Duqu2_procexp {
	meta:
...
rule Neo23x0_apt_APT_Kaspersky_Duqu2_SamsungPrint {
	meta:
...
rule Neo23x0_apt_APT_Kaspersky_Duqu2_msi3_32 {
	meta:
		description = "Kaspersky APT Report - Duqu2 Sample"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"

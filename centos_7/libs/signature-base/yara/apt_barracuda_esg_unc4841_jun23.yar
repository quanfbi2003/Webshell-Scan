...
rule Neo23x0_apt_APT_UNC4841_ESG_Barracuda_CVE_2023_2868_Forensic_Artifacts_Jun23_1 : SCRIPT {
   meta:
...
rule Neo23x0_apt_APT_MAL_UNC4841_SEASPY_Jun23_1 {
   meta:
...
rule Neo23x0_apt_APT_MAL_UNC4841_SEASPY_LUA_Jun23_1 {
   meta:
...
rule Neo23x0_apt_APT_HKTL_Proxy_Tool_Jun23_1 {
   meta:
...
rule Neo23x0_apt_SUSP_FScan_Port_Scanner_Output_Jun23 : SCRIPT {
   meta:
...
rule Neo23x0_apt_SUSP_PY_Shell_Spawn_Jun23_1 : SCRIPT {
   meta:
...
rule Neo23x0_apt_APT_MAL_Hunting_LUA_SEASIDE_1 {
    meta:
...
rule Neo23x0_apt_APT_MAL_LNX_Hunting_Linux_WHIRLPOOL_1 {
    meta:
...
rule Neo23x0_apt_APT_MAL_LUA_Hunting_SKIPJACK_1 {
    meta:
        author = "Mandiant"
        date = "2023-06-15"
        reference = "https://www.mandiant.com/resources/blog/barracuda-esg-exploited-globally"
...
rule Neo23x0_apt_APT_MAL_LUA_Hunting_Lua_SKIPJACK_2 {
    meta:
        author = "Mandiant"
        date = "2023-06-15"
        reference = "https://www.mandiant.com/resources/blog/barracuda-esg-exploited-globally"
...
rule Neo23x0_apt_APT_MAL_LUA_Hunting_Lua_SEASPRAY_1 {
    meta:
        author = "Mandiant"
        date = "2023-06-15"
        reference = "https://www.mandiant.com/resources/blog/barracuda-esg-exploited-globally"

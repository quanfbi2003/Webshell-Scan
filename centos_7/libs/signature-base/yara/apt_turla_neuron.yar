...
rule Neo23x0_apt_Neuron_common_strings {
    meta:
...
rule Neo23x0_apt_Neuron_standalone_signature {
    meta:
...
rule Neo23x0_apt_Nautilus_modified_rc4_loop {
    meta:
...
rule Neo23x0_apt_Nautilus_rc4_key {
    meta:
...
rule Neo23x0_apt_Nautilus_common_strings {
    meta:
...
rule Neo23x0_apt_Nautilus_forensic_artificats {
    meta:
...
rule Neo23x0_apt_APT_Neuron2_Loader_Strings {
   meta:

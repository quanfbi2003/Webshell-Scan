...
rule Neo23x0_apt_TeleBots_IntercepterNG {
   meta:
...
rule Neo23x0_apt_TeleBots_KillDisk_1 {
   meta:
...
rule Neo23x0_apt_TeleBots_KillDisk_2 {
   meta:
      description = "Detects TeleBots malware - KillDisk"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_TeleBots_CredRaptor_Password_Stealer {
   meta:
...
rule Neo23x0_apt_TeleBots_VBS_Backdoor_1 {
   meta:
...
rule Neo23x0_apt_TeleBots_VBS_Backdoor_2 {
   meta:
      description = "Detects TeleBots malware - VBS Backdoor"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_TeleBots_Win64_Spy_KeyLogger_G {
   meta:

...
rule Neo23x0_apt_APT_UNC5221_Ivanti_ForensicArtifacts_Jan24_1 {
   meta:
...
rule Neo23x0_apt_M_Hunting_Backdoor_ZIPLINE_1 {
  meta:
    author = "Mandiant"
...
rule Neo23x0_apt_M_Hunting_Dropper_WIREFIRE_1 {
  meta:
    author = "Mandiant"
...
rule Neo23x0_apt_M_Hunting_Webshell_LIGHTWIRE_2 {
  meta:
...
rule Neo23x0_apt_M_Hunting_Dropper_THINSPOOL_1 {
  meta:
    author = "Mandiant"
...
rule Neo23x0_apt_M_Hunting_CredTheft_WARPWIRE_1 {
  meta:
    author = "Mandiant"

...
rule Neo23x0_cri_WannaCry_Ransomware {
   meta:
...
rule Neo23x0_cri_WannaCry_Ransomware_Gen {
   meta:
      description = "Detects WannaCry Ransomware"
...
rule Neo23x0_cri_WannCry_m_vbs {
   meta:
...
rule Neo23x0_cri_WannaCry_RansomNote {
   meta:
...
rule Neo23x0_cri_APT_lazaruswannacry {
   meta:

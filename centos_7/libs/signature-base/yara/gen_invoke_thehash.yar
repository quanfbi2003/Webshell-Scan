...
rule Neo23x0_gen_Invoke_SMBExec {
   meta:
...
rule Neo23x0_gen_Invoke_WMIExec_Gen_1 {
   meta:
      description = "Detects Invoke-WmiExec or Invoke-SmbExec"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_gen_Invoke_SMBExec_Invoke_WMIExec_1 {
   meta:
...
rule Neo23x0_gen_Invoke_WMIExec_Gen {
   meta:

...
rule Neo23x0_gen_LSASS_memory_dump_file {
   meta:
...
rule Neo23x0_gen_NTLM_Dump_Output {
   meta:
...
rule Neo23x0_gen_Gsecdump_password_dump_file {
   meta:
...
rule Neo23x0_gen_SUSP_ZIP_NtdsDIT : T1003_003 {
   meta:

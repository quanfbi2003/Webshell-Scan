...
rule Neo23x0_tho_Weevely_Webshell {
	meta:
...
rule Neo23x0_tho_webshell_PHP_a {
	meta:
...
rule Neo23x0_tho_webshell_iMHaPFtp_2 {
	meta:
...
rule Neo23x0_tho_webshell_Jspspyweb {
	meta:
...
rule Neo23x0_tho_webshell_Safe_Mode_Bypass_PHP_4_4_2_and_PHP_5_1_2 {
	meta:
...
rule Neo23x0_tho_webshell_SimAttacker_Vrsion_1_0_0_priv8_4_My_friend {
	meta:
...
rule Neo23x0_tho_webshell_phpshell_2_1_pwhash {
	meta:
...
rule Neo23x0_tho_webshell_PHPRemoteView {
	meta:
...
rule Neo23x0_tho_webshell_jsp_12302 {
	meta:
...
rule Neo23x0_tho_webshell_caidao_shell_guo {
	meta:
...
rule Neo23x0_tho_webshell_PHP_redcod {
	meta:
...
rule Neo23x0_tho_webshell_remview_fix {
	meta:
...
rule Neo23x0_tho_webshell_asp_cmd {
	meta:
...
rule Neo23x0_tho_webshell_php_sh_server {
	meta:
...
rule Neo23x0_tho_webshell_PH_Vayv_PH_Vayv {
	meta:
...
rule Neo23x0_tho_webshell_caidao_shell_ice {
	meta:
...
rule Neo23x0_tho_webshell_cihshell_fix {
	meta:
...
rule Neo23x0_tho_webshell_asp_shell {
	meta:
...
rule Neo23x0_tho_webshell_Private_i3lue {
	meta:
...
rule Neo23x0_tho_webshell_php_up {
	meta:
...
rule Neo23x0_tho_webshell_Mysql_interface_v1_0 {
	meta:
...
rule Neo23x0_tho_webshell_php_s_u {
	meta:
...
rule Neo23x0_tho_webshell_phpshell_2_1_config {
	meta:
...
rule Neo23x0_tho_webshell_asp_EFSO_2 {
	meta:
...
rule Neo23x0_tho_webshell_jsp_up {
	meta:
...
rule Neo23x0_tho_webshell_NetworkFileManagerPHP {
	meta:
...
rule Neo23x0_tho_webshell_Server_Variables {
	meta:
...
rule Neo23x0_tho_webshell_caidao_shell_ice_2 {
	meta:
...
rule Neo23x0_tho_webshell_caidao_shell_mdb {
	meta:
...
rule Neo23x0_tho_webshell_jsp_guige {
	meta:
...
rule Neo23x0_tho_webshell_phpspy2010 {
	meta:
...
rule Neo23x0_tho_webshell_asp_ice {
	meta:
		description = "Web Shell - file ice.asp"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_webshell_drag_system {
	meta:
...
rule Neo23x0_tho_webshell_DarkBlade1_3_asp_indexx {
	meta:
...
rule Neo23x0_tho_webshell_phpshell3 {
	meta:
...
rule Neo23x0_tho_webshell_jsp_hsxa {
	meta:
...
rule Neo23x0_tho_webshell_jsp_utils {
	meta:
...
rule Neo23x0_tho_webshell_asp_01 {
	meta:
...
rule Neo23x0_tho_webshell_asp_404 {
	meta:
...
rule Neo23x0_tho_webshell_webshell_cnseay02_1 {
	meta:
...
rule Neo23x0_tho_webshell_php_fbi {
	meta:
...
rule Neo23x0_tho_webshell_B374kPHP_B374k {
	meta:
...
rule Neo23x0_tho_webshell_cmd_asp_5_1 {
	meta:
...
rule Neo23x0_tho_webshell_php_dodo_zip {
	meta:
...
rule Neo23x0_tho_webshell_aZRaiLPhp_v1_0 {
	meta:
...
rule Neo23x0_tho_webshell_php_list {
	meta:
...
rule Neo23x0_tho_webshell_ironshell {
	meta:
...
rule Neo23x0_tho_webshell_caidao_shell_404 {
	meta:
...
rule Neo23x0_tho_webshell_ASP_aspydrv {
	meta:
...
rule Neo23x0_tho_webshell_jsp_web {
	meta:
...
rule Neo23x0_tho_webshell_mysqlwebsh {
	meta:
...
rule Neo23x0_tho_webshell_jspShell {
	meta:
...
rule Neo23x0_tho_webshell_Dx_Dx {
	meta:
...
rule Neo23x0_tho_webshell_asp_ntdaddy {
	meta:
...
rule Neo23x0_tho_webshell_MySQL_Web_Interface_Version_0_8 {
	meta:
...
rule Neo23x0_tho_webshell_elmaliseker_2 {
	meta:
...
rule Neo23x0_tho_webshell_ASP_RemExp {
	meta:
...
rule Neo23x0_tho_webshell_jsp_list1 {
	meta:
...
rule Neo23x0_tho_webshell_phpkit_1_0_odd {
	meta:
...
rule Neo23x0_tho_webshell_jsp_123 {
	meta:
...
rule Neo23x0_tho_webshell_asp_1 {
	meta:
...
rule Neo23x0_tho_webshell_ASP_tool {
	meta:
...
rule Neo23x0_tho_webshell_cmd_win32 {
	meta:
...
rule Neo23x0_tho_webshell_jsp_jshell {
	meta:
...
rule Neo23x0_tho_webshell_ASP_zehir4 {
	meta:
...
rule Neo23x0_tho_webshell_wsb_idc {
	meta:
...
rule Neo23x0_tho_webshell_cpg_143_incl_xpl {
	meta:
...
rule Neo23x0_tho_webshell_mumaasp_com {
	meta:
...
rule Neo23x0_tho_webshell_php_404 {
	meta:
		description = "Web Shell - file 404.php"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_webshell_webshell_cnseay_x {
	meta:
...
rule Neo23x0_tho_webshell_asp_up {
	meta:
...
rule Neo23x0_tho_webshell_phpkit_0_1a_odd {
	meta:
		description = "Web Shell - file odd.php"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_webshell_PHP_Shell_x3 {
	meta:
...
rule Neo23x0_tho_webshell_PHP_g00nv13 {
	meta:
...
rule Neo23x0_tho_webshell_php_h6ss {
	meta:
...
rule Neo23x0_tho_webshell_jsp_zx {
	meta:
...
rule Neo23x0_tho_webshell_Ani_Shell {
	meta:
...
rule Neo23x0_tho_webshell_jsp_k8cmd {
	meta:
...
rule Neo23x0_tho_webshell_jsp_cmd {
	meta:
...
rule Neo23x0_tho_webshell_jsp_k81 {
	meta:
...
rule Neo23x0_tho_webshell_ASP_zehir {
	meta:
...
rule Neo23x0_tho_webshell_Worse_Linux_Shell_1 {
	meta:
...
rule Neo23x0_tho_webshell_zacosmall {
	meta:
...
rule Neo23x0_tho_webshell_Liz0ziM_Private_Safe_Mode_Command_Execuriton_Bypass_Exploit {
	meta:
...
rule Neo23x0_tho_webshell_redirect {
	meta:
...
rule Neo23x0_tho_webshell_jsp_cmdjsp {
	meta:
...
rule Neo23x0_tho_webshell_Java_Shell {
	meta:
...
rule Neo23x0_tho_webshell_asp_1d {
	meta:
...
rule Neo23x0_tho_webshell_jsp_IXRbE {
	meta:
...
rule Neo23x0_tho_webshell_PHP_G5 {
	meta:
...
rule Neo23x0_tho_webshell_PHP_r57142 {
	meta:
...
rule Neo23x0_tho_webshell_jsp_tree {
	meta:
...
rule Neo23x0_tho_webshell_C99madShell_v_3_0_smowu {
	meta:
...
rule Neo23x0_tho_webshell_simple_backdoor {
	meta:
...
rule Neo23x0_tho_webshell_Macker_s_Private_PHPShell {
	meta:
...
rule Neo23x0_tho_webshell_Antichat_Shell_v1_3_2 {
	meta:
...
rule Neo23x0_tho_webshell_Safe_mode_breaker {
	meta:
...
rule Neo23x0_tho_webshell_Sst_Sheller {
	meta:
...
rule Neo23x0_tho_webshell_jsp_list {
	meta:
...
rule Neo23x0_tho_webshell_PHPJackal_v1_5 {
	meta:
...
rule Neo23x0_tho_webshell_customize {
	meta:
...
rule Neo23x0_tho_webshell_s72_Shell_v1_1_Coding {
	meta:
...
rule Neo23x0_tho_webshell_jsp_sys3 {
	meta:
...
rule Neo23x0_tho_webshell_jsp_guige02 {
	meta:
...
rule Neo23x0_tho_webshell_php_ghost {
	meta:
...
rule Neo23x0_tho_webshell_WinX_Shell {
	meta:
...
rule Neo23x0_tho_webshell_Crystal_Crystal {
	meta:
...
rule Neo23x0_tho_webshell_r57_1_4_0 {
	meta:
...
rule Neo23x0_tho_webshell_asp_ajn {
	meta:
...
rule Neo23x0_tho_webshell_php_cmd {
	meta:
...
rule Neo23x0_tho_webshell_asp_list {
	meta:
...
rule Neo23x0_tho_webshell_PHP_co {
	meta:
...
rule Neo23x0_tho_webshell_PHP_150 {
	meta:
...
rule Neo23x0_tho_webshell_jsp_cmdjsp_2 {
	meta:
		description = "Web Shell - file cmdjsp.jsp"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_webshell_PHP_c37 {
	meta:
...
rule Neo23x0_tho_webshell_PHP_b37 {
	meta:
...
rule Neo23x0_tho_webshell_php_backdoor {
	meta:
...
rule Neo23x0_tho_webshell_asp_dabao {
	meta:
...
rule Neo23x0_tho_webshell_php_2 {
	meta:
...
rule Neo23x0_tho_webshell_asp_cmdasp {
	meta:
...
rule Neo23x0_tho_webshell_spjspshell {
	meta:
...
rule Neo23x0_tho_webshell_jsp_action {
	meta:
...
rule Neo23x0_tho_webshell_Inderxer {
	meta:
...
rule Neo23x0_tho_webshell_asp_Rader {
	meta:
...
rule Neo23x0_tho_webshell_c99_madnet_smowu {
	meta:
		description = "Web Shell - file smowu.php"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_webshell_php_moon {
	meta:
...
rule Neo23x0_tho_webshell_minupload {
	meta:
...
rule Neo23x0_tho_webshell_ELMALISEKER_Backd00r {
	meta:
...
rule Neo23x0_tho_webshell_PHP_bug_1_ {
	meta:
...
rule Neo23x0_tho_webshell_caidao_shell_hkmjj {
	meta:
...
rule Neo23x0_tho_webshell_jsp_asd {
	meta:
...
rule Neo23x0_tho_webshell_metaslsoft {
	meta:
...
rule Neo23x0_tho_webshell_asp_Ajan {
	meta:
...
rule Neo23x0_tho_webshell_config_myxx_zend {
	meta:
...
rule Neo23x0_tho_webshell_browser_201_3_ma_download {
	meta:
...
rule Neo23x0_tho_webshell_itsec_itsecteam_shell_jHn {
	meta:
...
rule Neo23x0_tho_webshell_ghost_source_icesword_silic {
	meta:
...
rule Neo23x0_tho_webshell_JspSpy_JspSpyJDK5_JspSpyJDK51_luci_jsp_spy2009_m_ma3_xxx {
	meta:
...
rule Neo23x0_tho_webshell_2_520_job_ma1_ma4_2 {
	meta:
...
rule Neo23x0_tho_webshell_000_403_807_a_c5_config_css_dm_he1p_JspSpy_JspSpyJDK5_JspSpyJDK51_luci_jsp_xxx {
	meta:
		description = "Web Shell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_webshell_wso2_5_1_wso2_5_wso2 {
	meta:
...
rule Neo23x0_tho_webshell_000_403_c5_queryDong_spyjsp2010_t00ls {
	meta:
...
rule Neo23x0_tho_webshell_404_data_suiyue {
	meta:
...
rule Neo23x0_tho_webshell_r57shell_r57shell127_SnIpEr_SA_Shell_EgY_SpIdEr_ShElL_V2_r57_xxx {
	meta:
		description = "Web Shell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_webshell_807_a_css_dm_he1p_JspSpy_xxx {
	meta:
		description = "Web Shell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_webshell_201_3_ma_download {
	meta:
...
rule Neo23x0_tho_webshell_browser_201_3_400_in_JFolder_jfolder01_jsp_leo_ma_warn_webshell_nc_download {
	meta:
		description = "Web Shell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_webshell_shell_phpspy_2006_arabicspy {
	meta:
...
rule Neo23x0_tho_webshell_in_JFolder_jfolder01_jsp_leo_warn {
	meta:
...
rule Neo23x0_tho_webshell_2_520_icesword_job_ma1_ma4_2 {
	meta:
...
rule Neo23x0_tho_webshell_phpspy_2005_full_phpspy_2005_lite_PHPSPY {
	meta:
...
rule Neo23x0_tho_webshell_shell_phpspy_2006_arabicspy_hkrkoz {
	meta:
...
rule Neo23x0_tho_webshell_c99_Shell_ci_Biz_was_here_c100_v_xxx {
	meta:
		description = "Web Shell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_webshell_2008_2009lite_2009mssql {
	meta:
...
rule Neo23x0_tho_webshell_shell_phpspy_2005_full_phpspy_2005_lite_phpspy_2006_arabicspy_PHPSPY_hkrkoz {
	meta:
		description = "Web Shell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_webshell_807_dm_JspSpyJDK5_m_cofigrue {
	meta:
...
rule Neo23x0_tho_webshell_Dive_Shell_1_0_Emperor_Hacking_Team_xxx {
	meta:
		description = "Web Shell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_webshell_404_data_in_JFolder_jfolder01_xxx {
	meta:
		description = "Web Shell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_webshell_jsp_reverse_jsp_reverse_jspbd {
	meta:
...
rule Neo23x0_tho_webshell_400_in_JFolder_jfolder01_jsp_leo_warn_webshell_nc {
	meta:
...
rule Neo23x0_tho_webshell_2_520_job_JspWebshell_1_2_ma1_ma4_2 {
	meta:
...
rule Neo23x0_tho_webshell_shell_2008_2009mssql_phpspy_2005_full_phpspy_2006_arabicspy_hkrkoz {
	meta:
		description = "Web Shell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_webshell_gfs_sh_r57shell_r57shell127_SnIpEr_SA_xxx {
	meta:
		description = "Web Shell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_webshell_itsec_PHPJackal_itsecteam_shell_jHn {
	meta:
...
rule Neo23x0_tho_webshell_Shell_ci_Biz_was_here_c100_v_xxx {
	meta:
		description = "Web Shell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_webshell_NIX_REMOTE_WEB_SHELL_NIX_REMOTE_WEB_xxx1 {
	meta:
		description = "Web Shell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_webshell_c99_c99shell_c99_w4cking_Shell_xxx {
	meta:
		description = "Web Shell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_webshell_2008_2009mssql_phpspy_2005_full_phpspy_2006_arabicspy_hkrkoz {
	meta:
		description = "Web Shell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_webshell_c99_c66_c99_shadows_mod_c99shell {
	meta:
...
rule Neo23x0_tho_webshell_he1p_JspSpy_nogfw_ok_style_1_JspSpy1 {
	meta:
...
rule Neo23x0_tho_webshell_000_403_c5_config_myxx_queryDong_spyjsp2010_zend {
	meta:
...
rule Neo23x0_tho_webshell_c99_c99shell_c99_c99shell {
	meta:
...
rule Neo23x0_tho_webshell_r57shell127_r57_iFX_r57_kartal_r57_antichat {
	meta:
...
rule Neo23x0_tho_webshell_NIX_REMOTE_WEB_SHELL_nstview_xxx {
	meta:
		description = "Web Shell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_webshell_000_403_807_a_c5_config_css_dm_he1p_xxx {
	meta:
		description = "Web Shell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_webshell_2_520_icesword_job_ma1 {
	meta:
...
rule Neo23x0_tho_webshell_404_data_in_JFolder_jfolder01_jsp_suiyue_warn {
	meta:
...
rule Neo23x0_tho_webshell_phpspy_2005_full_phpspy_2005_lite_phpspy_2006_PHPSPY {
	meta:
...
rule Neo23x0_tho_webshell_c99_locus7s_c99_w4cking_xxx {
	meta:
		description = "Web Shell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_webshell_browser_201_3_ma_ma2_download {
	meta:
...
rule Neo23x0_tho_webshell_000_403_c5_queryDong_spyjsp2010 {
	meta:
...
rule Neo23x0_tho_webshell_r57shell127_r57_kartal_r57 {
	meta:
...
rule Neo23x0_tho_webshell_webshells_new_con2 {
	meta:
...
rule Neo23x0_tho_webshell_webshells_new_make2 {
	meta:
...
rule Neo23x0_tho_webshell_webshells_new_aaa {
	meta:
...
rule Neo23x0_tho_webshell_Expdoor_com_ASP {
	meta:
...
rule Neo23x0_tho_webshell_webshells_new_php2 {
	meta:
...
rule Neo23x0_tho_webshell_bypass_iisuser_p {
	meta:
...
rule Neo23x0_tho_webshell_sig_404super {
	meta:
...
rule Neo23x0_tho_webshell_webshells_new_JSP {
	meta:
...
rule Neo23x0_tho_webshell_webshell_123 {
	meta:
...
rule Neo23x0_tho_webshell_dev_core {
	meta:
...
rule Neo23x0_tho_webshell_webshells_new_pHp {
	meta:
...
rule Neo23x0_tho_webshell_webshells_new_pppp {
	meta:
...
rule Neo23x0_tho_webshell_webshells_new_code {
	meta:
...
rule Neo23x0_tho_webshell_webshells_new_jspyyy {
	meta:
...
rule Neo23x0_tho_webshell_webshells_new_xxxx {
	meta:
...
rule Neo23x0_tho_webshell_webshells_new_JJjsp3 {
	meta:
...
rule Neo23x0_tho_webshell_webshells_new_PHP1 {
	meta:
...
rule Neo23x0_tho_webshell_webshells_new_JJJsp2 {
	meta:
...
rule Neo23x0_tho_webshell_webshells_new_radhat {
	meta:
...
rule Neo23x0_tho_webshell_webshells_new_asp1 {
	meta:
...
rule Neo23x0_tho_webshell_webshells_new_php6 {
	meta:
...
rule Neo23x0_tho_webshell_webshells_new_xxx {
	meta:
...
rule Neo23x0_tho_webshell_GetPostpHp {
	meta:
...
rule Neo23x0_tho_webshell_webshells_new_php5 {
	meta:
...
rule Neo23x0_tho_webshell_webshells_new_Asp {
	meta:
...
rule Neo23x0_tho_php_backdoor_php {
	meta:
...
rule Neo23x0_tho_Liz0ziM_Private_Safe_Mode_Command_Execuriton_Bypass_Exploit_php {
	meta:
...
rule Neo23x0_tho_Nshell__1__php_php {
	meta:
...
rule Neo23x0_tho_shankar_php_php {
	meta:
...
rule Neo23x0_tho_Casus15_php_php {
	meta:
...
rule Neo23x0_tho_small_php_php {
	meta:
...
rule Neo23x0_tho_fuckphpshell_php {
	meta:
...
rule Neo23x0_tho_jsp_reverse_jsp {
	meta:
...
rule Neo23x0_tho_SimAttacker___Vrsion_1_0_0___priv8_4_My_friend_php {
	meta:
...
rule Neo23x0_tho_phvayvv_php_php {
	meta:
...
rule Neo23x0_tho_r57shell_php_php {
	meta:
...
rule Neo23x0_tho_rst_sql_php_php {
	meta:
...
rule Neo23x0_tho_wh_bindshell_py {
	meta:
...
rule Neo23x0_tho_lurm_safemod_on_cgi {
	meta:
...
rule Neo23x0_tho_c99madshell_v2_0_php_php {
	meta:
...
rule Neo23x0_tho_backupsql_php_often_with_c99shell {
	meta:
...
rule Neo23x0_tho_uploader_php_php {
	meta:
...
rule Neo23x0_tho_WinX_Shell_html {
	meta:
...
rule Neo23x0_tho_pHpINJ_php_php {
	meta:
...
rule Neo23x0_tho_sig_2008_php_php {
	meta:
...
rule Neo23x0_tho_ak74shell_php_php {
	meta:
...
rule Neo23x0_tho_Rem_View_php_php {
	meta:
...
rule Neo23x0_tho_Java_Shell_js {
	meta:
...
rule Neo23x0_tho_aZRaiLPhp_v1_0_php {
	meta:
...
rule Neo23x0_tho_Moroccan_Spamers_Ma_EditioN_By_GhOsT_php {
	meta:
...
rule Neo23x0_tho_zacosmall_php {
	meta:
...
rule Neo23x0_tho_simple_backdoor_php {
	meta:
...
rule Neo23x0_tho_mysql_shell_php {
	meta:
...
rule Neo23x0_tho_Dive_Shell_1_0___Emperor_Hacking_Team_php {
	meta:
...
rule Neo23x0_tho_Asmodeus_v0_1_pl {
	meta:
...
rule Neo23x0_tho_backup_php_often_with_c99shell {
	meta:
...
rule Neo23x0_tho_phpshell17_php {
	meta:
...
rule Neo23x0_tho_myshell_php_php {
	meta:
...
rule Neo23x0_tho_SimShell_1_0___Simorgh_Security_MGZ_php {
	meta:
...
rule Neo23x0_tho_rootshell_php {
	meta:
...
rule Neo23x0_tho_connectback2_pl {
	meta:
...
rule Neo23x0_tho_DefaceKeeper_0_2_php {
	meta:
...
rule Neo23x0_tho_shells_PHP_wso {
	meta:
...
rule Neo23x0_tho_backdoor1_php {
	meta:
...
rule Neo23x0_tho_elmaliseker_asp {
	meta:
...
rule Neo23x0_tho_DxShell_php_php {
	meta:
...
rule Neo23x0_tho_s72_Shell_v1_1_Coding_html {
	meta:
...
rule Neo23x0_tho_PHP_Backdoor_Connect_pl_php {
	meta:
...
rule Neo23x0_tho_Antichat_Socks5_Server_php_php {
	meta:
...
rule Neo23x0_tho_Antichat_Shell_v1_3_php {
	meta:
...
rule Neo23x0_tho_Safe_Mode_Bypass_PHP_4_4_2_and_PHP_5_1_2_php {
	meta:
...
rule Neo23x0_tho_mysql_php_php {
	meta:
...
rule Neo23x0_tho_Worse_Linux_Shell_php {
	meta:
...
rule Neo23x0_tho_cyberlords_sql_php_php {
	meta:
...
rule Neo23x0_tho_cmd_asp_5_1_asp {
	meta:
...
rule Neo23x0_tho_PHP_Shell_php_php {
	meta:
...
rule Neo23x0_tho_Ayyildiz_Tim___AYT__Shell_v_2_1_Biz_html {
	meta:
...
rule Neo23x0_tho_lamashell_php {
	meta:
...
rule Neo23x0_tho_Ajax_PHP_Command_Shell_php {
	meta:
...
rule Neo23x0_tho_JspWebshell_1_2_jsp {
	meta:
...
rule Neo23x0_tho_Sincap_php_php {
	meta:
...
rule Neo23x0_tho_Phyton_Shell_py {
	meta:
...
rule Neo23x0_tho_mysql_tool_php_php {
	meta:
...
rule Neo23x0_tho_phpbackdoor15_php {
	meta:
...
rule Neo23x0_tho_phpjackal_php {
	meta:
...
rule Neo23x0_tho_ru24_post_sh_php_php {
	meta:
...
rule Neo23x0_tho_DTool_Pro_php {
	meta:
...
rule Neo23x0_tho_php_include_w_shell_php {
	meta:
...
rule Neo23x0_tho_Safe0ver_Shell__Safe_Mod_Bypass_By_Evilc0der_php {
	meta:
...
rule Neo23x0_tho_shell_php_php {
	meta:
...
rule Neo23x0_tho_ironshell_php {
	meta:
...
rule Neo23x0_tho_backdoorfr_php {
	meta:
...
rule Neo23x0_tho_h4ntu_shell__powered_by_tsoi_ {
	meta:
...
rule Neo23x0_tho_PHANTASMA_php {
	meta:
...
rule Neo23x0_tho_MySQL_Web_Interface_Version_0_8_php {
	meta:
...
rule Neo23x0_tho_simple_cmd_html {
	meta:
...
rule Neo23x0_tho__1_c2007_php_php_c100_php {
	meta:
...
rule Neo23x0_tho__nst_php_php_img_php_php_nstview_php_php {
	meta:
...
rule Neo23x0_tho__network_php_php_xinfo_php_php_nfm_php_php {
	meta:
...
rule Neo23x0_tho__w_php_php_c99madshell_v2_1_php_php_wacking_php_php_SpecialShell_99_php_php {
	meta:
...
rule Neo23x0_tho__r577_php_php_SnIpEr_SA_Shell_php_r57_php_php_r57_Shell_php_php_spy_php_php_s_php_php {
	meta:
		description = "Semi-Auto-generated "
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		super_rule = 1
...
rule Neo23x0_tho__c99shell_v1_0_php_php_c99php_SsEs_php_php_ctt_sh_php_php {
	meta:
...
rule Neo23x0_tho__r577_php_php_spy_php_php_s_php_php {
	meta:
...
rule Neo23x0_tho_webshell_c99_generic {
	meta:
		description = "Semi-Auto-generated "
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		super_rule = 1
...
rule Neo23x0_tho__w_php_php_c99madshell_v2_1_php_php_wacking_php_php_c99shell_v1_0_php_php_c99php_SpecialShell_99_php_php {
	meta:
		description = "Semi-Auto-generated "
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		super_rule = 1
...
rule Neo23x0_tho__w_php_php_wacking_php_php_SpecialShell_99_php_php {
	meta:
...
rule Neo23x0_tho__w_php_php_c99madshell_v2_1_php_php_wacking_php_php_SsEs_php_php_SpecialShell_99_php_php {
	meta:
		description = "Semi-Auto-generated "
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		super_rule = 1
...
rule Neo23x0_tho__r577_php_php_SnIpEr_SA_Shell_php_r57_php_php_spy_php_php_s_php_php {
	meta:
		description = "Semi-Auto-generated "
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		super_rule = 1
...
rule Neo23x0_tho__r577_php_php_SnIpEr_SA_Shell_php_r57_php_php {
	meta:
...
rule Neo23x0_tho__r577_php_php_r57_Shell_php_php_spy_php_php_s_php_php {
	meta:
...
rule Neo23x0_tho__wacking_php_php_1_SpecialShell_99_php_php_c100_php {
	meta:
...
rule Neo23x0_tho__r577_php_php_r57_php_php_r57_Shell_php_php_spy_php_php_s_php_php {
	meta:
...
rule Neo23x0_tho__w_php_php_wacking_php_php_SsEs_php_php_SpecialShell_99_php_php {
	meta:
...
rule Neo23x0_tho_multiple_php_webshells {
	meta:
...
rule Neo23x0_tho__w_php_php_c99madshell_v2_1_php_php_wacking_php_php {
	meta:
...
rule Neo23x0_tho__w_php_php_c99madshell_v2_1_php_php_wacking_php_php_c99shell_v1_0_php_php_c99php {
	meta:
		description = "Semi-Auto-generated "
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		super_rule = 1
...
rule Neo23x0_tho__GFS_web_shell_ver_3_1_7___PRiV8_php_nshell_php_php_gfs_sh_php_php {
	meta:
...
rule Neo23x0_tho__w_php_php_c99madshell_v2_1_php_php_wacking_php_php_c99shell_v1_0_php_php_SpecialShell_99_php_php {
	meta:
		description = "Semi-Auto-generated "
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		super_rule = 1
...
rule Neo23x0_tho__w_php_php_wacking_php_php_c99shell_v1_0_php_php_c99php_SpecialShell_99_php_php {
	meta:
		description = "Semi-Auto-generated "
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		super_rule = 1
...
rule Neo23x0_tho__antichat_php_php_Fatalshell_php_php_a_gedit_php_php {
	meta:
...
rule Neo23x0_tho__c99shell_v1_0_php_php_c99php_SsEs_php_php {
	meta:
...
rule Neo23x0_tho__Crystal_php_nshell_php_php_load_shell_php_php {
	meta:
...
rule Neo23x0_tho__nst_php_php_cybershell_php_php_img_php_php_nstview_php_php {
	meta:
...
rule Neo23x0_tho__w_php_php_c99madshell_v2_1_php_php_wacking_php_php_dC3_Security_Crew_Shell_PRiV_php_SpecialShell_99_php_php {
	meta:
		description = "Semi-Auto-generated "
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		super_rule = 1
...
rule Neo23x0_tho__c99shell_v1_0_php_php_c99php_1_c2007_php_php_c100_php {
	meta:
...
rule Neo23x0_tho_multiple_php_webshells_2 {
	meta:
		description = "Semi-Auto-generated "
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		super_rule = 1
...
rule Neo23x0_tho__w_php_php_c99madshell_v2_1_php_php_wacking_php_php_1_SpecialShell_99_php_php {
	meta:
		description = "Semi-Auto-generated "
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		super_rule = 1
...
rule Neo23x0_tho__r577_php_php_r57_php_php_spy_php_php_s_php_php {
	meta:
...
rule Neo23x0_tho__nixrem_php_php_c99shell_v1_0_php_php_c99php_NIX_REMOTE_WEB_SHELL_v_0_5_alpha_Lite_Public_Version_php {
	meta:
		description = "Semi-Auto-generated "
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		super_rule = 1
...
rule Neo23x0_tho_DarkSecurityTeam_Webshell {
	meta:
...
rule Neo23x0_tho_PHP_Cloaked_Webshell_SuperFetchExec {
	meta:
...
rule Neo23x0_tho_WebShell_RemExp_asp_php {
	meta:
...
rule Neo23x0_tho_WebShell_dC3_Security_Crew_Shell_PRiV {
	meta:
...
rule Neo23x0_tho_WebShell_simattacker {
	meta:
...
rule Neo23x0_tho_WebShell_DTool_Pro {
	meta:
...
rule Neo23x0_tho_WebShell_IronShell_4 {
	meta:
...
rule Neo23x0_tho_WebShell_indexer_asp_php {
	meta:
...
rule Neo23x0_tho_WebShell_toolaspshell {
	meta:
...
rule Neo23x0_tho_WebShell_b374k_mini_shell_php_php {
	meta:
...
rule Neo23x0_tho_WebShell_Sincap_1_0 {
	meta:
...
rule Neo23x0_tho_WebShell_b374k_php {
	meta:
...
rule Neo23x0_tho_WebShell_SimAttacker___Vrsion_1_0_0___priv8_4_My_friend {
	meta:
...
rule Neo23x0_tho_WebShell_php_webshells_pws {
	meta:
...
rule Neo23x0_tho_WebShell_reader_asp_php {
	meta:
...
rule Neo23x0_tho_WebShell_Safe_Mode_Bypass_PHP_4_4_2_and_PHP_5_1_2_3 {
	meta:
...
rule Neo23x0_tho_WebShell_Liz0ziM_Private_Safe_Mode_Command_Execuriton_Bypass_Exploit_2 {
	meta:
...
rule Neo23x0_tho_WebShell_PHP_Backdoor_2 {
	meta:
...
rule Neo23x0_tho_WebShell_Worse_Linux_Shell_2 {
	meta:
...
rule Neo23x0_tho_WebShell_php_webshells_pHpINJ {
	meta:
...
rule Neo23x0_tho_WebShell_php_webshells_NGH {
	meta:
...
rule Neo23x0_tho_WebShell_php_webshells_matamu {
	meta:
...
rule Neo23x0_tho_WebShell_ru24_post_sh {
	meta:
...
rule Neo23x0_tho_WebShell_hiddens_shell_v1 {
	meta:
...
rule Neo23x0_tho_WebShell_c99_madnet {
	meta:
...
rule Neo23x0_tho_WebShell_c99_locus7s {
	meta:
...
rule Neo23x0_tho_WebShell_JspWebshell_1_2 {
	meta:
...
rule Neo23x0_tho_WebShell_safe0ver {
	meta:
...
rule Neo23x0_tho_WebShell_Uploader {
	meta:
...
rule Neo23x0_tho_WebShell_php_webshells_kral {
	meta:
...
rule Neo23x0_tho_WebShell_cgitelnet {
	meta:
...
rule Neo23x0_tho_WebShell_simple_backdoor_2 {
	meta:
...
rule Neo23x0_tho_WebShell_Safe_Mode_Bypass_PHP_4_4_2_and_PHP_5_1_2_2 {
	meta:
...
rule Neo23x0_tho_WebShell_NTDaddy_v1_9 {
	meta:
...
rule Neo23x0_tho_WebShell_lamashell {
	meta:
...
rule Neo23x0_tho_WebShell_Simple_PHP_backdoor_by_DK {
	meta:
...
rule Neo23x0_tho_WebShell_Moroccan_Spamers_Ma_EditioN_By_GhOsT {
	meta:
...
rule Neo23x0_tho_WebShell_C99madShell_v__2_0_madnet_edition {
	meta:
...
rule Neo23x0_tho_WebShell_CmdAsp_asp_php {
	meta:
...
rule Neo23x0_tho_WebShell_NCC_Shell {
	meta:
...
rule Neo23x0_tho_WebShell_php_webshells_README {
	meta:
...
rule Neo23x0_tho_WebShell_backupsql {
	meta:
...
rule Neo23x0_tho_WebShell_AK_74_Security_Team_Web_Shell_Beta_Version {
	meta:
...
rule Neo23x0_tho_WebShell_php_webshells_cpanel {
	meta:
...
rule Neo23x0_tho_WebShell_accept_language {
	meta:
...
rule Neo23x0_tho_WebShell_php_webshells_529 {
	meta:
...
rule Neo23x0_tho_WebShell_STNC_WebShell_v0_8 {
	meta:
...
rule Neo23x0_tho_WebShell_php_webshells_tryag {
	meta:
...
rule Neo23x0_tho_WebShell_dC3_Security_Crew_Shell_PRiV_2 {
	meta:
...
rule Neo23x0_tho_WebShell_qsd_php_backdoor {
	meta:
...
rule Neo23x0_tho_WebShell_php_webshells_spygrup {
	meta:
...
rule Neo23x0_tho_WebShell_Web_shell__c_ShAnKaR {
	meta:
...
rule Neo23x0_tho_WebShell_Ayyildiz_Tim___AYT__Shell_v_2_1_Biz {
	meta:
...
rule Neo23x0_tho_WebShell_Gamma_Web_Shell {
	meta:
...
rule Neo23x0_tho_WebShell_php_webshells_aspydrv {
	meta:
...
rule Neo23x0_tho_WebShell_JspWebshell_1_2_2 {
	meta:
...
rule Neo23x0_tho_WebShell_g00nshell_v1_3 {
	meta:
...
rule Neo23x0_tho_WebShell_WinX_Shell_2 {
	meta:
...
rule Neo23x0_tho_WebShell_PHANTASMA {
	meta:
...
rule Neo23x0_tho_WebShell_php_webshells_cw {
	meta:
...
rule Neo23x0_tho_WebShell_php_include_w_shell {
	meta:
...
rule Neo23x0_tho_WebShell_mysql_tool {
	meta:
...
rule Neo23x0_tho_WebShell_PhpSpy_Ver_2006 {
	meta:
...
rule Neo23x0_tho_WebShell_ZyklonShell {
	meta:
...
rule Neo23x0_tho_WebShell_php_webshells_myshell_2 {
	meta:
		description = "PHP Webshells Github Archive - file myshell.php"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_WebShell_php_webshells_lolipop {
	meta:
...
rule Neo23x0_tho_WebShell_simple_cmd {
	meta:
...
rule Neo23x0_tho_WebShell_go_shell {
	meta:
...
rule Neo23x0_tho_WebShell_aZRaiLPhp_v1_0_2 {
	meta:
...
rule Neo23x0_tho_WebShell_webshells_zehir4 {
	meta:
...
rule Neo23x0_tho_WebShell_zehir4_asp_php {
	meta:
...
rule Neo23x0_tho_WebShell_php_webshells_lostDC {
	meta:
...
rule Neo23x0_tho_WebShell_CasuS_1_5 {
	meta:
...
rule Neo23x0_tho_WebShell_ftpsearch {
	meta:
...
rule Neo23x0_tho_WebShell__Cyber_Shell_cybershell_Cyber_Shell__v_1_0_ {
	meta:
...
rule Neo23x0_tho_WebShell__Ajax_PHP_Command_Shell_Ajax_PHP_Command_Shell_soldierofallah {
	meta:
...
rule Neo23x0_tho_WebShell_Generic_PHP_7 {
	meta:
...
rule Neo23x0_tho_WebShell__Small_Web_Shell_by_ZaCo_small_zaco_zacosmall {
	meta:
...
rule Neo23x0_tho_WebShell_Generic_PHP_8 {
	meta:
		description = "PHP Webshells Github Archive"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_WebShell__PH_Vayv_PHVayv_PH_Vayv_klasvayv_asp_php {
	meta:
...
rule Neo23x0_tho_WebShell_Generic_PHP_9 {
   meta:
...
rule Neo23x0_tho_WebShell__PH_Vayv_PHVayv_PH_Vayv {
	meta:
...
rule Neo23x0_tho_WebShell_Generic_PHP_1 {
   meta:
...
rule Neo23x0_tho_WebShell_Generic_PHP_2 {
	meta:
...
rule Neo23x0_tho_WebShell__CrystalShell_v_1_erne_stres {
	meta:
...
rule Neo23x0_tho_WebShell_Generic_PHP_3 {
	meta:
		description = "PHP Webshells Github Archive"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_WebShell_Generic_PHP_4 {
	meta:
...
rule Neo23x0_tho_WebShell__CrystalShell_v_1_sosyete_stres {
	meta:
...
rule Neo23x0_tho_WebShell_Generic_PHP_10 {
	meta:
...
rule Neo23x0_tho_WebShell_Generic_PHP_11 {
	meta:
...
rule Neo23x0_tho_WebShell__findsock_php_findsock_shell_php_reverse_shell {
	meta:
...
rule Neo23x0_tho_WebShell_Generic_PHP_6 {
	meta:
		description = "PHP Webshells Github Archive"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_Unpack_Injectt {
	meta:
...
rule Neo23x0_tho_HYTop_DevPack_fso {
	meta:
...
rule Neo23x0_tho_FeliksPack3___PHP_Shells_ssh {
	meta:
...
rule Neo23x0_tho_ZXshell2_0_rar_Folder_ZXshell {
	meta:
...
rule Neo23x0_tho_binder2_binder2 {
	meta:
...
rule Neo23x0_tho_thelast_orice2 {
	meta:
...
rule Neo23x0_tho_HYTop_DevPack_config {
	meta:
...
rule Neo23x0_tho_hkshell_hkshell {
	meta:
...
rule Neo23x0_tho_EditServer_EXE {
	meta:
...
rule Neo23x0_tho_PHP_Backdoor_v1 {
	meta:
...
rule Neo23x0_tho_HYTop_DevPack_server {
	meta:
...
rule Neo23x0_tho_FSO_s_remview {
	meta:
...
rule Neo23x0_tho_HYTop2006_rar_Folder_2006Z {
	meta:
...
rule Neo23x0_tho_FSO_s_casus15 {
	meta:
...
rule Neo23x0_tho_shelltools_g0t_root_uptime {
	meta:
...
rule Neo23x0_tho_Simple_PHP_BackDooR {
	meta:
...
rule Neo23x0_tho_Mithril_v1_45_Mithril {
	meta:
...
rule Neo23x0_tho_hkshell_hkrmv {
	meta:
...
rule Neo23x0_tho_WEBSHELL_PHP_1 {
	meta:
		description = "Webshells Auto-generated - file phpshell.php"
...
rule Neo23x0_tho_FeliksPack3___PHP_Shells_phpft {
	meta:
...
rule Neo23x0_tho_FSO_s_indexer {
	meta:
...
rule Neo23x0_tho_HYTop_DevPack_2005Red {
	meta:
...
rule Neo23x0_tho_HYTop2006_rar_Folder_2006X2 {
	meta:
...
rule Neo23x0_tho_HYTop_CaseSwitch_2005 {
	meta:
...
rule Neo23x0_tho_eBayId_index3 {
	meta:
...
rule Neo23x0_tho_byshell063_ntboot {
	meta:
...
rule Neo23x0_tho_FSO_s_casus15_2 {
	meta:
		description = "Webshells Auto-generated - file casus15.php"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_FSO_s_remview_2 {
	meta:
		description = "Webshells Auto-generated - file remview.php"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_FeliksPack3___PHP_Shells_r57 {
	meta:
...
rule Neo23x0_tho_HYTop2006_rar_Folder_2006X {
	meta:
...
rule Neo23x0_tho_FSO_s_phvayv_2 {
	meta:
		description = "Webshells Auto-generated - file phvayv.php"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_shelltools_g0t_root_resolve {
	meta:
...
rule Neo23x0_tho_FeliksPack3___PHP_Shells_2005 {
	meta:
...
rule Neo23x0_tho_shelltools_g0t_root_Fport {
	meta:
...
rule Neo23x0_tho_BackDooR__fr_ {
	meta:
...
rule Neo23x0_tho_FSO_s_ntdaddy {
	meta:
...
rule Neo23x0_tho_nstview_nstview {
	meta:
...
rule Neo23x0_tho_HYTop_DevPack_upload {
	meta:
...
rule Neo23x0_tho_PasswordReminder {
	meta:
...
rule Neo23x0_tho_FSO_s_RemExp_2 {
	meta:
		description = "Webshells Auto-generated - file RemExp.asp"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_rknt_zip_Folder_RkNT {
	meta:
...
rule Neo23x0_tho_Mithril_Mithril {
	meta:
		description = "Webshells Auto-generated - file Mithril.exe"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_Release_dllTest {
	meta:
...
rule Neo23x0_tho_Mithril_v1_45_dllTest {
	meta:
		description = "Webshells Auto-generated - file dllTest.dll"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_remview_2003_04_22 {
	meta:
...
rule Neo23x0_tho_thelast_index3 {
	meta:
		description = "Webshells Auto-generated - file index3.php"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_FeliksPack3___PHP_Shells_xIShell {
	meta:
...
rule Neo23x0_tho_HYTop_AppPack_2005 {
	meta:
		description = "Webshells Auto-generated - file 2005.asp"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_FeliksPack3___PHP_Shells_usr {
	meta:
...
rule Neo23x0_tho_xssshell_default {
	meta:
...
rule Neo23x0_tho_Mithril_dllTest {
	meta:
		description = "Webshells Auto-generated - file dllTest.dll"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_Debug_dllTest_2 {
	meta:
		description = "Webshells Auto-generated - file dllTest.dll"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_shelltools_g0t_root_HideRun {
	meta:
...
rule Neo23x0_tho_PHP_Shell_v1_7 {
	meta:
...
rule Neo23x0_tho_xssshell_save {
	meta:
...
rule Neo23x0_tho_FSO_s_phpinj_2 {
	meta:
		description = "Webshells Auto-generated - file phpinj.php"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_ZXshell2_0_rar_Folder_zxrecv {
	meta:
...
rule Neo23x0_tho_phpspy_2005_full {
	meta:
...
rule Neo23x0_tho_FSO_s_zehir4_2 {
	meta:
		description = "Webshells Auto-generated - file zehir4.asp"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_FSO_s_indexer_2 {
	meta:
		description = "Webshells Auto-generated - file indexer.asp"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_HYTop_DevPack_2005 {
	meta:
		description = "Webshells Auto-generated - file 2005.asp"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho__root_040_zip_Folder_deploy {
	meta:
...
rule Neo23x0_tho_icyfox007v1_10_rar_Folder_asp {
	meta:
...
rule Neo23x0_tho_byshell063_ntboot_2 {
	meta:
...
rule Neo23x0_tho_shelltools_g0t_root_xwhois {
	meta:
...
rule Neo23x0_tho_down_rar_Folder_down {
	meta:
...
rule Neo23x0_tho_ZXshell2_0_rar_Folder_nc {
	meta:
...
rule Neo23x0_tho_HYTop2006_rar_Folder_2006 {
	meta:
...
rule Neo23x0_tho_Webshell_and_Exploit_CN_APT_HK : Webshell
{
meta:
	license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
	author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_JSP_Browser_APT_webshell {
	meta:
...
rule Neo23x0_tho_JSP_jfigueiredo_APT_webshell {
	meta:
...
rule Neo23x0_tho_JSP_jfigueiredo_APT_webshell_2 {
	meta:
		description = "JSP Browser used as web shell by APT groups - author: jfigueiredo"
		author = "Florian Roth (Nextron Systems)"
		date = "12.10.2014"
...
rule Neo23x0_tho_Webshell_Insomnia {
	meta:
...
rule Neo23x0_tho_HawkEye_PHP_Panel {
	meta:
...
rule Neo23x0_tho_SoakSoak_Infected_Wordpress {
	meta:
...
rule Neo23x0_tho_Pastebin_Webshell {
	meta:
...
rule Neo23x0_tho_Webshell_27_9_c66_c99 {
	meta:
...
rule Neo23x0_tho_Webshell_acid_AntiSecShell_3 {
	meta:
...
rule Neo23x0_tho_Webshell_c99_4 {
	meta:
...
rule Neo23x0_tho_Webshell_r57shell_2 {
	meta:
...
rule Neo23x0_tho_Webshell_27_9_acid_c99_locus7s {
	meta:
...
rule Neo23x0_tho_Webshell_Backdoor_PHP_Agent_r57_mod_bizzz_shell_r57 {
	meta:
...
rule Neo23x0_tho_Webshell_c100 {
	meta:
...
rule Neo23x0_tho_Webshell_AcidPoison {
	meta:
...
rule Neo23x0_tho_Webshell_acid_FaTaLisTiCz_Fx_fx_p0isoN_sh3ll_x0rg_byp4ss_256 {
	meta:
...
rule Neo23x0_tho_Webshell_Ayyildiz {
	meta:
		description = "Detects Webshell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_Webshell_zehir {
	meta:
...
rule Neo23x0_tho_UploadShell_98038f1efa4203432349badabad76d44337319a6 {
	meta:
...
rule Neo23x0_tho_DKShell_f0772be3c95802a2d1e7a4a3f5a45dcdef6997f3 {
	meta:
		description = "Detects a web shell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_Unknown_8af033424f9590a15472a23cc3236e68070b952e {
	meta:
		description = "Detects a web shell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_DkShell_4000bd83451f0d8501a9dfad60dce39e55ae167d {
	meta:
		description = "Detects a web shell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_WebShell_5786d7d9f4b0df731d79ed927fb5a124195fc901 {
	meta:
		description = "Detects a web shell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_webshell_e8eaf8da94012e866e51547cd63bb996379690bf {
	meta:
		description = "Detects a web shell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_Unknown_0f06c5d1b32f4994c3b3abf8bb76d5468f105167 {
	meta:
		description = "Detects a web shell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_WSOShell_0bbebaf46f87718caba581163d4beed56ddf73a7 {
	meta:
		description = "Detects a web shell"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_WebShell_Generic_1609_A {
	meta:
...
rule Neo23x0_tho_Nishang_Webshell {
	meta:
...
rule Neo23x0_tho_PHP_Webshell_1_Feb17 {
   meta:
...
rule Neo23x0_tho_Webshell_Tiny_JSP_2 {
	meta:
...
rule Neo23x0_tho_Wordpress_Config_Webshell_Preprend {
   meta:
...
rule Neo23x0_tho_PAS_Webshell_Encoded {
   meta:
...
rule Neo23x0_tho_Webshell_FOPO_Obfuscation_APT_ON_Nov17_1 {
   meta:
...
rule Neo23x0_tho_WebShell_JexBoss_JSP_1 {
   meta:
...
rule Neo23x0_tho_WebShell_JexBoss_WAR_1 {
   meta:
...
rule Neo23x0_tho_webshell_tinyasp {
    meta:
	author = "Jeff Beley"
...
rule Neo23x0_tho_WEBSHELL_ASPX_Mar21_1 {
   meta:

...
rule Neo23x0_gen_WindowsShell_s3 {
	meta:
...
rule Neo23x0_gen_WindosShell_s1 {
	meta:
...
rule Neo23x0_gen_WindowsShell_s4 {
	meta:
...
rule Neo23x0_gen_WindowsShell_Gen {
	meta:
...
rule Neo23x0_gen_WindowsShell_Gen2 {
	meta:

...
rule Neo23x0_apt_APT_MAL_CN_Wocao_Agent_Csharp {
    meta:
...
rule Neo23x0_apt_APT_MAL_CN_Wocao_agent_powershell_dropper {
    meta:
...
rule Neo23x0_apt_APT_MAL_CN_Wocao_agent_powershell_b64encoded {
    meta:
...
rule Neo23x0_apt_APT_MAL_CN_Wocao_agent_py {
    meta:
...
rule Neo23x0_apt_APT_MAL_CN_Wocao_agent_py_b64encoded {
    meta:
...
rule Neo23x0_apt_APT_MAL_CN_Wocao_keylogger_py {
    meta:
...
rule Neo23x0_apt_APT_MAL_CN_Wocao_keylogger_file {
    meta:
...
rule Neo23x0_apt_APT_MAL_CN_Wocao_xserver_csharp {
    meta:
...
rule Neo23x0_apt_APT_MAL_CN_Wocao_xserver_powershell_b64encoded {
    meta:
...
rule Neo23x0_apt_APT_MAL_CN_Wocao_xserver_powershell_dropper {
    meta:
...
rule Neo23x0_apt_APT_MAL_CN_Wocao_injector_bin {
    meta:
...
rule Neo23x0_apt_APT_MAL_CN_Wocao_timeliner_bin {
    meta:
...
rule Neo23x0_apt_APT_MAL_CN_Wocao_checkadmin_bin {
    meta:
...
rule Neo23x0_apt_APT_MAL_CN_Wocao_getos_py {
    meta:
...
rule Neo23x0_apt_APT_MAL_CN_Wocao_info_vbs {
    meta:
...
rule Neo23x0_apt_APT_MAL_CN_Wocao_webshell_console_jsp {
    meta:
...
rule Neo23x0_apt_APT_MAL_CN_Wocao_webshell_index_jsp {
    meta:
...
rule Neo23x0_apt_APT_MAL_CN_Wocao_webshell_ver_jsp {
    meta:
...
rule Neo23x0_apt_APT_MAL_CN_Wocao_webshell_webinfo {
    meta:

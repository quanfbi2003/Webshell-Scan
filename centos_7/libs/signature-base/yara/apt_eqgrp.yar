...
rule Neo23x0_apt_EQGRP_noclient_3_0_5 {
	meta:
...
rule Neo23x0_apt_EQGRP_installdate {
	meta:
...
rule Neo23x0_apt_EQGRP_teflondoor {
	meta:
...
rule Neo23x0_apt_EQGRP_durablenapkin_solaris_2_0_1 {
	meta:
...
rule Neo23x0_apt_EQGRP_teflonhandle {
	meta:
...
rule Neo23x0_apt_EQGRP_dn_1_0_2_1 {
	meta:
...
rule Neo23x0_apt_EQGRP_bc_parser {
	meta:
...
rule Neo23x0_apt_EQGRP_1212_dehex {
	meta:
...
rule Neo23x0_apt_install_get_persistent_filenames {
	meta:
...
rule Neo23x0_apt_EQGRP_create_dns_injection {
	meta:
...
rule Neo23x0_apt_EQGRP_screamingplow {
	meta:
...
rule Neo23x0_apt_EQGRP_MixText {
	meta:
...
rule Neo23x0_apt_EQGRP_tunnel_state_reader {
	meta:
...
rule Neo23x0_apt_EQGRP_payload {
	meta:
...
rule Neo23x0_apt_EQGRP_eligiblecandidate {
	meta:
...
rule Neo23x0_apt_EQGRP_BUSURPER_2211_724 {
	meta:
...
rule Neo23x0_apt_EQGRP_networkProfiler_orderScans {
	meta:
...
rule Neo23x0_apt_EQGRP_epicbanana_2_1_0_1 {
	meta:
...
rule Neo23x0_apt_EQGRP_sniffer_xml2pcap {
	meta:
...
rule Neo23x0_apt_EQGRP_BananaAid {
	meta:
...
rule Neo23x0_apt_EQGRP_SecondDate_2211 {
	meta:
...
rule Neo23x0_apt_EQGRP_config_jp1_UA {
	meta:
...
rule Neo23x0_apt_EQGRP_userscript {
	meta:
...
rule Neo23x0_apt_EQGRP_BBALL_M50FW08_2201 {
	meta:
...
rule Neo23x0_apt_EQGRP_BUSURPER_3001_724 {
	meta:
...
rule Neo23x0_apt_EQGRP_tinyhttp_setup {
	meta:
...
rule Neo23x0_apt_EQGRP_shellcode {
	meta:
...
rule Neo23x0_apt_EQGRP_jetplow_SH {
	meta:
...
rule Neo23x0_apt_EQGRP_BPATROL_2201 {
	meta:
...
rule Neo23x0_apt_EQGRP_extrabacon {
	meta:
...
rule Neo23x0_apt_EQGRP_sploit_py {
	meta:
...
rule Neo23x0_apt_EQGRP_uninstallPBD {
	meta:
...
rule Neo23x0_apt_EQGRP_BICECREAM {
	meta:
...
rule Neo23x0_apt_EQGRP_create_http_injection {
	meta:
...
rule Neo23x0_apt_EQGRP_BFLEA_2201 {
	meta:
...
rule Neo23x0_apt_EQGRP_BpfCreator_RHEL4 {
	meta:
...
rule Neo23x0_apt_EQGRP_StoreFc {
	meta:
...
rule Neo23x0_apt_EQGRP_hexdump {
	meta:
...
rule Neo23x0_apt_EQGRP_BARPUNCH_BPICKER {
	meta:
...
rule Neo23x0_apt_EQGRP_Implants_Gen6 {
	meta:
...
rule Neo23x0_apt_EQGRP_Implants_Gen5 {
	meta:
		description = "EQGRP Toolset Firewall"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_EQGRP_pandarock {
	meta:
...
rule Neo23x0_apt_EQGRP_BananaUsurper_writeJetPlow {
	meta:
...
rule Neo23x0_apt_EQGRP_Implants_Gen4 {
	meta:
...
rule Neo23x0_apt_EQGRP_Implants_Gen3 {
	meta:
		description = "EQGRP Toolset Firewall"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_EQGRP_BLIAR_BLIQUER {
	meta:
...
rule Neo23x0_apt_EQGRP_Implants_Gen2 {
	meta:
		description = "EQGRP Toolset Firewall"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_EQGRP_Implants_Gen1 {
	meta:
		description = "EQGRP Toolset Firewall"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_EQGRP_eligiblebombshell_generic {
	meta:
...
rule Neo23x0_apt_EQGRP_ssh_telnet_29 {
	meta:
...
rule Neo23x0_apt_EQGRP_tinyexec {
	meta:
...
rule Neo23x0_apt_EQGRP_callbacks {
	meta:
...
rule Neo23x0_apt_EQGRP_Extrabacon_Output {
	meta:
...
rule Neo23x0_apt_EQGRP_Unique_Strings {
	meta:
...
rule Neo23x0_apt_EQGRP_RC5_RC6_Opcode {
	meta:
...
rule Neo23x0_apt_EquationGroup_modifyAudit_Implant {
   meta:
...
rule Neo23x0_apt_EquationGroup_modifyAudit_Lp {
   meta:
...
rule Neo23x0_apt_EquationGroup_ProcessHide_Lp {
   meta:
...
rule Neo23x0_apt_EquationGroup_pwdump_Implant {
   meta:
...
rule Neo23x0_apt_EquationGroup_EquationDrug_Gen_5 {
   meta:
...
rule Neo23x0_apt_EquationGroup_PC_Level3_http_flav_dll {
   meta:
...
rule Neo23x0_apt_EquationGroup_LSADUMP_Lp {
   meta:
...
rule Neo23x0_apt_EquationGroup_EquationDrug_mstcp32 {
   meta:
...
rule Neo23x0_apt_EquationGroup_nethide_Lp {
   meta:
...
rule Neo23x0_apt_EquationGroup_PC_Level4_flav_dll_x64 {
   meta:
...
rule Neo23x0_apt_EquationGroup_PC_Level4_flav_exe {
   meta:
...
rule Neo23x0_apt_EquationGroup_processinfo_Implant {
   meta:
...
rule Neo23x0_apt_EquationGroup_EquationDrug_Gen_2 {
   meta:
...
rule Neo23x0_apt_EquationGroup_EquationDrug_ntevt {
   meta:
...
rule Neo23x0_apt_EquationGroup_nethide_Implant {
   meta:
...
rule Neo23x0_apt_EquationGroup_EquationDrug_Gen_4 {
   meta:
...
rule Neo23x0_apt_EquationGroup_EquationDrug_tdi6 {
   meta:
...
rule Neo23x0_apt_EquationGroup_modifyAuthentication_Implant {
   meta:
...
rule Neo23x0_apt_EquationGroup_ntfltmgr {
   meta:
...
rule Neo23x0_apt_EquationGroup_DXGHLP16 {
   meta:
...
rule Neo23x0_apt_EquationGroup_EquationDrug_msgkd {
   meta:
...
rule Neo23x0_apt_EquationGroup_RunAsChild_Lp {
   meta:
...
rule Neo23x0_apt_EquationGroup_EquationDrug_Gen_6 {
   meta:
...
rule Neo23x0_apt_EquationGroup_PC_Level3_http_flav_dll_x64 {
   meta:
...
rule Neo23x0_apt_EquationGroup_EquationDrug_Gen_3 {
   meta:
...
rule Neo23x0_apt_EquationGroup_GetAdmin_Lp {
   meta:
...
rule Neo23x0_apt_EquationGroup_ModifyGroup_Lp {
   meta:
...
rule Neo23x0_apt_EquationGroup_pwdump_Lp {
   meta:
...
rule Neo23x0_apt_EquationGroup_EventLogEdit_Implant {
   meta:
...
rule Neo23x0_apt_EquationGroup_PortMap_Lp {
   meta:
...
rule Neo23x0_apt_EquationGroup_ProcessOptions_Lp {
   meta:
...
rule Neo23x0_apt_EquationGroup_PassFreely_Lp {
   meta:
...
rule Neo23x0_apt_EquationGroup_EquationDrug_Gen_1 {
   meta:
...
rule Neo23x0_apt_EquationDrug_MS_Identifier {
	meta:

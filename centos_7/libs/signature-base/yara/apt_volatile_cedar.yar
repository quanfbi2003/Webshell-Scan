...
rule Neo23x0_apt_Explosive_EXE : APT {
	meta:
...
rule Neo23x0_apt_Explosion_Sample_1 {
	meta:
		description = "Explosion/Explosive Malware - Volatile Cedar APT"
...
rule Neo23x0_apt_Explosion_Sample_2 {
	meta:
		description = "Explosion/Explosive Malware - Volatile Cedar APT"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_Explosion_Generic_1 {
	meta:
...
rule Neo23x0_apt_Webshell_Caterpillar_ASPX {
	meta:

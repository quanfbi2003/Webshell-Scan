...
rule Neo23x0_apt_TA17_293A_malware_1 {
    meta:
...
rule Neo23x0_apt_TA17_293A_energetic_bear_api_hashing_tool {
   meta:
...
rule Neo23x0_apt_TA17_293A_Query_XML_Code_MAL_DOC_PT_2 {
    meta:
...
rule Neo23x0_apt_TA17_293A_Query_XML_Code_MAL_DOC {
    meta:
...
rule Neo23x0_apt_TA17_293A_Query_Javascript_Decode_Function {
    meta:
...
rule Neo23x0_apt_TA17_293A_Hacktool_PS_1 {
   meta:
...
rule Neo23x0_apt_TA17_293A_Hacktool_Touch_MAC_modification {
   meta:
      description = "Auto-generated rule"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_TA17_293A_Hacktool_Exploit_MS16_032 {
   meta:
      description = "Auto-generated rule"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_Imphash_UPX_Packed_Malware_1_TA17_293A {
   meta:
...
rule Neo23x0_apt_Imphash_Malware_2_TA17_293A : HIGHVOL {
   meta:
      description = "Detects malware based on Imphash of malware used in TA17-293A"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"

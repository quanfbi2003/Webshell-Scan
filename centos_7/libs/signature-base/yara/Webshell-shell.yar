...
rule DarkenCode_Web_Weevely_Webshell {
	meta:
...
rule DarkenCode_Web_webshell_h4ntu_shell_powered_by_tsoi_ {
	meta:
...
rule DarkenCode_Web_webshell_PHP_sql {
	meta:
...
rule DarkenCode_Web_webshell_PHP_a {
	meta:
...
rule DarkenCode_Web_webshell_iMHaPFtp_2 {
	meta:
...
rule DarkenCode_Web_webshell_Jspspyweb {
	meta:
...
rule DarkenCode_Web_webshell_Safe_Mode_Bypass_PHP_4_4_2_and_PHP_5_1_2 {
	meta:
...
rule DarkenCode_Web_webshell_SimAttacker_Vrsion_1_0_0_priv8_4_My_friend {
	meta:
...
rule DarkenCode_Web_webshell_phpshell_2_1_pwhash {
	meta:
...
rule DarkenCode_Web_webshell_PHPRemoteView {
	meta:
...
rule DarkenCode_Web_webshell_jsp_12302 {
	meta:
...
rule DarkenCode_Web_webshell_caidao_shell_guo {
	meta:
...
rule DarkenCode_Web_webshell_PHP_redcod {
	meta:
...
rule DarkenCode_Web_webshell_remview_fix {
	meta:
...
rule DarkenCode_Web_webshell_asp_cmd {
	meta:
...
rule DarkenCode_Web_webshell_php_sh_server {
	meta:
...
rule DarkenCode_Web_webshell_PH_Vayv_PH_Vayv {
	meta:
...
rule DarkenCode_Web_webshell_caidao_shell_ice {
	meta:
...
rule DarkenCode_Web_webshell_cihshell_fix {
	meta:
...
rule DarkenCode_Web_webshell_asp_shell {
	meta:
...
rule DarkenCode_Web_webshell_Private_i3lue {
	meta:
...
rule DarkenCode_Web_webshell_php_up {
	meta:
...
rule DarkenCode_Web_webshell_Mysql_interface_v1_0 {
	meta:
...
rule DarkenCode_Web_webshell_php_s_u {
	meta:
...
rule DarkenCode_Web_webshell_phpshell_2_1_config {
	meta:
...
rule DarkenCode_Web_webshell_asp_EFSO_2 {
	meta:
...
rule DarkenCode_Web_webshell_jsp_up {
	meta:
...
rule DarkenCode_Web_webshell_NetworkFileManagerPHP {
	meta:
...
rule DarkenCode_Web_webshell_Server_Variables {
	meta:
...
rule DarkenCode_Web_webshell_caidao_shell_ice_2 {
	meta:
...
rule DarkenCode_Web_webshell_caidao_shell_mdb {
	meta:
...
rule DarkenCode_Web_webshell_jsp_guige {
	meta:
...
rule DarkenCode_Web_webshell_phpspy2010 {
	meta:
...
rule DarkenCode_Web_webshell_asp_ice {
	meta:
		description = "Web Shell - file ice.asp"
		author = "Florian Roth"
		date = "2014/01/28"
...
rule DarkenCode_Web_webshell_drag_system {
	meta:
...
rule DarkenCode_Web_webshell_DarkBlade1_3_asp_indexx {
	meta:
...
rule DarkenCode_Web_webshell_phpshell3 {
	meta:
...
rule DarkenCode_Web_webshell_jsp_hsxa {
	meta:
...
rule DarkenCode_Web_webshell_jsp_utils {
	meta:
...
rule DarkenCode_Web_webshell_asp_01 {
	meta:
...
rule DarkenCode_Web_webshell_asp_404 {
	meta:
...
rule DarkenCode_Web_webshell_webshell_cnseay02_1 {
	meta:
...
rule DarkenCode_Web_webshell_php_fbi {
	meta:
...
rule DarkenCode_Web_webshell_B374kPHP_B374k {
	meta:
...
rule DarkenCode_Web_webshell_cmd_asp_5_1 {
	meta:
...
rule DarkenCode_Web_webshell_php_dodo_zip {
	meta:
...
rule DarkenCode_Web_webshell_aZRaiLPhp_v1_0 {
	meta:
...
rule DarkenCode_Web_webshell_php_list {
	meta:
...
rule DarkenCode_Web_webshell_ironshell {
	meta:
...
rule DarkenCode_Web_webshell_caidao_shell_404 {
	meta:
...
rule DarkenCode_Web_webshell_ASP_aspydrv {
	meta:
...
rule DarkenCode_Web_webshell_jsp_web {
	meta:
...
rule DarkenCode_Web_webshell_mysqlwebsh {
	meta:
...
rule DarkenCode_Web_webshell_jspShell {
	meta:
...
rule DarkenCode_Web_webshell_Dx_Dx {
	meta:
...
rule DarkenCode_Web_webshell_asp_ntdaddy {
	meta:
...
rule DarkenCode_Web_webshell_MySQL_Web_Interface_Version_0_8 {
	meta:
...
rule DarkenCode_Web_webshell_elmaliseker_2 {
	meta:
...
rule DarkenCode_Web_webshell_ASP_RemExp {
	meta:
...
rule DarkenCode_Web_webshell_jsp_list1 {
	meta:
...
rule DarkenCode_Web_webshell_phpkit_1_0_odd {
	meta:
...
rule DarkenCode_Web_webshell_jsp_123 {
	meta:
...
rule DarkenCode_Web_webshell_asp_1 {
	meta:
...
rule DarkenCode_Web_webshell_ASP_tool {
	meta:
...
rule DarkenCode_Web_webshell_cmd_win32 {
	meta:
...
rule DarkenCode_Web_webshell_jsp_jshell {
	meta:
...
rule DarkenCode_Web_webshell_ASP_zehir4 {
	meta:
...
rule DarkenCode_Web_webshell_wsb_idc {
	meta:
...
rule DarkenCode_Web_webshell_cpg_143_incl_xpl {
	meta:
...
rule DarkenCode_Web_webshell_mumaasp_com {
	meta:
...
rule DarkenCode_Web_webshell_php_404 {
	meta:
		description = "Web Shell - file 404.php"
		author = "Florian Roth"
		date = "2014/01/28"
...
rule DarkenCode_Web_webshell_webshell_cnseay_x {
	meta:
...
rule DarkenCode_Web_webshell_asp_up {
	meta:
...
rule DarkenCode_Web_webshell_phpkit_0_1a_odd {
	meta:
		description = "Web Shell - file odd.php"
		author = "Florian Roth"
		date = "2014/01/28"
...
rule DarkenCode_Web_webshell_PHP_Shell_x3 {
	meta:
...
rule DarkenCode_Web_webshell_PHP_g00nv13 {
	meta:
...
rule DarkenCode_Web_webshell_php_h6ss {
	meta:
...
rule DarkenCode_Web_webshell_jsp_zx {
	meta:
...
rule DarkenCode_Web_webshell_Ani_Shell {
	meta:
...
rule DarkenCode_Web_webshell_jsp_k8cmd {
	meta:
...
rule DarkenCode_Web_webshell_jsp_cmd {
	meta:
...
rule DarkenCode_Web_webshell_jsp_k81 {
	meta:
...
rule DarkenCode_Web_webshell_ASP_zehir {
	meta:
...
rule DarkenCode_Web_webshell_Worse_Linux_Shell {
	meta:
...
rule DarkenCode_Web_webshell_zacosmall {
	meta:
...
rule DarkenCode_Web_webshell_Liz0ziM_Private_Safe_Mode_Command_Execuriton_Bypass_Exploit {
	meta:
...
rule DarkenCode_Web_webshell_redirect {
	meta:
...
rule DarkenCode_Web_webshell_jsp_cmdjsp {
	meta:
...
rule DarkenCode_Web_webshell_Java_Shell {
	meta:
...
rule DarkenCode_Web_webshell_asp_1d {
	meta:
...
rule DarkenCode_Web_webshell_jsp_IXRbE {
	meta:
...
rule DarkenCode_Web_webshell_PHP_G5 {
	meta:
...
rule DarkenCode_Web_webshell_PHP_r57142 {
	meta:
...
rule DarkenCode_Web_webshell_jsp_tree {
	meta:
...
rule DarkenCode_Web_webshell_C99madShell_v_3_0_smowu {
	meta:
...
rule DarkenCode_Web_webshell_simple_backdoor {
	meta:
...
rule DarkenCode_Web_webshell_Macker_s_Private_PHPShell {
	meta:
...
rule DarkenCode_Web_webshell_Antichat_Shell_v1_3_2 {
	meta:
...
rule DarkenCode_Web_webshell_Safe_mode_breaker {
	meta:
...
rule DarkenCode_Web_webshell_Sst_Sheller {
	meta:
...
rule DarkenCode_Web_webshell_jsp_list {
	meta:
...
rule DarkenCode_Web_webshell_PHPJackal_v1_5 {
	meta:
...
rule DarkenCode_Web_webshell_customize {
	meta:
...
rule DarkenCode_Web_webshell_s72_Shell_v1_1_Coding {
	meta:
...
rule DarkenCode_Web_webshell_jsp_sys3 {
	meta:
...
rule DarkenCode_Web_webshell_jsp_guige02 {
	meta:
...
rule DarkenCode_Web_webshell_php_ghost {
	meta:
...
rule DarkenCode_Web_webshell_WinX_Shell {
	meta:
...
rule DarkenCode_Web_webshell_Crystal_Crystal {
	meta:
...
rule DarkenCode_Web_webshell_r57_1_4_0 {
	meta:
...
rule DarkenCode_Web_webshell_jsp_hsxa1 {
	meta:
...
rule DarkenCode_Web_webshell_asp_ajn {
	meta:
...
rule DarkenCode_Web_webshell_php_cmd {
	meta:
...
rule DarkenCode_Web_webshell_asp_list {
	meta:
...
rule DarkenCode_Web_webshell_PHP_co {
	meta:
...
rule DarkenCode_Web_webshell_PHP_150 {
	meta:
...
rule DarkenCode_Web_webshell_jsp_cmdjsp_2 {
	meta:
		description = "Web Shell - file cmdjsp.jsp"
		author = "Florian Roth"
		date = "2014/01/28"
...
rule DarkenCode_Web_webshell_PHP_c37 {
	meta:
...
rule DarkenCode_Web_webshell_PHP_b37 {
	meta:
...
rule DarkenCode_Web_webshell_php_backdoor {
	meta:
...
rule DarkenCode_Web_webshell_asp_dabao {
	meta:
...
rule DarkenCode_Web_webshell_php_2 {
	meta:
...
rule DarkenCode_Web_webshell_asp_cmdasp {
	meta:
...
rule DarkenCode_Web_webshell_spjspshell {
	meta:
...
rule DarkenCode_Web_webshell_jsp_action {
	meta:
...
rule DarkenCode_Web_webshell_Inderxer {
	meta:
...
rule DarkenCode_Web_webshell_asp_Rader {
	meta:
...
rule DarkenCode_Web_webshell_c99_madnet_smowu {
	meta:
		description = "Web Shell - file smowu.php"
		author = "Florian Roth"
		date = "2014/01/28"
...
rule DarkenCode_Web_webshell_php_moon {
	meta:
...
rule DarkenCode_Web_webshell_jsp_jdbc {
	meta:
...
rule DarkenCode_Web_webshell_minupload {
	meta:
...
rule DarkenCode_Web_webshell_ELMALISEKER_Backd00r {
	meta:
...
rule DarkenCode_Web_webshell_PHP_bug_1_ {
	meta:
...
rule DarkenCode_Web_webshell_caidao_shell_hkmjj {
	meta:
...
rule DarkenCode_Web_webshell_jsp_asd {
	meta:
...
rule DarkenCode_Web_webshell_jsp_inback3 {
	meta:
...
rule DarkenCode_Web_webshell_metaslsoft {
	meta:
...
rule DarkenCode_Web_webshell_asp_Ajan {
	meta:
...
rule DarkenCode_Web_webshell_config_myxx_zend {
	meta:
...
rule DarkenCode_Web_webshell_browser_201_3_ma_download {
	meta:
...
rule DarkenCode_Web_webshell_itsec_itsecteam_shell_jHn {
	meta:
...
rule DarkenCode_Web_webshell_ghost_source_icesword_silic {
	meta:
...
rule DarkenCode_Web_webshell_JspSpy_JspSpyJDK5_JspSpyJDK51_luci_jsp_spy2009_m_ma3_xxx {
	meta:
...
rule DarkenCode_Web_webshell_2_520_job_ma1_ma4_2 {
	meta:
...
rule DarkenCode_Web_webshell_000_403_807_a_c5_config_css_dm_he1p_JspSpy_JspSpyJDK5_JspSpyJDK51_luci_jsp_xxx {
	meta:
...
rule DarkenCode_Web_webshell_wso2_5_1_wso2_5_wso2 {
	meta:
...
rule DarkenCode_Web_webshell_000_403_c5_queryDong_spyjsp2010_t00ls {
	meta:
...
rule DarkenCode_Web_webshell_404_data_suiyue {
	meta:
...
rule DarkenCode_Web_webshell_r57shell_r57shell127_SnIpEr_SA_Shell_EgY_SpIdEr_ShElL_V2_r57_xxx {
	meta:
...
rule DarkenCode_Web_webshell_807_a_css_dm_he1p_JspSpy_xxx {
	meta:
...
rule DarkenCode_Web_webshell_201_3_ma_download {
	meta:
...
rule DarkenCode_Web_webshell_browser_201_3_400_in_JFolder_jfolder01_jsp_leo_ma_warn_webshell_nc_download {
	meta:
...
rule DarkenCode_Web_webshell_shell_phpspy_2006_arabicspy {
	meta:
...
rule DarkenCode_Web_webshell_in_JFolder_jfolder01_jsp_leo_warn {
	meta:
...
rule DarkenCode_Web_webshell_2_520_icesword_job_ma1_ma4_2 {
	meta:
...
rule DarkenCode_Web_webshell_phpspy_2005_full_phpspy_2005_lite_PHPSPY {
	meta:
...
rule DarkenCode_Web_webshell_shell_phpspy_2006_arabicspy_hkrkoz {
	meta:
...
rule DarkenCode_Web_webshell_c99_Shell_ci_Biz_was_here_c100_v_xxx {
	meta:
...
rule DarkenCode_Web_webshell_2008_2009lite_2009mssql {
	meta:
...
rule DarkenCode_Web_webshell_shell_phpspy_2005_full_phpspy_2005_lite_phpspy_2006_arabicspy_PHPSPY_hkrkoz {
	meta:
...
rule DarkenCode_Web_webshell_807_dm_JspSpyJDK5_m_cofigrue {
	meta:
...
rule DarkenCode_Web_webshell_Dive_Shell_1_0_Emperor_Hacking_Team_xxx {
	meta:
...
rule DarkenCode_Web_webshell_404_data_in_JFolder_jfolder01_xxx {
	meta:
...
rule DarkenCode_Web_webshell_jsp_reverse_jsp_reverse_jspbd {
	meta:
...
rule DarkenCode_Web_webshell_400_in_JFolder_jfolder01_jsp_leo_warn_webshell_nc {
	meta:
...
rule DarkenCode_Web_webshell_2_520_job_JspWebshell_1_2_ma1_ma4_2 {
	meta:
...
rule DarkenCode_Web_webshell_shell_2008_2009mssql_phpspy_2005_full_phpspy_2006_arabicspy_hkrkoz {
	meta:
...
rule DarkenCode_Web_webshell_gfs_sh_r57shell_r57shell127_SnIpEr_SA_xxx {
	meta:
...
rule DarkenCode_Web_webshell_itsec_PHPJackal_itsecteam_shell_jHn {
	meta:
...
rule DarkenCode_Web_webshell_Shell_ci_Biz_was_here_c100_v_xxx {
	meta:
...
rule DarkenCode_Web_webshell_NIX_REMOTE_WEB_SHELL_NIX_REMOTE_WEB_xxx1 {
	meta:
...
rule DarkenCode_Web_webshell_c99_c99shell_c99_w4cking_Shell_xxx {
	meta:
...
rule DarkenCode_Web_webshell_2008_2009mssql_phpspy_2005_full_phpspy_2006_arabicspy_hkrkoz {
	meta:
...
rule DarkenCode_Web_webshell_c99_c66_c99_shadows_mod_c99shell {
	meta:
...
rule DarkenCode_Web_webshell_he1p_JspSpy_nogfw_ok_style_1_JspSpy1 {
	meta:
...
rule DarkenCode_Web_webshell_000_403_c5_config_myxx_queryDong_spyjsp2010_zend {
	meta:
...
rule DarkenCode_Web_webshell_c99_c99shell_c99_c99shell {
	meta:
...
rule DarkenCode_Web_webshell_r57shell127_r57_iFX_r57_kartal_r57_antichat {
	meta:
...
rule DarkenCode_Web_webshell_NIX_REMOTE_WEB_SHELL_nstview_xxx {
	meta:
...
rule DarkenCode_Web_webshell_000_403_807_a_c5_config_css_dm_he1p_xxx {
	meta:
...
rule DarkenCode_Web_webshell_2_520_icesword_job_ma1 {
	meta:
...
rule DarkenCode_Web_webshell_404_data_in_JFolder_jfolder01_jsp_suiyue_warn {
	meta:
...
rule DarkenCode_Web_webshell_phpspy_2005_full_phpspy_2005_lite_phpspy_2006_PHPSPY {
	meta:
...
rule DarkenCode_Web_webshell_c99_locus7s_c99_w4cking_xxx {
	meta:
...
rule DarkenCode_Web_webshell_browser_201_3_ma_ma2_download {
	meta:
...
rule DarkenCode_Web_webshell_000_403_c5_queryDong_spyjsp2010 {
	meta:
...
rule DarkenCode_Web_webshell_r57shell127_r57_kartal_r57 {
	meta:
...
rule DarkenCode_Web_webshell_webshells_new_con2 {
	meta:
...
rule DarkenCode_Web_webshell_webshells_new_make2 {
	meta:
...
rule DarkenCode_Web_webshell_webshells_new_aaa {
	meta:
...
rule DarkenCode_Web_webshell_Expdoor_com_ASP {
	meta:
...
rule DarkenCode_Web_webshell_webshells_new_php2 {
	meta:
...
rule DarkenCode_Web_webshell_bypass_iisuser_p {
	meta:
...
rule DarkenCode_Web_webshell_sig_404super {
	meta:
...
rule DarkenCode_Web_webshell_webshells_new_JSP {
	meta:
...
rule DarkenCode_Web_webshell_webshell_123 {
	meta:
...
rule DarkenCode_Web_webshell_dev_core {
	meta:
...
rule DarkenCode_Web_webshell_webshells_new_pHp {
	meta:
...
rule DarkenCode_Web_webshell_webshells_new_pppp {
	meta:
...
rule DarkenCode_Web_webshell_webshells_new_code {
	meta:
...
rule DarkenCode_Web_webshell_webshells_new_jspyyy {
	meta:
...
rule DarkenCode_Web_webshell_webshells_new_xxxx {
	meta:
...
rule DarkenCode_Web_webshell_webshells_new_JJjsp3 {
	meta:
...
rule DarkenCode_Web_webshell_webshells_new_PHP1 {
	meta:
...
rule DarkenCode_Web_webshell_webshells_new_JJJsp2 {
	meta:
...
rule DarkenCode_Web_webshell_webshells_new_radhat {
	meta:
...
rule DarkenCode_Web_webshell_webshells_new_asp1 {
	meta:
...
rule DarkenCode_Web_webshell_webshells_new_php6 {
	meta:
...
rule DarkenCode_Web_webshell_webshells_new_xxx {
	meta:
...
rule DarkenCode_Web_webshell_GetPostpHp {
	meta:
...
rule DarkenCode_Web_webshell_webshells_new_php5 {
	meta:
...
rule DarkenCode_Web_webshell_webshells_new_Asp {
	meta:
...
rule DarkenCode_Web_WebShell_cgi {
	meta:
...
rule DarkenCode_Web_WinX_Shell_html {
	meta:
...
rule DarkenCode_Web_Dx_php_php {
	meta:
...
rule DarkenCode_Web_csh_php_php {
	meta:
...
rule DarkenCode_Web_pHpINJ_php_php {
	meta:
...
rule DarkenCode_Web_sig_2008_php_php {
	meta:
...
rule DarkenCode_Web_ak74shell_php_php {
	meta:
...
rule DarkenCode_Web_Rem_View_php_php {
	meta:
...
rule DarkenCode_Web_Java_Shell_js {
	meta:
...
rule DarkenCode_Web_STNC_php_php {
	meta:
...
rule DarkenCode_Web_aZRaiLPhp_v1_0_php {
	meta:
...
rule DarkenCode_Web_Moroccan_Spamers_Ma_EditioN_By_GhOsT_php {
	meta:
...
rule DarkenCode_Web_zacosmall_php {
	meta:
...
rule DarkenCode_Web_CmdAsp_asp {
	meta:
...
rule DarkenCode_Web_simple_backdoor_php {
	meta:
...
rule DarkenCode_Web_mysql_shell_php {
	meta:
...
rule DarkenCode_Web_Dive_Shell_1_0___Emperor_Hacking_Team_php {
	meta:
...
rule DarkenCode_Web_Asmodeus_v0_1_pl {
	meta:
...
rule DarkenCode_Web_backup_php_often_with_c99shell {
	meta:
...
rule DarkenCode_Web_Reader_asp {
	meta:
...
rule DarkenCode_Web_phpshell17_php {
	meta:
...
rule DarkenCode_Web_myshell_php_php {
	meta:
...
rule DarkenCode_Web_SimShell_1_0___Simorgh_Security_MGZ_php {
	meta:
...
rule DarkenCode_Web_jspshall_jsp {
	meta:
...
rule DarkenCode_Web_webshell_php {
	meta:
...
rule DarkenCode_Web_rootshell_php {
	meta:
...
rule DarkenCode_Web_connectback2_pl {
	meta:
...
rule DarkenCode_Web_DefaceKeeper_0_2_php {
	meta:
...
rule DarkenCode_Web_shells_PHP_wso {
	meta:
...
rule DarkenCode_Web_backdoor1_php {
	meta:
...
rule DarkenCode_Web_elmaliseker_asp {
	meta:
...
rule DarkenCode_Web_indexer_asp {
	meta:
...
rule DarkenCode_Web_DxShell_php_php {
	meta:
...
rule DarkenCode_Web_s72_Shell_v1_1_Coding_html {
	meta:
...
rule DarkenCode_Web_hidshell_php_php {
	meta:
...
rule DarkenCode_Web_PHP_Backdoor_Connect_pl_php {
	meta:
...
rule DarkenCode_Web_Antichat_Socks5_Server_php_php {
	meta:
...
rule DarkenCode_Web_Antichat_Shell_v1_3_php {
	meta:
...
rule DarkenCode_Web_Safe_Mode_Bypass_PHP_4_4_2_and_PHP_5_1_2_php {
	meta:
...
rule DarkenCode_Web_mysql_php_php {
	meta:
...
rule DarkenCode_Web_Worse_Linux_Shell_php {
	meta:
...
rule DarkenCode_Web_cyberlords_sql_php_php {
	meta:
...
rule DarkenCode_Web_cmd_asp_5_1_asp {
	meta:
...
rule DarkenCode_Web_pws_php_php {
	meta:
...
rule DarkenCode_Web_PHP_Shell_php_php {
	meta:
...
rule DarkenCode_Web_Ayyildiz_Tim___AYT__Shell_v_2_1_Biz_html {
	meta:
...
rule DarkenCode_Web_EFSO_2_asp {
	meta:
...
rule DarkenCode_Web_lamashell_php {
	meta:
...
rule DarkenCode_Web_Ajax_PHP_Command_Shell_php {
	meta:
...
rule DarkenCode_Web_JspWebshell_1_2_jsp {
	meta:
...
rule DarkenCode_Web_Sincap_php_php {
	meta:
...
rule DarkenCode_Web_Test_php_php {
	meta:
...
rule DarkenCode_Web_Phyton_Shell_py {
	meta:
...
rule DarkenCode_Web_mysql_tool_php_php {
	meta:
...
rule DarkenCode_Web_Zehir_4_asp {
	meta:
...
rule DarkenCode_Web_sh_php_php {
	meta:
...
rule DarkenCode_Web_phpbackdoor15_php {
	meta:
...
rule DarkenCode_Web_phpjackal_php {
	meta:
...
rule DarkenCode_Web_sql_php_php {
	meta:
...
rule DarkenCode_Web_cgi_python_py {
	meta:
...
rule DarkenCode_Web_ru24_post_sh_php_php {
	meta:
...
rule DarkenCode_Web_DTool_Pro_php {
	meta:
...
rule DarkenCode_Web_telnetd_pl {
	meta:
...
rule DarkenCode_Web_php_include_w_shell_php {
	meta:
...
rule DarkenCode_Web_Safe0ver_Shell__Safe_Mod_Bypass_By_Evilc0der_php {
	meta:
...
rule DarkenCode_Web_shell_php_php {
	meta:
...
rule DarkenCode_Web_telnet_cgi {
	meta:
...
rule DarkenCode_Web_ironshell_php {
	meta:
...
rule DarkenCode_Web_backdoorfr_php {
	meta:
...
rule DarkenCode_Web_aspydrv_asp {
	meta:
...
rule DarkenCode_Web_cmdjsp_jsp {
	meta:
...
rule DarkenCode_Web_h4ntu_shell__powered_by_tsoi_ {
	meta:
...
rule DarkenCode_Web_PHANTASMA_php {
	meta:
...
rule DarkenCode_Web_MySQL_Web_Interface_Version_0_8_php {
	meta:
...
rule DarkenCode_Web_simple_cmd_html {
	meta:
...
rule DarkenCode_Web__1_c2007_php_php_c100_php {
	meta:
...
rule DarkenCode_Web__nst_php_php_img_php_php_nstview_php_php {
	meta:
...
rule DarkenCode_Web__network_php_php_xinfo_php_php_nfm_php_php {
	meta:
...
rule DarkenCode_Web__w_php_php_c99madshell_v2_1_php_php_wacking_php_php_SpecialShell_99_php_php {
	meta:
...
rule DarkenCode_Web__r577_php_php_SnIpEr_SA_Shell_php_r57_php_php_r57_Shell_php_php_spy_php_php_s_php_php {
	meta:
...
rule DarkenCode_Web__c99shell_v1_0_php_php_c99php_SsEs_php_php_ctt_sh_php_php {
	meta:
...
rule DarkenCode_Web__r577_php_php_spy_php_php_s_php_php {
	meta:
...
rule DarkenCode_Web__w_php_php_c99madshell_v2_1_php_php_wacking_php_php_c99shell_v1_0_php_php_c99php_SpecialShell_99_php_php {
	meta:
...
rule DarkenCode_Web__w_php_php_wacking_php_php_SpecialShell_99_php_php {
	meta:
...
rule DarkenCode_Web__w_php_php_c99madshell_v2_1_php_php_wacking_php_php_SsEs_php_php_SpecialShell_99_php_php {
	meta:
...
rule DarkenCode_Web__r577_php_php_SnIpEr_SA_Shell_php_r57_php_php_spy_php_php_s_php_php {
	meta:
...
rule DarkenCode_Web__r577_php_php_SnIpEr_SA_Shell_php_r57_php_php {
	meta:
...
rule DarkenCode_Web__r577_php_php_r57_Shell_php_php_spy_php_php_s_php_php {
	meta:
...
rule DarkenCode_Web__wacking_php_php_1_SpecialShell_99_php_php_c100_php {
	meta:
...
rule DarkenCode_Web__r577_php_php_r57_php_php_r57_Shell_php_php_spy_php_php_s_php_php {
	meta:
...
rule DarkenCode_Web__w_php_php_wacking_php_php_SsEs_php_php_SpecialShell_99_php_php {
	meta:
...
rule DarkenCode_Web__webadmin_php_php_iMHaPFtp_php_php_Private_i3lue_php {
	meta:
...
rule DarkenCode_Web_multiple_php_webshells {
	meta:
...
rule DarkenCode_Web__w_php_php_c99madshell_v2_1_php_php_wacking_php_php {
	meta:
...
rule DarkenCode_Web__w_php_php_c99madshell_v2_1_php_php_wacking_php_php_c99shell_v1_0_php_php_c99php {
	meta:
...
rule DarkenCode_Web__GFS_web_shell_ver_3_1_7___PRiV8_php_nshell_php_php_gfs_sh_php_php {
	meta:
...
rule DarkenCode_Web__w_php_php_c99madshell_v2_1_php_php_wacking_php_php_c99shell_v1_0_php_php_SpecialShell_99_php_php {
	meta:
...
rule DarkenCode_Web__w_php_php_wacking_php_php_c99shell_v1_0_php_php_c99php_SpecialShell_99_php_php {
	meta:
...
rule DarkenCode_Web__antichat_php_php_Fatalshell_php_php_a_gedit_php_php {
	meta:
...
rule DarkenCode_Web__c99shell_v1_0_php_php_c99php_SsEs_php_php {
	meta:
...
rule DarkenCode_Web__Crystal_php_nshell_php_php_load_shell_php_php {
	meta:
...
rule DarkenCode_Web__nst_php_php_cybershell_php_php_img_php_php_nstview_php_php {
	meta:
...
rule DarkenCode_Web__w_php_php_c99madshell_v2_1_php_php_wacking_php_php_dC3_Security_Crew_Shell_PRiV_php_SpecialShell_99_php_php {
	meta:
...
rule DarkenCode_Web__c99shell_v1_0_php_php_c99php_1_c2007_php_php_c100_php {
	meta:
...
rule DarkenCode_Web_multiple_php_webshells_2 {
	meta:
...
rule DarkenCode_Web__w_php_php_c99madshell_v2_1_php_php_wacking_php_php_1_SpecialShell_99_php_php {
	meta:
...
rule DarkenCode_Web__r577_php_php_r57_php_php_spy_php_php_s_php_php {
	meta:
...
rule DarkenCode_Web__nixrem_php_php_c99shell_v1_0_php_php_c99php_NIX_REMOTE_WEB_SHELL_v_0_5_alpha_Lite_Public_Version_php {
	meta:
...
rule DarkenCode_Web_DarkSecurityTeam_Webshell {
	meta:
...
rule DarkenCode_Web_GIFCloaked_Webshell {
	meta:
...
rule DarkenCode_Web_PHP_Cloaked_Webshell_SuperFetchExec {
	meta:
...
rule DarkenCode_Web_WebShell_RemExp_asp_php {
	meta:
...
rule DarkenCode_Web_WebShell_dC3_Security_Crew_Shell_PRiV {
	meta:
...
rule DarkenCode_Web_WebShell_simattacker {
	meta:
...
rule DarkenCode_Web_WebShell_DTool_Pro {
	meta:
...
rule DarkenCode_Web_WebShell_indexer_asp_php {
	meta:
...
rule DarkenCode_Web_WebShell_toolaspshell {
	meta:
...
rule DarkenCode_Web_WebShell_b374k_mini_shell_php_php {
	meta:
...
rule DarkenCode_Web_WebShell_Sincap_1_0 {
	meta:
...
rule DarkenCode_Web_WebShell_b374k_php {
	meta:
...
rule DarkenCode_Web_WebShell_SimAttacker___Vrsion_1_0_0___priv8_4_My_friend {
	meta:
...
rule DarkenCode_Web_WebShell_h4ntu_shell__powered_by_tsoi_ {
	meta:
...
rule DarkenCode_Web_WebShell_php_webshells_MyShell {
	meta:
...
rule DarkenCode_Web_WebShell_php_webshells_pws {
	meta:
...
rule DarkenCode_Web_WebShell_reader_asp_php {
	meta:
...
rule DarkenCode_Web_WebShell_php_webshells_pHpINJ {
	meta:
...
rule DarkenCode_Web_WebShell_php_webshells_NGH {
	meta:
...
rule DarkenCode_Web_WebShell_php_webshells_matamu {
	meta:
...
rule DarkenCode_Web_WebShell_ru24_post_sh {
	meta:
...
rule DarkenCode_Web_WebShell_hiddens_shell_v1 {
	meta:
...
rule DarkenCode_Web_WebShell_c99_madnet {
	meta:
...
rule DarkenCode_Web_WebShell_c99_locus7s {
	meta:
...
rule DarkenCode_Web_WebShell_JspWebshell_1_2 {
	meta:
...
rule DarkenCode_Web_WebShell_safe0ver {
	meta:
...
rule DarkenCode_Web_WebShell_Uploader {
	meta:
...
rule DarkenCode_Web_WebShell_php_webshells_kral {
	meta:
...
rule DarkenCode_Web_WebShell_cgitelnet {
	meta:
...
rule DarkenCode_Web_WebShell_Safe_Mode_Bypass_PHP_4_4_2_and_PHP_5_1_2_2 {
	meta:
...
rule DarkenCode_Web_WebShell_NTDaddy_v1_9 {
	meta:
...
rule DarkenCode_Web_WebShell_lamashell {
	meta:
...
rule DarkenCode_Web_WebShell_Simple_PHP_backdoor_by_DK {
	meta:
...
rule DarkenCode_Web_WebShell_Moroccan_Spamers_Ma_EditioN_By_GhOsT {
	meta:
...
rule DarkenCode_Web_WebShell_C99madShell_v__2_0_madnet_edition {
	meta:
...
rule DarkenCode_Web_WebShell_CmdAsp_asp_php {
	meta:
...
rule DarkenCode_Web_WebShell_NCC_Shell {
	meta:
...
rule DarkenCode_Web_WebShell_php_webshells_README {
	meta:
...
rule DarkenCode_Web_WebShell_backupsql {
	meta:
...
rule DarkenCode_Web_WebShell_AK_74_Security_Team_Web_Shell_Beta_Version {
	meta:
...
rule DarkenCode_Web_WebShell_php_webshells_cpanel {
	meta:
...
rule DarkenCode_Web_WebShell_accept_language {
	meta:
...
rule DarkenCode_Web_WebShell_php_webshells_529 {
	meta:
...
rule DarkenCode_Web_WebShell_STNC_WebShell_v0_8 {
	meta:
...
rule DarkenCode_Web_WebShell_php_webshells_tryag {
	meta:
...
rule DarkenCode_Web_WebShell_dC3_Security_Crew_Shell_PRiV_2 {
	meta:
...
rule DarkenCode_Web_WebShell_qsd_php_backdoor {
	meta:
...
rule DarkenCode_Web_WebShell_php_webshells_spygrup {
	meta:
...
rule DarkenCode_Web_WebShell_Web_shell__c_ShAnKaR {
	meta:
...
rule DarkenCode_Web_WebShell_Ayyildiz_Tim___AYT__Shell_v_2_1_Biz {
	meta:
...
rule DarkenCode_Web_WebShell_Gamma_Web_Shell {
	meta:
...
rule DarkenCode_Web_WebShell_php_webshells_aspydrv {
	meta:
...
rule DarkenCode_Web_WebShell_JspWebshell_1_2_2 {
	meta:
...
rule DarkenCode_Web_WebShell_g00nshell_v1_3 {
	meta:
...
rule DarkenCode_Web_WebShell_PHANTASMA {
	meta:
...
rule DarkenCode_Web_WebShell_php_webshells_cw {
	meta:
...
rule DarkenCode_Web_WebShell_php_include_w_shell {
	meta:
...
rule DarkenCode_Web_WebShell_mysql_tool {
	meta:
...
rule DarkenCode_Web_WebShell_PhpSpy_Ver_2006 {
	meta:
...
rule DarkenCode_Web_WebShell_ZyklonShell {
	meta:
...
rule DarkenCode_Web_WebShell_php_webshells_lolipop {
	meta:
...
rule DarkenCode_Web_WebShell_simple_cmd {
	meta:
...
rule DarkenCode_Web_WebShell_go_shell {
	meta:
...
rule DarkenCode_Web_WebShell_webshells_zehir4 {
	meta:
...
rule DarkenCode_Web_WebShell_zehir4_asp_php {
	meta:
...
rule DarkenCode_Web_WebShell_php_webshells_lostDC {
	meta:
...
rule DarkenCode_Web_WebShell_CasuS_1_5 {
	meta:
...
rule DarkenCode_Web_WebShell_ftpsearch {
	meta:
...
rule DarkenCode_Web_WebShell__Cyber_Shell_cybershell_Cyber_Shell__v_1_0_ {
	meta:
...
rule DarkenCode_Web_WebShell__Ajax_PHP_Command_Shell_Ajax_PHP_Command_Shell_soldierofallah {
	meta:
...
rule DarkenCode_Web_WebShell_Generic_PHP_7 {
	meta:
...
rule DarkenCode_Web_WebShell__Small_Web_Shell_by_ZaCo_small_zaco_zacosmall {
	meta:
...
rule DarkenCode_Web_WebShell_Generic_PHP_8 {
	meta:
...
rule DarkenCode_Web_WebShell__PH_Vayv_PHVayv_PH_Vayv_klasvayv_asp_php {
	meta:
...
rule DarkenCode_Web_WebShell_Generic_PHP_9 {
	meta:
...
rule DarkenCode_Web_WebShell__PH_Vayv_PHVayv_PH_Vayv {
	meta:
...
rule DarkenCode_Web_WebShell_Generic_PHP_1 {
	meta:
...
rule DarkenCode_Web_WebShell_Generic_PHP_2 {
	meta:
...
rule DarkenCode_Web_WebShell__CrystalShell_v_1_erne_stres {
	meta:
...
rule DarkenCode_Web_WebShell_Generic_PHP_3 {
	meta:
...
rule DarkenCode_Web_WebShell_Generic_PHP_4 {
	meta:
...
rule DarkenCode_Web_WebShell_Generic_PHP_5 {
	meta:
...
rule DarkenCode_Web_WebShell_GFS {
	meta:
...
rule DarkenCode_Web_WebShell__CrystalShell_v_1_sosyete_stres {
	meta:
...
rule DarkenCode_Web_WebShell_Generic_PHP_10 {
	meta:
...
rule DarkenCode_Web_WebShell_Generic_PHP_11 {
	meta:
...
rule DarkenCode_Web_WebShell__findsock_php_findsock_shell_php_reverse_shell {
	meta:
...
rule DarkenCode_Web_WebShell_Generic_PHP_6 {
	meta:
...
rule DarkenCode_Web_Unpack_Injectt {
	meta:
...
rule DarkenCode_Web_HYTop_DevPack_fso {
	meta:
...
rule DarkenCode_Web_FeliksPack3___PHP_Shells_ssh {
	meta:
...
rule DarkenCode_Web_Debug_BDoor {
	meta:
...
rule DarkenCode_Web_bin_Client {
	meta:
...
rule DarkenCode_Web_ZXshell2_0_rar_Folder_ZXshell {
	meta:
...
rule DarkenCode_Web_binder2_binder2 {
	meta:
...
rule DarkenCode_Web_thelast_orice2 {
	meta:
...
rule DarkenCode_Web_FSO_s_sincap {
	meta:
...
rule DarkenCode_Web_HYTop_DevPack_config {
	meta:
...
rule DarkenCode_Web_FSO_s_zehir4 {
	meta:
...
rule DarkenCode_Web_hkshell_hkshell {
	meta:
...
rule DarkenCode_Web_Unpack_TBack {
	meta:
...
rule DarkenCode_Web_DarkSpy105 {
	meta:
...
rule DarkenCode_Web_EditServer_3 {
	meta:
...
rule DarkenCode_Web_FSO_s_reader {
	meta:
...
rule DarkenCode_Web_ASP_CmdAsp {
	meta:
...
rule DarkenCode_Web_PHP_Backdoor_v1 {
	meta:
...
rule DarkenCode_Web_svchostdll {
	meta:
...
rule DarkenCode_Web_HYTop_DevPack_server {
	meta:
...
rule DarkenCode_Web_FSO_s_remview {
	meta:
...
rule DarkenCode_Web_saphpshell {
	meta:
...
rule DarkenCode_Web_HYTop2006_rar_Folder_2006Z {
	meta:
...
rule DarkenCode_Web_FSO_s_casus15 {
	meta:
...
rule DarkenCode_Web_shelltools_g0t_root_uptime {
	meta:
...
rule DarkenCode_Web_Simple_PHP_BackDooR {
	meta:
...
rule DarkenCode_Web_sig_2005Gray {
	meta:
...
rule DarkenCode_Web_DllInjection {
	meta:
...
rule DarkenCode_Web_Mithril_v1_45_Mithril {
	meta:
...
rule DarkenCode_Web_hkshell_hkrmv {
	meta:
...
rule DarkenCode_Web_FeliksPack3___PHP_Shells_phpft {
	meta:
...
rule DarkenCode_Web_FSO_s_indexer {
	meta:
...
rule DarkenCode_Web_HYTop_DevPack_2005Red {
	meta:
...
rule DarkenCode_Web_HYTop2006_rar_Folder_2006X2 {
	meta:
...
rule DarkenCode_Web_HYTop_CaseSwitch_2005 {
	meta:
...
rule DarkenCode_Web_eBayId_index3 {
	meta:
...
rule DarkenCode_Web_FSO_s_phvayv {
	meta:
...
rule DarkenCode_Web_byshell063_ntboot {
	meta:
...
rule DarkenCode_Web_FSO_s_casus15_2 {
	meta:
		description = "Webshells Auto-generated - file casus15.php"
		author = "Yara Bulk Rule Generator by Florian Roth"
		hash = "8d155b4239d922367af5d0a1b89533a3"
...
rule DarkenCode_Web_FSO_s_remview_2 {
	meta:
		description = "Webshells Auto-generated - file remview.php"
		author = "Yara Bulk Rule Generator by Florian Roth"
		hash = "b4a09911a5b23e00b55abe546ded691c"
...
rule DarkenCode_Web_FeliksPack3___PHP_Shells_r57 {
	meta:
...
rule DarkenCode_Web_HYTop2006_rar_Folder_2006X {
	meta:
...
rule DarkenCode_Web_FSO_s_phvayv_2 {
	meta:
		description = "Webshells Auto-generated - file phvayv.php"
		author = "Yara Bulk Rule Generator by Florian Roth"
		hash = "205ecda66c443083403efb1e5c7f7878"
...
rule DarkenCode_Web_elmaliseker {
	meta:
...
rule DarkenCode_Web_shelltools_g0t_root_resolve {
	meta:
...
rule DarkenCode_Web_FSO_s_RemExp {
	meta:
...
rule DarkenCode_Web_FSO_s_tool {
	meta:
...
rule DarkenCode_Web_FeliksPack3___PHP_Shells_2005 {
	meta:
...
rule DarkenCode_Web_shelltools_g0t_root_Fport {
	meta:
...
rule DarkenCode_Web_BackDooR__fr_ {
	meta:
...
rule DarkenCode_Web_FSO_s_ntdaddy {
	meta:
...
rule DarkenCode_Web_nstview_nstview {
	meta:
...
rule DarkenCode_Web_HYTop_DevPack_upload {
	meta:
...
rule DarkenCode_Web_PasswordReminder {
	meta:
...
rule DarkenCode_Web_Pack_InjectT {
	meta:
		description = "Webshells Auto-generated - file InjectT.exe"
		author = "Yara Bulk Rule Generator by Florian Roth"
...
rule DarkenCode_Web_FSO_s_RemExp_2 {
	meta:
		description = "Webshells Auto-generated - file RemExp.asp"
		author = "Yara Bulk Rule Generator by Florian Roth"
		hash = "b69670ecdbb40012c73686cd22696eeb"
...
rule DarkenCode_Web_rknt_zip_Folder_RkNT {
	meta:
...
rule DarkenCode_Web_Mithril_Mithril {
	meta:
		description = "Webshells Auto-generated - file Mithril.exe"
		author = "Yara Bulk Rule Generator by Florian Roth"
...
rule DarkenCode_Web_hxdef100_2 {
	meta:
		description = "Webshells Auto-generated - file hxdef100.exe"
		author = "Yara Bulk Rule Generator by Florian Roth"
...
rule DarkenCode_Web_Release_dllTest {
	meta:
...
rule DarkenCode_Web_r57shell_2 {
	meta:
		description = "Webshells Auto-generated - file r57shell.php"
		author = "Yara Bulk Rule Generator by Florian Roth"
		hash = "8023394542cddf8aee5dec6072ed02b5"
...
rule DarkenCode_Web_Mithril_v1_45_dllTest {
	meta:
		description = "Webshells Auto-generated - file dllTest.dll"
		author = "Yara Bulk Rule Generator by Florian Roth"
...
rule DarkenCode_Web_dbgiis6cli {
	meta:
...
rule DarkenCode_Web_remview_2003_04_22 {
	meta:
...
rule DarkenCode_Web_FSO_s_test {
	meta:
...
rule DarkenCode_Web_Debug_cress {
	meta:
...
rule DarkenCode_Web_FSO_s_EFSO_2 {
	meta:
...
rule DarkenCode_Web_thelast_index3 {
	meta:
		description = "Webshells Auto-generated - file index3.php"
		author = "Yara Bulk Rule Generator by Florian Roth"
...
rule DarkenCode_Web_FeliksPack3___PHP_Shells_xIShell {
	meta:
...
rule DarkenCode_Web_HYTop_AppPack_2005 {
	meta:
		description = "Webshells Auto-generated - file 2005.asp"
		author = "Yara Bulk Rule Generator by Florian Roth"
...
rule DarkenCode_Web_FeliksPack3___PHP_Shells_usr {
	meta:
...
rule DarkenCode_Web_FSO_s_phpinj {
	meta:
...
rule DarkenCode_Web_xssshell_db {
	meta:
...
rule DarkenCode_Web_xssshell_default {
	meta:
...
rule DarkenCode_Web_EditServer_2 {
	meta:
		description = "Webshells Auto-generated - file EditServer.exe"
		author = "Yara Bulk Rule Generator by Florian Roth"
...
rule DarkenCode_Web_Mithril_dllTest {
	meta:
		description = "Webshells Auto-generated - file dllTest.dll"
		author = "Yara Bulk Rule Generator by Florian Roth"
...
rule DarkenCode_Web_peek_a_boo {
	meta:
...
rule DarkenCode_Web_fmlibraryv3 {
	meta:
...
rule DarkenCode_Web_Debug_dllTest_2 {
	meta:
		description = "Webshells Auto-generated - file dllTest.dll"
		author = "Yara Bulk Rule Generator by Florian Roth"
		hash = "1b9e518aaa62b15079ff6edb412b21e9"
...
rule DarkenCode_Web_shelltools_g0t_root_HideRun {
	meta:
...
rule DarkenCode_Web_PHP_Shell_v1_7 {
	meta:
...
rule DarkenCode_Web_xssshell_save {
	meta:
...
rule DarkenCode_Web_FSO_s_phpinj_2 {
	meta:
		description = "Webshells Auto-generated - file phpinj.php"
		author = "Yara Bulk Rule Generator by Florian Roth"
		hash = "dd39d17e9baca0363cc1c3664e608929"
...
rule DarkenCode_Web_ZXshell2_0_rar_Folder_zxrecv {
	meta:
...
rule DarkenCode_Web_FSO_s_ajan {
	meta:
...
rule DarkenCode_Web_phpspy_2005_full {
	meta:
...
rule DarkenCode_Web_FSO_s_zehir4_2 {
	meta:
		description = "Webshells Auto-generated - file zehir4.asp"
		author = "Yara Bulk Rule Generator by Florian Roth"
		hash = "5b496a61363d304532bcf52ee21f5d55"
...
rule DarkenCode_Web_FSO_s_indexer_2 {
	meta:
		description = "Webshells Auto-generated - file indexer.asp"
		author = "Yara Bulk Rule Generator by Florian Roth"
		hash = "135fc50f85228691b401848caef3be9e"
...
rule DarkenCode_Web_HYTop_DevPack_2005 {
	meta:
		description = "Webshells Auto-generated - file 2005.asp"
		author = "Yara Bulk Rule Generator by Florian Roth"
		hash = "63d9fd24fa4d22a41fc5522fc7050f9f"
...
rule DarkenCode_Web__root_040_zip_Folder_deploy {
	meta:
...
rule DarkenCode_Web_icyfox007v1_10_rar_Folder_asp {
	meta:
...
rule DarkenCode_Web_FSO_s_EFSO_2_2 {
	meta:
		description = "Webshells Auto-generated - file EFSO_2.asp"
		author = "Yara Bulk Rule Generator by Florian Roth"
		hash = "a341270f9ebd01320a7490c12cb2e64c"
...
rule DarkenCode_Web_byshell063_ntboot_2 {
	meta:
...
rule DarkenCode_Web_shelltools_g0t_root_xwhois {
	meta:
...
rule DarkenCode_Web_vanquish_2 {
	meta:
...
rule DarkenCode_Web_down_rar_Folder_down {
	meta:
...
rule DarkenCode_Web_ZXshell2_0_rar_Folder_nc {
	meta:
...
rule DarkenCode_Web_portlessinst {
	meta:
...
rule DarkenCode_Web_SetupBDoor {
	meta:
...
rule DarkenCode_Web_phpshell_3 {
	meta:
		description = "Webshells Auto-generated - file phpshell.php"
		author = "Yara Bulk Rule Generator by Florian Roth"
...
rule DarkenCode_Web_BIN_Server {
	meta:
...
rule DarkenCode_Web_HYTop2006_rar_Folder_2006 {
	meta:
...
rule DarkenCode_Web_r57shell_3 {
	meta:
		description = "Webshells Auto-generated - file r57shell.php"
		author = "Yara Bulk Rule Generator by Florian Roth"
...
rule DarkenCode_Web_FSO_s_ajan_2 {
	meta:
		description = "Webshells Auto-generated - file ajan.asp"
		author = "Yara Bulk Rule Generator by Florian Roth"
		hash = "22194f8c44524f80254e1b5aec67b03e"
...
rule DarkenCode_Web_Webshell_and_Exploit_CN_APT_HK : Webshell
{
meta:
	author = "Florian Roth"
...
rule DarkenCode_Web_JSP_Browser_APT_webshell {
	meta: 
...
rule DarkenCode_Web_JSP_jfigueiredo_APT_webshell {
	meta: 
...
rule DarkenCode_Web_JSP_jfigueiredo_APT_webshell_2 {
	meta: 
		description = "JSP Browser used as web shell by APT groups - author: jfigueiredo"
		author = "F.Roth"
		date = "12.10.2014"
...
rule DarkenCode_Web_AJAX_FileUpload_webshell {
	meta: 
...
rule DarkenCode_Web_Webshell_Insomnia {
	meta:
...
rule DarkenCode_Web_HawkEye_PHP_Panel {
	meta:
...
rule DarkenCode_Web_SoakSoak_Infected_Wordpress {
	meta:
...
rule DarkenCode_Web_Pastebin_Webshell {
	meta:

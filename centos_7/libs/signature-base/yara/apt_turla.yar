...
rule Neo23x0_apt_Turla_APT_srsvc {
	meta:
...
rule Neo23x0_apt_Turla_APT_Malware_Gen1 {
	meta:
		description = "Detects Turla malware (based on sample used in the RUAG APT case)"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_RUAG_APT_Malware_Gen2 {
   meta:
...
rule Neo23x0_apt_Turla_APT_Malware_Gen3 {
	meta:
		description = "Detects Turla malware (based on sample used in the RUAG APT case)"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_Turla_Mal_Script_Jan18_1 {
   meta:
...
rule Neo23x0_apt_Turla_KazuarRAT {
   meta:
...
rule Neo23x0_apt_MAL_Turla_Agent_BTZ {
   meta:
...
rule Neo23x0_apt_MAL_Turla_Sample_May18_1 {
   meta:
...
rule Neo23x0_apt_APT_MAL_LNX_Turla_Apr20_1 {
   meta:
...
rule Neo23x0_apt_APT_MAL_TinyTurla_Sep21_1 {
	meta:
		author = "Cisco Talos"

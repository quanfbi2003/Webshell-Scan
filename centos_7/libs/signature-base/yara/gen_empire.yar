...
rule Neo23x0_gen_Empire_Invoke_MetasploitPayload {
   meta:
...
rule Neo23x0_gen_Empire_Exploit_Jenkins {
   meta:
...
rule Neo23x0_gen_Empire_Get_SecurityPackages {
   meta:
...
rule Neo23x0_gen_Empire_Invoke_PowerDump {
   meta:
...
rule Neo23x0_gen_Empire_Install_SSP {
   meta:
...
rule Neo23x0_gen_Empire_Invoke_ShellcodeMSIL {
   meta:
...
rule Neo23x0_gen_HKTL_Empire_PowerUp {
   meta:
...
rule Neo23x0_gen_Empire_Invoke_Mimikatz_Gen {
   meta:
...
rule Neo23x0_gen_Empire_Get_GPPPassword {
   meta:
...
rule Neo23x0_gen_Empire_Invoke_SmbScanner {
   meta:
...
rule Neo23x0_gen_Empire_Exploit_JBoss {
   meta:
...
rule Neo23x0_gen_Empire_dumpCredStore {
   meta:
...
rule Neo23x0_gen_Empire_Invoke_EgressCheck {
   meta:
...
rule Neo23x0_gen_Empire_ReflectivePick_x64_orig {
   meta:
...
rule Neo23x0_gen_Empire_Out_Minidump {
   meta:
...
rule Neo23x0_gen_Empire_Invoke_PsExec {
   meta:
...
rule Neo23x0_gen_Empire_Invoke_PostExfil {
   meta:
...
rule Neo23x0_gen_Empire_Invoke_SMBAutoBrute {
   meta:
...
rule Neo23x0_gen_Empire_Get_Keystrokes {
   meta:
...
rule Neo23x0_gen_Empire_Invoke_DllInjection {
   meta:
...
rule Neo23x0_gen_Empire_KeePassConfig {
   meta:
...
rule Neo23x0_gen_Empire_Invoke_SSHCommand {
   meta:
...
rule Neo23x0_gen_Empire_PowerShell_Framework_Gen1 {
   meta:
...
rule Neo23x0_gen_Empire_PowerUp_Gen {
   meta:
...
rule Neo23x0_gen_Empire_PowerShell_Framework_Gen2 {
   meta:
      description = "Detects Empire component"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_gen_Empire_Agent_Gen {
   meta:
...
rule Neo23x0_gen_Empire_PowerShell_Framework_Gen3 {
   meta:
      description = "Detects Empire component"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_gen_Empire_Invoke_InveighRelay_Gen {
   meta:
...
rule Neo23x0_gen_Empire_KeePassConfig_Gen {
   meta:
...
rule Neo23x0_gen_Empire_Invoke_Portscan_Gen {
   meta:
...
rule Neo23x0_gen_Empire_PowerShell_Framework_Gen4 {
   meta:
      description = "Detects Empire component"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_gen_Empire_Invoke_CredentialInjection_Invoke_Mimikatz_Gen {
   meta:
...
rule Neo23x0_gen_Empire_Invoke_Gen {
   meta:
...
rule Neo23x0_gen_Empire_PowerShell_Framework_Gen5 {
   meta:
      description = "Detects Empire component"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"

...
rule Neo23x0_gen_SUSP_PS1_Msdt_Execution_May22 {
   meta:
...
rule Neo23x0_gen_SUSP_Doc_WordXMLRels_May22 {
   meta:
...
rule Neo23x0_gen_SUSP_Doc_RTF_ExternalResource_May22 {
   meta:
...
rule Neo23x0_gen_EXPL_Follina_CVE_2022_30190_Msdt_MSProtocolURI_May22 {
   meta:
...
rule Neo23x0_gen_SUSP_Doc_RTF_OLE2Link_Jun22 {
   meta:
...
rule Neo23x0_gen_SUSP_Doc_RTF_OLE2Link_EMAIL_Jun22 {
   meta:
...
rule Neo23x0_gen_SUSP_DOC_RTF_ExternalResource_EMAIL_Jun22 {
   meta:
...
rule Neo23x0_gen_SUSP_Msdt_Artefact_Jun22_2 {
   meta:
...
rule Neo23x0_gen_SUSP_LNK_Follina_Jun22 {
   meta:

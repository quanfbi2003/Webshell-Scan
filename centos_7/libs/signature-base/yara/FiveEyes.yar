...
rule DarkenCode_Fiv_FiveEyes_QUERTY_Malwareqwerty_20121 {
	meta:
...
rule DarkenCode_Fiv_FiveEyes_QUERTY_Malwaresig_20123_sys {
	meta:
...
rule DarkenCode_Fiv_FiveEyes_QUERTY_Malwaresig_20123_cmdDef {
	meta:
...
rule DarkenCode_Fiv_FiveEyes_QUERTY_Malwaresig_20121_dll {
	meta:
...
rule DarkenCode_Fiv_FiveEyes_QUERTY_Malwareqwerty_20123 {
	meta:
...
rule DarkenCode_Fiv_FiveEyes_QUERTY_Malwaresig_20120_dll {
	meta:
...
rule DarkenCode_Fiv_FiveEyes_QUERTY_Malwaresig_20120_cmdDef {
	meta:
...
rule DarkenCode_Fiv_FiveEyes_QUERTY_Malwareqwerty_20120 {
	meta:
...
rule DarkenCode_Fiv_FiveEyes_QUERTY_Malwaresig_20121_cmdDef {
	meta:

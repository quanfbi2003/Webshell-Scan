...
rule Neo23x0_con_VULN_Linux_Sudoers_Commands {
	meta:
...
rule Neo23x0_con_VULN_Linux_NFS_Exports {
	meta:
...
rule Neo23x0_con_SUSP_AES_Key_in_MySql_History {
	meta:
...
rule Neo23x0_con_VULN_Slapd_Conf_with_Default_Password {
	meta:
...
rule Neo23x0_con_VULN_Unencrypted_SSH_Private_Key : T1552_004 {
    meta:
...
rule Neo23x0_con_VULN_Unencrypted_SSH_Private_Key_Root_Folder : T1552_004 {
    meta:
        description = "Detects unencrypted SSH private keys with DSA, RSA, ECDSA and ED25519 of openssh or Putty"
        license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
        author = "Arnim Rupp"

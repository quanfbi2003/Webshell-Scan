...
rule Neo23x0_gen_PowerShell_ISESteroids_Obfuscation {
   meta:
...
rule Neo23x0_gen_SUSP_Obfuscted_PowerShell_Code {
   meta:
...
rule Neo23x0_gen_SUSP_PowerShell_Caret_Obfuscation_2 {
   meta:
...
rule Neo23x0_gen_SUSP_OBFUSC_PowerShell_True_Jun20_1 {
   meta:

...
rule Neo23x0_apt_Winnti_signing_cert {
	meta:
...
rule Neo23x0_apt_Winnti_malware_Nsiproxy {
	meta:
...
rule Neo23x0_apt_Winnti_malware_UpdateDLL {
	meta:
...
rule Neo23x0_apt_Winnti_malware_FWPK {
   meta:
...
rule Neo23x0_apt_Winnti_malware_StreamPortal_Gen {
	meta:
...
rule Neo23x0_apt_WINNTI_KingSoft_Moz_Confustion {
   meta:
...
rule Neo23x0_apt_APT_Winnti_MAL_Dec19_1 {
   meta:
...
rule Neo23x0_apt_APT_Winnti_MAL_Dec19_3 {
   meta:
      description = "Detects Winnti malware"
      author = "Unknown"
      reference = "https://www.verfassungsschutz.de/download/broschuere-2019-12-bfv-cyber-brief-2019-01.pdf"
...
rule Neo23x0_apt_APT_Winnti_MAL_Dec19_4 {
   meta:
      description = "Detects Winnti malware"
      author = "Unknown"
      reference = "https://www.verfassungsschutz.de/download/broschuere-2019-12-bfv-cyber-brief-2019-01.pdf"
...
rule Neo23x0_apt_APT_Winnti_MAL_Dec19_5 {
   meta:
      description = "Detects Winnti malware"
      author = "Unknown"
      reference = "https://www.verfassungsschutz.de/download/broschuere-2019-12-bfv-cyber-brief-2019-01.pdf"
...
rule Neo23x0_apt_APT_CN_Group_Loader_Jan20_1 {
   meta:
...
rule Neo23x0_apt_winnti_dropper_x64_libtomcrypt_fns : TAU CN APT {
   meta:
...
rule Neo23x0_apt_winnti_dropper_x86_libtomcrypt_fns : TAU CN APT {
   meta:
      author = "CarbonBlack Threat Research" // tharuyama
      date = "2019-08-26"

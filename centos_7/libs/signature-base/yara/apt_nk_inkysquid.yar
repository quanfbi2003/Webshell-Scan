...
rule Neo23x0_apt_APT_RUBY_RokRat_Loader : InkySquid
{
    meta:
...
rule Neo23x0_apt_APT_PY_BlueLight_Loader : InkySquid
{
    meta:
        author = "threatintel@volexity.com"
...
rule Neo23x0_apt_APT_MAL_Win_DecRok : InkySquid
{
    meta:
        author = "threatintel@volexity.com"
        date = "2021-06-23"
...
rule Neo23x0_apt_APT_MAL_Win_RokLoad_Loader : InkySquid
{
    meta:
        author = "threatintel@volexity.com"
        date = "2021-06-23"
...
rule Neo23x0_apt_APT_NK_Scarcruft_RUBY_Shellcode_XOR_Routine {
     meta:
...
rule Neo23x0_apt_APT_NK_Scarcruft_evolved_ROKRAT {
    meta:
        author        = "S2WLAB_TALON_JACK2"

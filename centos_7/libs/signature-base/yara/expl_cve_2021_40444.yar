...
rule Neo23x0_exp_EXPL_CVE_2021_40444_Document_Rels_XML {
   meta:
...
rule Neo23x0_exp_EXPL_MAL_MalDoc_OBFUSCT_MHTML_Sep21_1 {
   meta:
...
rule Neo23x0_exp_EXPL_XML_Encoded_CVE_2021_40444 {
   meta:
...
rule Neo23x0_exp_SUSP_OBFUSC_Indiators_XML_OfficeDoc_Sep21_1 : Windows CVE {
   meta:
      author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_exp_SUSP_OBFUSC_Indiators_XML_OfficeDoc_Sep21_2 : Windows CVE {
   meta:
      author = "Florian Roth (Nextron Systems)"
      description = "Detects suspicious encodings in fields used in reference files found in weaponized MS Office documents"
      reference = "https://twitter.com/sudosev/status/1439205606129377282"

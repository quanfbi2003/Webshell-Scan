...
rule Neo23x0_exp_WEBSHELL_ASPX_ProxyShell_Aug21_2 {
   meta:
...
rule Neo23x0_exp_WEBSHELL_ASPX_ProxyShell_Aug21_3 {
   meta:
...
rule Neo23x0_exp_APT_IIS_Config_ProxyShell_Artifacts {
   meta:
...
rule Neo23x0_exp_WEBSHELL_ASPX_ProxyShell_Exploitation_Aug21_1 {
   meta:
...
rule Neo23x0_exp_WEBSHELL_ASPX_ProxyShell_Aug15 {
   meta:
...
rule Neo23x0_exp_WEBSHELL_Mailbox_Export_PST_ProxyShell_Aug26 {
   meta:
...
rule Neo23x0_exp_SUSP_IIS_Config_ProxyShell_Artifacts {
   meta:
...
rule Neo23x0_exp_SUSP_IIS_Config_VirtualDir {
   meta:
...
rule Neo23x0_exp_SUSP_ASPX_PossibleDropperArtifact_Aug21 {
   meta:
...
rule Neo23x0_exp_WEBSHELL_ProxyShell_Exploitation_Nov21_1 {
   meta:

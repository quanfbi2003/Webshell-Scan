...
rule DarkenCode_Enf_EnfalCode : Enfal Family 
{
    meta:
...
rule DarkenCode_Enf_EnfalStrings : Enfal Family
{
    meta:
...
rule DarkenCode_Enf_Enfal_Malware {
	meta:
...
rule DarkenCode_Enf_Enfal_Malware_Backdoor {
	meta:
...
rule DarkenCode_Enf_ce_enfal_cmstar_debug_msg
{
    meta:
        Author      = "rfalcone"
        Date        = "2015.05.10"

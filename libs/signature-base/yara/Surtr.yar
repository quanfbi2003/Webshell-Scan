...
rule DarkenCode_Sur_RSharedStrings : Surtr Family {
	meta:
...
rule DarkenCode_Sur_RemoteStrings : Remote Variant Surtr Family {
	meta:
...
rule DarkenCode_Sur_GmRemoteStrings : GmRemote Variant Family Surtr {
	meta:
...
rule DarkenCode_Sur_SurtrStrings : Surtr Family {	
	meta: 
		author = "Katie Kleemola"
...
rule DarkenCode_Sur_SurtrCode : Surtr Family {
	meta: 
		author = "Katie Kleemola"

...
rule Neo23x0_air_hacktool_macos_exploit_cve_5889
{
    meta:
...
rule Neo23x0_air_hacktool_macos_exploit_tpwn
{
    meta:
...
rule Neo23x0_air_hacktool_macos_juuso_keychaindump
{
    meta:
...
rule Neo23x0_air_hacktool_macos_keylogger_b4rsby_swiftlog
{
    meta:
...
rule Neo23x0_air_hacktool_macos_keylogger_caseyscarborough
{
    meta:
...
rule Neo23x0_air_hacktool_macos_keylogger_dannvix
{
    meta:
...
rule Neo23x0_air_hacktool_macos_keylogger_eldeveloper_keystats
{
    meta:
        description = "A simple keylogger for macOS."
...
rule Neo23x0_air_hacktool_macos_keylogger_giacomolaw
{
    meta:
        description = "A simple keylogger for macOS."
...
rule Neo23x0_air_hacktool_macos_keylogger_logkext
{
    meta:
...
rule Neo23x0_air_hacktool_macos_keylogger_roxlu_ofxkeylogger
{
    meta:
...
rule Neo23x0_air_hacktool_macos_keylogger_skreweverything_swift
{
    meta:
...
rule Neo23x0_air_hacktool_macos_macpmem
{
    meta:
...
rule Neo23x0_air_hacktool_macos_manwhoami_icloudcontacts
{
    meta:
...
rule Neo23x0_air_hacktool_macos_manwhoami_mmetokendecrypt
{
    meta:
...
rule Neo23x0_air_hacktool_macos_manwhoami_osxchromedecrypt
{
    meta:
...
rule Neo23x0_air_hacktool_macos_n0fate_chainbreaker
{
    meta:
...
rule Neo23x0_air_hacktool_macos_ptoomey3_keychain_dumper
{
    meta:
...
rule Neo23x0_air_hacktool_multi_bloodhound_owned
{
    meta:
...
rule Neo23x0_air_hacktool_multi_jtesta_ssh_mitm
{
    meta:
...
rule Neo23x0_air_hacktool_multi_masscan
{
    meta:
...
rule Neo23x0_air_hacktool_multi_ncc_ABPTTS
{
    meta:
...
rule Neo23x0_air_hacktool_multi_ntlmrelayx
{
    meta:
...
rule Neo23x0_air_hacktool_multi_pyrasite_py
{
    meta:
...
rule Neo23x0_air_hacktool_multi_responder_py
{
    meta:
...
rule Neo23x0_air_hacktool_windows_hot_potato
{
    meta:
...
rule Neo23x0_air_hacktool_windows_moyix_creddump
{
    meta:
...
rule Neo23x0_air_hacktool_windows_ncc_wmicmd : FILE {
    meta:
...
rule Neo23x0_air_hacktool_windows_rdp_cmd_delivery
{
    meta:
...
rule Neo23x0_air_hacktool_windows_wmi_implant
{
    meta:
...
rule Neo23x0_air_hacktool_windows_mimikatz_copywrite
{
    meta:
...
rule Neo23x0_air_hacktool_windows_mimikatz_errors
{
    meta:
...
rule Neo23x0_air_hacktool_windows_mimikatz_files
{
    meta:
...
rule Neo23x0_air_hacktool_windows_mimikatz_modules
{
    meta:
...
rule Neo23x0_air_hacktool_windows_mimikatz_sekurlsa
{
    meta:

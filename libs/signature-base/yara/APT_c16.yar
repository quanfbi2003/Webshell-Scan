...
rule DarkenCode_APT_apt_c16_win_memory_pcclient 
{
  meta:
...
rule DarkenCode_APT_apt_c16_win_disk_pcclient 
{
  meta:
    author = "@dragonthreatlab"
...
rule DarkenCode_APT_apt_c16_win32_dropper 
{
  meta:
    author = "@dragonthreatlab"
...
rule DarkenCode_APT_apt_c16_win_swisyn 
{
  meta:
    author = "@dragonthreatlab"
...
rule DarkenCode_APT_apt_c16_win_wateringhole 
{
  meta:
    author = "@dragonthreatlab"
...
rule DarkenCode_APT_apt_c16_win64_dropper
{
    meta:
        author      = "@dragonthreatlab"
        date        = "2015/01/11" 

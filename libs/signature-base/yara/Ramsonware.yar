...
rule DarkenCode_Ram_CryptoLocker_set1
{
meta:
...
rule DarkenCode_Ram_CryptoLocker_rule2
{
meta:
	author = "Christiaan Beek, Christiaan_Beek@McAfee.com"
	date = "2014-04-14"
...
rule DarkenCode_Ram_SVG_LoadURL {
	meta:
...
rule DarkenCode_Ram_BackdoorFCKG: CTB_Locker_Ransomware
{
meta:
author = "ISG"
date = "2015-01-20"

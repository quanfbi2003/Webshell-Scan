...
rule DarkenCode_PAT_whosthere_alt {
	meta:
...
rule DarkenCode_PAT_iam_alt_iam_alt {
	meta:
...
rule DarkenCode_PAT_genhash_genhash {
	meta:
...
rule DarkenCode_PAT_iam_iamdll {
	meta:
...
rule DarkenCode_PAT_whosthere_alt_pth {
	meta:

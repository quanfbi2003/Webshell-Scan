...
rule Neo23x0_tho_iexplore_ANOMALY {
   meta:
...
rule Neo23x0_tho_svchost_ANOMALY {
	meta:
...
rule Neo23x0_tho_explorer_ANOMALY {
	meta:
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_sethc_ANOMALY {
	meta:
...
rule Neo23x0_tho_Utilman_ANOMALY {
	meta:
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_magnify_ANOMALY {
	meta:
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_narrator_ANOMALY {
	meta:
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_notepad_ANOMALY {
	meta:
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_tho_csrss_ANOMALY {
	meta:
...
rule Neo23x0_tho_conhost_ANOMALY {
	meta:
...
rule Neo23x0_tho_wininit_ANOMALY {
	meta:
...
rule Neo23x0_tho_winlogon_ANOMALY {
	meta:
...
rule Neo23x0_tho_SndVol_ANOMALY {
	meta:
...
rule Neo23x0_tho_doskey_ANOMALY {
	meta:
...
rule Neo23x0_tho_lsass_ANOMALY {
	meta:
...
rule Neo23x0_tho_taskmgr_ANOMALY {
   meta:
...
rule Neo23x0_tho_APT_Cloaked_PsExec
	{
	meta:
...
rule Neo23x0_tho_APT_Cloaked_SuperScan
	{
	meta:
...
rule Neo23x0_tho_APT_Cloaked_ScanLine
	{
	meta:
...
rule Neo23x0_tho_SUSP_Renamed_Dot1Xtray {
   meta:
...
rule Neo23x0_tho_APT_Cloaked_CERTUTIL {
   meta:
...
rule Neo23x0_tho_APT_SUSP_Solarwinds_Orion_Config_Anomaly_Dec20 {
   meta:
...
rule Neo23x0_tho_PAExec_Cloaked {
   meta:
...
rule Neo23x0_tho_SUSP_VULN_DRV_PROCEXP152_May23 {
   meta:
...
rule Neo23x0_tho_SUSP_VULN_DRV_PROCEXP152_Renamed_May23 {
   meta:
...
rule Neo23x0_tho_SUSP_ANOMALY_Teams_Binary_Nov23 : SCRIPT {
   meta:
...
rule Neo23x0_tho_SAM_Hive_Backup {
   meta:

...
rule Neo23x0_apt_MAL_Backdoor_DLL_Nov23_1 {
   meta:
      author = "X__Junior"
...
rule Neo23x0_apt_MAL_Trojan_DLL_Nov23 {
   meta:
      author = "X__Junior"
...
rule Neo23x0_apt_MAL_DLL_Stealer_Nov23 {
   meta:
      author = "X__Junior"
...
rule Neo23x0_apt_MAL_Python_Backdoor_Script_Nov23 {
   meta:
      author = "X__Junior"
...
rule Neo23x0_apt_APT_RANSOM_Lockbit_ForensicArtifacts_Nov23 {
   meta:

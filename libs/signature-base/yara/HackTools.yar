...
rule DarkenCode_Hac_PScan_Portscan_1 {
	meta:
...
rule DarkenCode_Hac_HackTool_Samples {
	meta: 
...
rule DarkenCode_Hac_HackTool_Producers {
...
rule DarkenCode_Hac_Mimikatz_Memory_Rule_1 : APT {
	meta: 
		author = "Florian Roth"
		date = "12/22/2014"
		score = 70
...
rule DarkenCode_Hac_Mimikatz_Memory_Rule_2 : APT {
	meta:
...
rule DarkenCode_Hac_Mimikatz_SampleSet_1 : APT {
	meta:
...
rule DarkenCode_Hac_Mimikatz_SampleSet_2 : APT {
	meta:
		description = "Mimikatz Rule generated from a big Mimikatz sample set"
		author = "Florian Roth - Florian Roth"
...
rule DarkenCode_Hac_Mimikatz_SampleSet_3 : APT {
	meta:
		description = "Mimikatz Rule generated from a big Mimikatz sample set"
		author = "Florian Roth - Florian Roth"
...
rule DarkenCode_Hac_Mimikatz_SampleSet_4 : APT {
	meta:
		description = "Mimikatz Rule generated from a big Mimikatz sample set"
		author = "Florian Roth - Florian Roth"
...
rule DarkenCode_Hac_Mimikatz_SampleSet_5 : APT {
	meta:
		description = "Mimikatz Rule generated from a big Mimikatz sample set"
		author = "Florian Roth - Florian Roth"
...
rule DarkenCode_Hac_Mimikatz_SampleSet_6 : APT {
	meta:
		description = "Mimikatz Rule generated from a big Mimikatz sample set"
		author = "Florian Roth - Florian Roth"
...
rule DarkenCode_Hac_Mimikatz_SampleSet_7 : APT {
	meta:
		description = "Mimikatz Rule generated from a big Mimikatz sample set"
		author = "Florian Roth - Florian Roth"
		super_rule = 1
...
rule DarkenCode_Hac_Mimikatz_SampleSet_8 : APT {
	meta:
		description = "Mimikatz Rule generated from a big Mimikatz sample set"
		author = "Florian Roth - Florian Roth"
		super_rule = 1
...
rule DarkenCode_Hac_Mimikatz_SampleSet_9 : APT {
	meta:
		description = "Mimikatz Rule generated from a big Mimikatz sample set"
		author = "Florian Roth - Florian Roth"
		super_rule = 1
...
rule DarkenCode_Hac_Mimikatz_SampleSet_10 : APT {
	meta:
		description = "Mimikatz Rule generated from a big Mimikatz sample set"
		author = "Florian Roth - Florian Roth"
		super_rule = 1
...
rule DarkenCode_Hac_PortScanner {
	meta:
...
rule DarkenCode_Hac_DomainScanV1_0 {
	meta:
...
rule DarkenCode_Hac_MooreR_Port_Scanner {
	meta:
...
rule DarkenCode_Hac_NetBIOS_Name_Scanner {
	meta:
...
rule DarkenCode_Hac_FeliksPack3___Scanners_ipscan {
	meta:
...
rule DarkenCode_Hac_CGISscan_CGIScan {
	meta:
...
rule DarkenCode_Hac_IP_Stealing_Utilities {
	meta:
...
rule DarkenCode_Hac_SuperScan4 {
	meta:
...
rule DarkenCode_Hac_scanarator {
	meta:
...
rule DarkenCode_Hac_aolipsniffer {
	meta:
...
rule DarkenCode_Hac__Bitchin_Threads_ {
	meta:
...
rule DarkenCode_Hac_cgis4_cgis4 {
	meta:
...
rule DarkenCode_Hac_ProPort_zip_Folder_ProPort {
	meta:
...
rule DarkenCode_Hac_StealthWasp_s_Basic_PortScanner_v1_2 {
	meta:
...
rule DarkenCode_Hac_BluesPortScan {
	meta:
...
rule DarkenCode_Hac_scanarator_iis {
	meta:
...
rule DarkenCode_Hac_stealth_Stealth {
	meta:
...
rule DarkenCode_Hac_Angry_IP_Scanner_v2_08_ipscan {
	meta:
		description = "Auto-generated rule on file ipscan.exe"
		author = "yarGen Yara Rule Generator by Florian Roth"
...
rule DarkenCode_Hac_crack_Loader {
	meta:
...
rule DarkenCode_Hac_CN_GUI_Scanner {
	meta: 
...
rule DarkenCode_Hac_CN_Packed_Scanner {
	meta: 
...
rule DarkenCode_Hac_Tiny_Network_Tool_Generic {
	meta:
...
rule DarkenCode_Hac_Beastdoor_Backdoor {
	meta:
...
rule DarkenCode_Hac_Powershell_Netcat {
	meta:
...
rule DarkenCode_Hac_Chinese_Hacktool_1014 {
	meta:
...
rule DarkenCode_Hac_CN_Hacktool_BAT_PortsOpen {
	meta:
...
rule DarkenCode_Hac_CN_Hacktool_SSPort_Portscanner {
	meta:
...
rule DarkenCode_Hac_CN_Hacktool_ScanPort_Portscanner {
	meta:
...
rule DarkenCode_Hac_CN_Hacktool_S_EXE_Portscanner {
	meta:
...
rule DarkenCode_Hac_CN_Hacktool_MilkT_BAT {
	meta:
...
rule DarkenCode_Hac_CN_Hacktool_MilkT_Scanner {
	meta:
...
rule DarkenCode_Hac_CN_Hacktool_1433_Scanner {
	meta:
...
rule DarkenCode_Hac_CN_Hacktool_1433_Scanner_Comp2 {
	meta:
...
rule DarkenCode_Hac_WCE_Modified_1_1014 {
	meta:
...
rule DarkenCode_Hac_ReactOS_cmd_valid {
	meta:
...
rule DarkenCode_Hac_iKAT_wmi_rundll {
	meta:
...
rule DarkenCode_Hac_iKAT_revelations {
	meta:
...
rule DarkenCode_Hac_iKAT_priv_esc_tasksch {
	meta:
...
rule DarkenCode_Hac_iKAT_command_lines_agent {
	meta:
...
rule DarkenCode_Hac_iKAT_cmd_as_dll {
	meta:
...
rule DarkenCode_Hac_iKAT_tools_nmap {
	meta:
...
rule DarkenCode_Hac_iKAT_startbar {
	meta:
...
rule DarkenCode_Hac_iKAT_gpdisable_customcmd_kitrap0d_uacpoc {
	meta:
...
rule DarkenCode_Hac_iKAT_Tool_Generic {
	meta:
...
rule DarkenCode_Hac_BypassUac2 {
	meta:
...
rule DarkenCode_Hac_BypassUac_3 {
	meta:
...
rule DarkenCode_Hac_BypassUac_9 {
	meta:
...
rule DarkenCode_Hac_BypassUacDll_6 {
	meta:
...
rule DarkenCode_Hac_BypassUacDll_7 {
	meta:
		description = "Auto-generated rule - file BypassUacDll.aps"
		author = "yarGen Yara Rule Generator"
		hash = "58d7b24b6870cb7f1ec4807d2f77dd984077e531"
...
rule DarkenCode_Hac_BypassUac_EXE {
	meta:
		description = "Auto-generated rule - file BypassUacDll.aps"
		author = "yarGen Yara Rule Generator"
		hash = "58d7b24b6870cb7f1ec4807d2f77dd984077e531"
...
rule DarkenCode_Hac_APT_Proxy_Malware_Packed_dev
{
	meta:
		author = "FRoth"
		date = "2014-11-10"
...
rule DarkenCode_Hac_Tzddos_DDoS_Tool_CN {
	meta:
...
rule DarkenCode_Hac_Ncat_Hacktools_CN {
	meta:
...
rule DarkenCode_Hac_MS08_067_Exploit_Hacktools_CN {
	meta:
...
rule DarkenCode_Hac_Hacktools_CN_Burst_sql {
	meta:
...
rule DarkenCode_Hac_Hacktools_CN_JoHor_Rdos {
	meta:
...
rule DarkenCode_Hac_Hacktools_CN_Panda_445TOOL {
	meta:
...
rule DarkenCode_Hac_Hacktools_CN_Panda_445 {
	meta:
...
rule DarkenCode_Hac_Hacktools_CN_WinEggDrop {
	meta:
...
rule DarkenCode_Hac_Hacktools_CN_Scan_BAT {
	meta:
...
rule DarkenCode_Hac_Hacktools_CN_Panda_Burst {
	meta:
...
rule DarkenCode_Hac_Hacktools_CN_445_cmd {
	meta:
...
rule DarkenCode_Hac_Hacktools_CN_GOGOGO_Bat {
	meta:
...
rule DarkenCode_Hac_Hacktools_CN_Burst_pass {
	meta:
...
rule DarkenCode_Hac_Hacktools_CN_JoHor_Posts_Killer {
	meta:
...
rule DarkenCode_Hac_Hacktools_CN_JoHor_Rdos_3_6_uplis {
	meta:
...
rule DarkenCode_Hac_Hacktools_CN_Panda_tesksd {
	meta:
...
rule DarkenCode_Hac_Hacktools_CN_Panda_k {
	meta:
...
rule DarkenCode_Hac_Hacktools_CN_Http {
	meta:
...
rule DarkenCode_Hac_Hacktools_CN_JoHor_Rdos_get {
	meta:
...
rule DarkenCode_Hac_Hacktools_CN_JoHor_Rdos_LineExp {
	meta:
...
rule DarkenCode_Hac_Hacktools_CN_Burst_Start {
	meta:
...
rule DarkenCode_Hac_Hacktools_CN_Panda_tasksvr {
	meta:
...
rule DarkenCode_Hac_Hacktools_CN_Burst_Clear {
	meta:
...
rule DarkenCode_Hac_Hacktools_CN_Panda_andrew {
	meta:
...
rule DarkenCode_Hac_Hacktools_CN_Burst_Thecard {
	meta:
...
rule DarkenCode_Hac_Hacktools_CN_Burst_Blast {
	meta:
...
rule DarkenCode_Hac_VUBrute_VUBrute {
	meta:
...
rule DarkenCode_Hac_VUBrute_config {
	meta:
...
rule DarkenCode_Hac_sig_238_hunt {
	meta:
...
rule DarkenCode_Hac_sig_238_listip {
	meta:
...
rule DarkenCode_Hac_ArtTrayHookDll {
	meta:
...
rule DarkenCode_Hac_sig_238_eee {
	meta:
...
rule DarkenCode_Hac_aspbackdoor_asp4 {
	meta:
...
rule DarkenCode_Hac_EditServer {
	meta:
...
rule DarkenCode_Hac_sig_238_letmein {
	meta:
...
rule DarkenCode_Hac_sig_238_token {
	meta:
...
rule DarkenCode_Hac_sig_238_TELNET {
	meta:
...
rule DarkenCode_Hac_snifferport {
	meta:
...
rule DarkenCode_Hac_sig_238_webget {
	meta:
...
rule DarkenCode_Hac_XYZCmd_zip_Folder_XYZCmd {
	meta:
...
rule DarkenCode_Hac_ASPack_Chinese {
	meta:
...
rule DarkenCode_Hac_aspbackdoor_EDIR {
	meta:
...
rule DarkenCode_Hac_sig_238_filespy {
	meta:
...
rule DarkenCode_Hac_ByPassFireWall_zip_Folder_Ie {
	meta:
...
rule DarkenCode_Hac_EditKeyLogReadMe {
	meta:
...
rule DarkenCode_Hac_PassSniffer_zip_Folder_readme {
	meta:
...
rule DarkenCode_Hac_sig_238_gina {
	meta:
...
rule DarkenCode_Hac_EditKeyLog {
	meta:
...
rule DarkenCode_Hac_PassSniffer {
	meta:
...
rule DarkenCode_Hac_Jc_ALL_WinEggDropShell_rar_Folder_SOCKS {
	meta:
...
rule DarkenCode_Hac_UnPack_rar_Folder_InjectT {
	meta:
...
rule DarkenCode_Hac_Jc_WinEggDrop_Shell {
	meta:
...
rule DarkenCode_Hac_aspbackdoor_asp1 {
	meta:
...
rule DarkenCode_Hac_QQ_zip_Folder_QQ {
	meta:
...
rule DarkenCode_Hac_UnPack_rar_Folder_TBack {
	meta:
...
rule DarkenCode_Hac_sig_238_cmd_2 {
	meta:
...
rule DarkenCode_Hac_XYZCmd_zip_Folder_Readme {
	meta:
		description = "Disclosed hacktool set (old stuff) - file Readme.txt"
		author = "Florian Roth"
		date = "23.11.14"
...
rule DarkenCode_Hac_ByPassFireWall_zip_Folder_Inject {
	meta:
...
rule DarkenCode_Hac_sig_238_sqlcmd {
	meta:
...
rule DarkenCode_Hac_ASPack_ASPACK {
	meta:
...
rule DarkenCode_Hac_sig_238_2323 {
	meta:
...
rule DarkenCode_Hac_Jc_ALL_WinEggDropShell_rar_Folder_Install_2 {
	meta:
...
rule DarkenCode_Hac_sig_238_TFTPD32 {
	meta:
...
rule DarkenCode_Hac_sig_238_iecv {
	meta:
...
rule DarkenCode_Hac_Antiy_Ports_1_21 {
	meta:
...
rule DarkenCode_Hac_perlcmd_zip_Folder_cmd {
	meta:
...
rule DarkenCode_Hac_aspbackdoor_asp3 {
	meta:
...
rule DarkenCode_Hac_sig_238_FPipe {
	meta:
...
rule DarkenCode_Hac_sig_238_concon {
	meta:
...
rule DarkenCode_Hac_aspbackdoor_regdll {
	meta:
...
rule DarkenCode_Hac_CleanIISLog {
	meta:
...
rule DarkenCode_Hac_sig_238_RunAsEx {
	meta:
...
rule DarkenCode_Hac_sig_238_nbtdump {
	meta:
...
rule DarkenCode_Hac_sig_238_Glass2k {
	meta:
...
rule DarkenCode_Hac_SplitJoin_V1_3_3_rar_Folder_3 {
	meta:
		description = "Disclosed hacktool set (old stuff) - file splitjoin.exe"
		author = "Florian Roth"
		date = "23.11.14"
...
rule DarkenCode_Hac_aspbackdoor_EDIT {
	meta:
...
rule DarkenCode_Hac_aspbackdoor_entice {
	meta:
...
rule DarkenCode_Hac_ArtTray_zip_Folder_ArtTray {
	meta:
...
rule DarkenCode_Hac_sig_238_findoor {
	meta:
...
rule DarkenCode_Hac_aspbackdoor_ipclear {
	meta:
...
rule DarkenCode_Hac_WinEggDropShellFinal_zip_Folder_InjectT {
	meta:
		description = "Disclosed hacktool set (old stuff) - file InjectT.exe"
		author = "Florian Roth"
		date = "23.11.14"
...
rule DarkenCode_Hac_sig_238_rshsvc {
	meta:
...
rule DarkenCode_Hac_gina_zip_Folder_gina {
	meta:
...
rule DarkenCode_Hac_superscan3_0 {
	meta:
...
rule DarkenCode_Hac_sig_238_xsniff {
	meta:
...
rule DarkenCode_Hac_sig_238_fscan {
	meta:
...
rule DarkenCode_Hac__iissample_nesscan_twwwscan {
	meta:
...
rule DarkenCode_Hac__FsHttp_FsPop_FsSniffer {
	meta:
...
rule DarkenCode_Hac_Ammyy_Admin_AA_v3 {
	meta:
...
rule DarkenCode_Hac_Mimikatz_Samples_2014b_1 {
	meta:
...
rule DarkenCode_Hac_Mimikatz_Samples_2014b_2 {
	meta:
		description = "Mimikatz pwassword dumper samples from the second half of 2014"
		author = "Florian Roth with the help of YarGen Rule Generator"
		reference = "not set"
...
rule DarkenCode_Hac_Mimikatz_Samples_2014b_Family_2 {
	meta:
		description = "Mimikatz pwassword dumper samples from the second half of 2014"
		author = "Florian Roth with the help of YarGen Rule Generator"
		date = "2014/12/23"
...
rule DarkenCode_Hac_LinuxHacktool_eyes_screen {
	meta:
...
rule DarkenCode_Hac_LinuxHacktool_eyes_scanssh {
	meta:
...
rule DarkenCode_Hac_LinuxHacktool_eyes_scanner {
	meta:
...
rule DarkenCode_Hac_LinuxHacktool_eyes_pscan2 {
	meta:
...
rule DarkenCode_Hac_LinuxHacktool_eyes_a {
	meta:
...
rule DarkenCode_Hac_LinuxHacktool_eyes_mass {
	meta:
...
rule DarkenCode_Hac_LinuxHacktool_eyes_pscan2_2 {
	meta:
...
rule DarkenCode_Hac_CN_Portscan : APT
{
    meta:
...
rule DarkenCode_Hac_WMI_vbs : APT 
{
    meta:
...
rule DarkenCode_Hac_mimikatz_lsass_mdmp
{
meta:
...
rule DarkenCode_Hac_mimikatz_kirbi_ticket
{
meta:
...
rule DarkenCode_Hac_power_pe_injection
{
meta:

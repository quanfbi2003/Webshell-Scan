...
rule Neo23x0_exp_ConnectWise_ScreenConnect_Authentication_Bypass_Feb_2024_Exploitation_IIS_Logs {
   meta:
...
rule Neo23x0_exp_SUSP_ScreenConnect_User_PoC_Com_Unused_Feb24 {
   meta:
...
rule Neo23x0_exp_SUSP_ScreenConnect_User_PoC_Com_Used_Feb24 {
   meta:
...
rule Neo23x0_exp_SUSP_ScreenConnect_Exploitation_Artefacts_Feb24 : SCRIPT {
   meta:
...
rule Neo23x0_exp_SUSP_Command_Line_Combos_Feb24_2 : SCRIPT {
   meta:
...
rule Neo23x0_exp_SUSP_PS1_Combo_TransferSH_Feb24 : SCRIPT {
   meta:
...
rule Neo23x0_exp_MAL_SUSP_RANSOM_LockBit_RansomNote_Feb24 {
   meta:
...
rule Neo23x0_exp_MAL_SUSP_RANSOM_Lazy_RansomNote_Feb24 {
   meta:
...
rule Neo23x0_exp_SUSP_MAL_SigningCert_Feb24_1 {
   meta:
...
rule Neo23x0_exp_MAL_CS_Loader_Feb24_1 {
   meta:
...
rule Neo23x0_exp_MAL_RANSOM_LockBit_Indicators_Feb24 {
   meta:
...
rule Neo23x0_exp_MAL_MSI_Mpyutils_Feb24_1 {
   meta:
...
rule Neo23x0_exp_MAL_Beacon_Unknown_Feb24_1 {
   meta:
...
rule Neo23x0_exp_SUSP_ScreenConnect_User_Gmail_2024_Feb24 {
   meta:
...
rule Neo23x0_exp_SUSP_ScreenConnect_New_User_2024_Feb24 {
   meta:
...
rule Neo23x0_exp_SUSP_ScreenConnect_User_2024_No_Logon_Feb24 {
   meta:

...
rule DarkenCode_Bla_BlackShades_3 : Trojan
{
    meta:
...
rule DarkenCode_Bla_BlackShades2 : Trojan
{
	meta:
		author="Kevin Falcoz"
		date="26/06/2013"
...
rule DarkenCode_Bla_BlackShades_4 : rat
{
	meta:
...
rule DarkenCode_Bla_BlackShades : Trojan
{
	meta:
		author="Kevin Falcoz"
		date="26/06/2013"
...
rule DarkenCode_Bla_BlackShades_25052015
{
    meta:

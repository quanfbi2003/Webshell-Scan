...
//===SUCCESS===
rule DarkenCode_WoolenGoldfish_WoolenGoldfish_Sample_1 {
	meta:
...
//===SUCCESS===
rule DarkenCode_WoolenGoldfish_WoolenGoldfish_Generic_1 {
	meta:
		description = "Detects a operation Woolen-Goldfish sample - http://goo.gl/NpJpVZ"
		author = "Florian Roth"
		reference = "http://goo.gl/NpJpVZ"
...
//===SUCCESS===
rule DarkenCode_WoolenGoldfish_WoolenGoldfish_Generic_2 {
	meta:
		description = "Detects a operation Woolen-Goldfish sample - http://goo.gl/NpJpVZ"
		author = "Florian Roth"
		reference = "http://goo.gl/NpJpVZ"
...
//===SUCCESS===
rule DarkenCode_WoolenGoldfish_WoolenGoldfish_Generic_3 {
	meta:
		description = "Detects a operation Woolen-Goldfish sample - http://goo.gl/NpJpVZ"
		author = "Florian Roth"
		reference = "http://goo.gl/NpJpVZ"

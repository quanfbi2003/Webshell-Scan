...
//===SUCCESS===
rule DarkenCode_NetTraveler_NetpassStrings : NetPass Variant {
...
//===SUCCESS===
rule DarkenCode_NetTraveler_NetPass : Variant {
        meta:
                description = "netpass variant"
                author = "Katie Kleemola"
                last_updated = "2014-07-08"
        condition:
                DarkenCode_NetTraveler_NetpassStrings
}
//===SUCCESS===
rule DarkenCode_NetTraveler_NetTravStrings : NetTraveler Family {
...
//===SUCCESS===
rule DarkenCode_NetTraveler_NetTravExports : NetTraveler Family {
...
//===SUCCESS===
rule DarkenCode_NetTraveler_NetTraveler : Family {
	meta:
	...
	condition:
		DarkenCode_NetTraveler_NetTravExports or DarkenCode_NetTraveler_NetTravStrings or DarkenCode_NetTraveler_NetpassStrings

...
//===SUCCESS===
rule DarkenCode_Safenet_SafeNetCode : SafeNet Family 
{
    meta:
...
//===SUCCESS===
rule DarkenCode_Safenet_SafeNetStrings : SafeNet Family
{
    meta:
...
//===SUCCESS===
rule DarkenCode_Safenet_SafeNet : Family
{
    meta:
        description = "SafeNet family"
        
    condition:
        DarkenCode_Safenet_SafeNetCode or DarkenCode_Safenet_SafeNetStrings

...
//===SUCCESS===
rule DarkenCode_Opcleaver_OPCLEAVER_BackDoorLogger
{
	meta:
...
//===SUCCESS===
rule DarkenCode_Opcleaver_OPCLEAVER_Jasus
{
	meta:
...
//===SUCCESS===
rule DarkenCode_Opcleaver_OPCLEAVER_LoggerModule
{
	meta:
		description = "Keylogger used by attackers in Operation Cleaver"
		reference = "http://cylance.com/assets/Cleaver/Cylance_Operation_Cleaver_Report.pdf"
...
//===SUCCESS===
rule DarkenCode_Opcleaver_OPCLEAVER_NetC
{
	meta:
...
//===SUCCESS===
rule DarkenCode_Opcleaver_OPCLEAVER_ShellCreator2
{
	meta:
...
//===SUCCESS===
rule DarkenCode_Opcleaver_OPCLEAVER_SmartCopy2
{
	meta:
...
//===SUCCESS===
rule DarkenCode_Opcleaver_OPCLEAVER_SynFlooder
{
	meta:
		description = "Malware or hack tool used by attackers in Operation Cleaver"
		reference = "http://cylance.com/assets/Cleaver/Cylance_Operation_Cleaver_Report.pdf"
...
//===SUCCESS===
rule DarkenCode_Opcleaver_OPCLEAVER_TinyZBot
{
	meta:
...
//===SUCCESS===
rule DarkenCode_Opcleaver_OPCLEAVER_ZhoupinExploitCrew
{
	meta:
...
//===SUCCESS===
rule DarkenCode_Opcleaver_OPCLEAVER_antivirusdetector
{
	meta:
...
//===SUCCESS===
rule DarkenCode_Opcleaver_OPCLEAVER_csext
{
	meta:
...
//===SUCCESS===
rule DarkenCode_Opcleaver_OPCLEAVER_kagent
{
	meta:
		description = "Backdoor used by attackers in Operation Cleaver"
		reference = "http://cylance.com/assets/Cleaver/Cylance_Operation_Cleaver_Report.pdf"
...
//===SUCCESS===
rule DarkenCode_Opcleaver_OPCLEAVER_mimikatzWrapper
{
	meta:
...
//===SUCCESS===
rule DarkenCode_Opcleaver_OPCLEAVER_pvz_in
{
	meta:
...
//===SUCCESS===
rule DarkenCode_Opcleaver_OPCLEAVER_pvz_out
{
	meta:
		description = "Parviz tool used by attackers in Operation Cleaver"
		reference = "http://cylance.com/assets/Cleaver/Cylance_Operation_Cleaver_Report.pdf"
...
//===SUCCESS===
rule DarkenCode_Opcleaver_OPCLEAVER_wndTest
{
	meta:
		description = "Backdoor used by attackers in Operation Cleaver"
		reference = "http://cylance.com/assets/Cleaver/Cylance_Operation_Cleaver_Report.pdf"
...
//===SUCCESS===
rule DarkenCode_Opcleaver_OPCLEAVER_zhCat
{
	meta:
...
//===SUCCESS===
rule DarkenCode_Opcleaver_OPCLEAVER_zhLookUp
{
	meta:
		description = "Hack tool used by attackers in Operation Cleaver"
		reference = "http://cylance.com/assets/Cleaver/Cylance_Operation_Cleaver_Report.pdf"
...
//===SUCCESS===
rule DarkenCode_Opcleaver_OPCLEAVER_zhmimikatz
{
	meta:
		description = "Mimikatz wrapper used by attackers in Operation Cleaver"
		reference = "http://cylance.com/assets/Cleaver/Cylance_Operation_Cleaver_Report.pdf"
...
//===SUCCESS===
rule DarkenCode_Opcleaver_OPCLEAVER_Parviz_Developer
{
	meta:
...
//===SUCCESS===
rule DarkenCode_Opcleaver_OPCLEAVER_CCProxy_Config
{
	meta:

...
//===SUCCESS===
rule DarkenCode_Wimmie_WimmieShellcode : Wimmie Family 
{
    meta:
...
//===SUCCESS===
rule DarkenCode_Wimmie_WimmieStrings : Wimmie Family
{
    meta:
...
//===SUCCESS===
rule DarkenCode_Wimmie_Wimmie : Family
{
    meta:
    ...
    condition:
        DarkenCode_Wimmie_WimmieShellcode or DarkenCode_Wimmie_WimmieStrings

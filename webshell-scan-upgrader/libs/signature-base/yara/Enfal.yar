...
//===SUCCESS===
rule DarkenCode_Enfal_EnfalCode : Enfal Family 
{
    meta:
...
//===SUCCESS===
rule DarkenCode_Enfal_EnfalStrings : Enfal Family
{
    meta:
...
//===SUCCESS===
rule DarkenCode_Enfal_Enfal : Family
{
    meta:
        description = "Enfal"
        author = "Seth Hardy"
    ...
    condition:
        DarkenCode_Enfal_EnfalCode or DarkenCode_Enfal_EnfalStrings
}
//===SUCCESS===
rule DarkenCode_Enfal_Enfal_Malware {
	meta:
...
//===SUCCESS===
rule DarkenCode_Enfal_Enfal_Malware_Backdoor {
	meta:
...
//===SUCCESS===
rule DarkenCode_Enfal_ce_enfal_cmstar_debug_msg
{
    meta:
        Author      = "rfalcone"
        Date        = "2015.05.10"

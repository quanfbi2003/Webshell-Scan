import "elf"
//===SUCCESS===
rule tenable_elf_format_single_load_rwe
{
    meta:
...
//===SUCCESS===
rule tenable_elf_format_fake_section_headers_conflicting_entry_point_address
{
    meta:
...
//===SUCCESS===
rule tenable_elf_format_fake_dynamic_symbols
{
    meta:

...
//===SUCCESS===
rule DarkenCode_Casper_Casper_Backdoor_x86 {
	meta:
...
//===SUCCESS===
rule DarkenCode_Casper_Casper_EXE_Dropper {
	meta:
...
//===SUCCESS===
rule DarkenCode_Casper_Casper_Included_Strings {
	meta:
...
//===SUCCESS===
rule DarkenCode_Casper_Casper_SystemInformation_Output {
	meta:

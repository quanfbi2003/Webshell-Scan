...
//===SUCCESS===
rule DarkenCode_Miscelanea_tran_duy_linh
{
meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_misc_iocs
{
meta:
	author = "@patrickrolsen"
	maltype = "Misc."
...
//===SUCCESS===
rule DarkenCode_Miscelanea_malicious_LNK_files
{
meta:
	author = "@patrickrolsen"
strings:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_memory_pivy
...
//===SUCCESS===
rule DarkenCode_Miscelanea_memory_shylock
...
/*DELETED*/
//===SUCCESS===
rule DarkenCode_Miscelanea_TrojanDownloader {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Embedded_EXE_Cloaking {
        meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Cloaked_as_JPG {
        meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_WindowsCredentialEditor
{
    meta: 
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Amplia_Security_Tool
{
    meta: 
...
//===SUCCESS===
rule DarkenCode_Miscelanea_perlbot_pl {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_php_backdoor_php {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Liz0ziM_Private_Safe_Mode_Command_Execuriton_Bypass_Exploit_php {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Nshell__1__php_php {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_shankar_php_php {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Casus15_php_php {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_small_php_php {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_shellbot_pl {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_fuckphpshell_php {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_ngh_php_php {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_jsp_reverse_jsp {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Tool_asp {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_NT_Addy_asp {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_SimAttacker___Vrsion_1_0_0___priv8_4_My_friend_php {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_RemExp_asp {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_phvayvv_php_php {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_klasvayv_asp {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_r57shell_php_php {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_rst_sql_php_php {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_wh_bindshell_py {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_lurm_safemod_on_cgi {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_c99madshell_v2_0_php_php {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_backupsql_php_often_with_c99shell {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_uploader_php_php {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_telnet_pl {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_w3d_php_php {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_rtf_yahoo_ken
{
meta:
	author = "@patrickrolsen"
	maltype = "Yahoo Ken"
...
//===SUCCESS===
rule DarkenCode_Miscelanea_ZXProxy
{
meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_OrcaRAT
{
    meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_mimikatz
{
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_mimikatz_lsass_mdmp
{
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_mimikatz_kirbi_ticket
{
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_wce
{
	meta:
		description		= "wce"
		author			= "Benjamin DELPY (gentilkiwi)"
...
//===SUCCESS===
rule DarkenCode_Miscelanea_EmiratesStatement
{
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_PUP_InstallRex_AntiFWb {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Win7Elevatev2 {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_UACME_Akagi {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_LightFTP_fftp_x86_64 {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_LightFTP_Config {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_SpyGate_v2_9
{
	meta:
		date = "2014/09"
...
//===SUCCESS===
rule DarkenCode_Miscelanea_PythoRAT
{
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_CN_Toolset_sig_1433_135_sqlr {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_VirusRat
{
	meta:
		author = " Kevin Breen <kevin@techanarchy.net>"
		date = "2014/04"
...
//===SUCCESS===
rule DarkenCode_Miscelanea_ice_ix_12xy : banker
{
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_qadars : banker
{
	meta:
		author = "Jean-Philippe Teissier / @Jipe_"
...
//===SUCCESS===
rule DarkenCode_Miscelanea_shylock :  banker
{
	meta:
		author = "Jean-Philippe Teissier / @Jipe_"
...
//===FAILED===
/*
rule DarkenCode_Miscelanea_spyeye : banker
{
	meta:
		author = "Jean-Philippe Teissier / @Jipe_"
	...
	condition:
		$DarkenCode_Miscelanea_spyeye or (any of ($a,$b,$c,$d,$e,$f,$g,$h,$i,$j,$k,$l,$m,$n))
}
*/
//===FAILED===
/*
rule DarkenCode_Miscelanea_spyeye_plugins : banker
{
	meta:
		author = "Jean-Philippe Teissier / @Jipe_"
...
*/
//===SUCCESS===
rule DarkenCode_Miscelanea_callTogether_certificate
{
    meta:
        Author      = "Fireeye Labs"
        Date        = "2014/11/03" 
...
//===SUCCESS===
rule DarkenCode_Miscelanea_qti_certificate
{
    meta:
        Author      = "Fireeye Labs"
        Date        = "2014/11/03" 
...
//===SUCCESS===
rule DarkenCode_Miscelanea_DownExecute_A
{
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_CN_Toolset__XScanLib_XScanLib_XScanLib {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_CN_Toolset_NTscan_PipeCmd {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_CN_Toolset_LScanPortss_2 {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_CVE_2015_1674_CNGSYS {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Ap0calypse
{
	meta:
		author = " Kevin Breen <kevin@techanarchy.net>"
		date = "2014/04"
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Arcom
{
	meta:
		author = " Kevin Breen <kevin@techanarchy.net>"
		date = "2014/04"
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Bandook
{
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Bozok
{
	meta:
		author = " Kevin Breen <kevin@techanarchy.net>"
		date = "2014/04"
...
//===SUCCESS===
rule DarkenCode_Miscelanea_CyberGate
{
...
//===SUCCESS===
rule DarkenCode_Miscelanea_DarkRAT
{
	meta:
		author = " Kevin Breen <kevin@techanarchy.net>"
		date = "2014/04"
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Greame
{
	meta:
		author = " Kevin Breen <kevin@techanarchy.net>"
		date = "2014/04"
...
//===SUCCESS===
rule DarkenCode_Miscelanea_LostDoor
{
	meta:
		author = " Kevin Breen <kevin@techanarchy.net>"
		date = "2014/04"
...
//===SUCCESS===
rule DarkenCode_Miscelanea_LuxNet
{
	meta:
		author = " Kevin Breen <kevin@techanarchy.net>"
		date = "2014/04"
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Pandora
{
	meta:
		author = " Kevin Breen <kevin@techanarchy.net>"
		date = "2014/04"
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Paradox
{
	meta:
		author = " Kevin Breen <kevin@techanarchy.net>"
		date = "2014/04"
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Punisher
{
	meta:
		author = " Kevin Breen <kevin@techanarchy.net>"
		date = "2014/04"
...
//===SUCCESS===
rule DarkenCode_Miscelanea_SmallNet
{
	meta:
		author = " Kevin Breen <kevin@techanarchy.net>"
		date = "2014/04"
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Base64_encoded_Executable {
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_CredStealESY : For CredStealer
{
 meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Mimikatz_Logfile
{
	meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_lsadump
{
	meta:

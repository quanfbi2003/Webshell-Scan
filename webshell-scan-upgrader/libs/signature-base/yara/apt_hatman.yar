...
//===SUCCESS===
private rule Neo23x0_apt_hatman_hatman_setstatus : hatman {
    strings:
...
//===SUCCESS===
private rule Neo23x0_apt_hatman_hatman_memcpy : hatman {
    strings:
...
//===SUCCESS===
private rule Neo23x0_apt_hatman_hatman_dividers : hatman {
    strings:
        $div1       = { 9a 78 56 00 }
        $div2       = { 34 12 00 00 }
    condition:
...
//===SUCCESS===
private rule Neo23x0_apt_hatman_hatman_nullsub : hatman {
    strings:
...
//===SUCCESS===
private rule Neo23x0_apt_hatman_hatman_origaddr : hatman {
    strings:
...
//===SUCCESS===
private rule Neo23x0_apt_hatman_hatman_origcode : hatman {
    strings:
...
//===SUCCESS===
private rule Neo23x0_apt_hatman_hatman_mftmsr : hatman {
    strings:
...
//===SUCCESS===
private rule Neo23x0_apt_hatman_hatman_loadoff : hatman {
    strings:
...
//===SUCCESS===
rule Neo23x0_apt_hatman_hatman_compiled_python : hatman {
    meta:
    ...
    condition:
        Neo23x0_apt_hatman_hatman_nullsub and Neo23x0_apt_hatman_hatman_setstatus and Neo23x0_apt_hatman_hatman_dividers
}
//===SUCCESS===
rule Neo23x0_apt_hatman_hatman_injector : hatman {
    meta:
        description = "Detects Hatman malware"
        reference = "https://ics-cert.us-cert.gov/MAR-17-352-01-HatMan%E2%80%94Safety-System-Targeted-Malware"
        date = "2017/12/19"
    ...
    condition:
        ( Neo23x0_apt_hatman_hatman_memcpy and Neo23x0_apt_hatman_hatman_origaddr and Neo23x0_apt_hatman_hatman_loadoff )
}
//===SUCCESS===
rule Neo23x0_apt_hatman_hatman_payload : hatman {
    meta:
        description = "Detects Hatman malware"
        reference = "https://ics-cert.us-cert.gov/MAR-17-352-01-HatMan%E2%80%94Safety-System-Targeted-Malware"
        date = "2017/12/19"
    ...
    condition:
        ( Neo23x0_apt_hatman_hatman_memcpy and Neo23x0_apt_hatman_hatman_origcode and Neo23x0_apt_hatman_hatman_mftmsr ) and not ( Neo23x0_apt_hatman_hatman_origaddr and Neo23x0_apt_hatman_hatman_loadoff )
}

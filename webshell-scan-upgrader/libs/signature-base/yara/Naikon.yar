...
//===SUCCESS===
rule DarkenCode_Naikon_NaikonCode : Naikon Family 
{
    meta:
...
//===SUCCESS===
rule DarkenCode_Naikon_NaikonStrings : Naikon Family
{
    meta:
...
//===SUCCESS===
rule DarkenCode_Naikon_Naikon : Family
{
    meta:
        description = "Naikon"
        author = "Seth Hardy"
    ...
    condition:
        DarkenCode_Naikon_NaikonCode or DarkenCode_Naikon_NaikonStrings
}
//===SUCCESS===
rule DarkenCode_Naikon_Backdoor_Naikon_APT_Sample1 {
	meta:

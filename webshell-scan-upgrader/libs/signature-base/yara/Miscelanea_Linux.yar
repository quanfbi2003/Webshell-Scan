...
//===SUCCESS===
rule DarkenCode_Miscelanea_Linux_LinuxAESDDoS
{
    meta:
	Author = "@benkow_"
	Date = "2014/09/12"
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Linux_LinuxBillGates
{
    meta:
       Author      = "@benkow_"
       Date        = "2014/08/11" 
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Linux_LinuxElknot
{
    meta:
	Author      = "@benkow_"
        Date        = "2013/12/24" 
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Linux_LinuxMrBlack
{
    meta:
	Author      = "@benkow_"
        Date        = "2014/09/12" 
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Linux_LinuxTsunami
{
    meta:
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Linux_rootkit
{
	meta:
                author="xorseed"
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Linux_exploit
{
        meta:
                author="xorseed"
                reference= "https://stuff.rop.io/"
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Linux_ldpreload
{
        meta:
                author="xorseed"
                reference= "https://stuff.rop.io/"
...
//===SUCCESS===
rule DarkenCode_Miscelanea_Linux_keylogger
{
        meta:
                author="xorseed"
                reference="https://stuff.rop.io/"

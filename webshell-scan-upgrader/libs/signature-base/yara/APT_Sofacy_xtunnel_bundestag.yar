import "pe"
//===SUCCESS===
rule Neo23x0_apt_sofacy_xtunnel_bundestag_apt_sofacy_xtunnel {
    meta:
...
//===SUCCESS===
rule Neo23x0_apt_sofacy_xtunnel_bundestag_Winexe_RemoteExec {
   meta:
...
//===SUCCESS===
rule Neo23x0_apt_sofacy_xtunnel_bundestag_Sofacy_Mal2 {
    meta:
...
//===SUCCESS===
rule Neo23x0_apt_sofacy_xtunnel_bundestag_Sofacy_Mal3 {
    meta:
...
//===SUCCESS===
rule Neo23x0_apt_sofacy_xtunnel_bundestag_Sofacy_Bundestag_Batch {
    meta:

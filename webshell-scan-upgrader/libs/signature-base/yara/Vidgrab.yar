...
//===SUCCESS===
rule DarkenCode_Vidgrab_VidgrabCode : Vidgrab Family 
{
    meta:
...
//===SUCCESS===
rule DarkenCode_Vidgrab_VidgrabStrings : Vidgrab Family
{
    meta:
...
//===SUCCESS===
rule DarkenCode_Vidgrab_Vidgrab : Family
{
    meta:
        description = "Vidgrab"
        author = "Seth Hardy"
    ...
    condition:
        DarkenCode_Vidgrab_VidgrabCode or DarkenCode_Vidgrab_VidgrabStrings
}

...
//===SUCCESS===
rule DarkenCode_Xtreme_xtreme_rat : Trojan
{
	meta:
		author="Kevin Falcoz"
		date="23/02/2013"
...
//===SUCCESS===
rule DarkenCode_Xtreme_XtremeRATCode : XtremeRAT Family 
{
    meta:
...
//===SUCCESS===
rule DarkenCode_Xtreme_XtremeRATStrings : XtremeRAT Family
{
    meta:
...
//===SUCCESS===
rule DarkenCode_Xtreme_XtremeRAT : Family
{
    meta:
    ...
    condition:
        DarkenCode_Xtreme_XtremeRATCode or DarkenCode_Xtreme_XtremeRATStrings
}
//===SUCCESS===
rule DarkenCode_Xtreme_xtremrat : rat
{
	meta:

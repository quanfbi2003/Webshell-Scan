...
//===SUCCESS===
rule Neo23x0_apt_bluetermite_emdivi_Emdivi_SFX {
	meta:
...
/* Super Rules ------------------------------------------------------------- */
//===SUCCESS===
rule Neo23x0_apt_bluetermite_emdivi_Emdivi_Gen1 {
	meta:
...
//===SUCCESS===
rule Neo23x0_apt_bluetermite_emdivi_Emdivi_Gen2 {
	meta:
		description = "Detects Emdivi Malware"
		author = "Florian Roth (Nextron Systems) @Cyber0ps"
		reference = "https://securelist.com/blog/research/71876/new-activity-of-the-blue-termite-apt/"
...
//===SUCCESS===
rule Neo23x0_apt_bluetermite_emdivi_MAL_Emdivi_Gen3 {
   meta:
      description = "Detects Emdivi Malware"
...
//===SUCCESS===
rule Neo23x0_apt_bluetermite_emdivi_Emdivi_Gen4 {
	meta:
		description = "Detects Emdivi Malware"
		author = "Florian Roth (Nextron Systems) @Cyber0ps"
		reference = "https://securelist.com/blog/research/71876/new-activity-of-the-blue-termite-apt/"

/*
<<<<<<< Updated upstream:libs/signature-base/yara/apt_cloudduke.yar
	Yara Rule Set
	Author: Florian Roth
	Date: 2015-07-22
...
//===SUCCESS===
rule DarkenCode_APT_Cloudduke_CloudDuke_Malware {
>>>>>>> Stashed changes:webshell-scan-upgrader/libs/signature-base/yara/apt_cloudduke.yar
	meta:
...
//===SUCCESS===
rule DarkenCode_APT_Cloudduke_Acrotray_Anomaly {
	meta:
...
/* Super Rules ------------------------------------------------------------- */
//===SUCCESS===
rule DarkenCode_APT_Cloudduke_SFXRAR_Acrotray {
>>>>>>> Stashed changes:webshell-scan-upgrader/libs/signature-base/yara/apt_cloudduke.yar
	meta:

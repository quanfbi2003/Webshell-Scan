...
//===SUCCESS===
rule Neo23x0_apt_laudanum_webshells_asp_file {
	meta:
	...
	strings:
		...
		$s6 = "Set file = fso.GetFile(file_path)" fullword ascii
	condition:
		uint16(0) == 0x253c and filesize < 30KB and 5 of them
}
//===SUCCESS===
rule Neo23x0_apt_laudanum_webshells_php_killnc {
	meta:
...
//===SUCCESS===
rule Neo23x0_apt_laudanum_webshells_asp_shell {
	meta:
...
//===SUCCESS===
rule Neo23x0_apt_laudanum_webshells_settings {
	meta:
...
//===SUCCESS===
rule Neo23x0_apt_laudanum_webshells_asp_proxy {
	meta:
...
//===SUCCESS===
rule Neo23x0_apt_laudanum_webshells_cfm_shell {
	meta:
...
//===SUCCESS===
rule Neo23x0_apt_laudanum_webshells_aspx_shell {
	meta:
...
//===SUCCESS===
rule Neo23x0_apt_laudanum_webshells_php_shell {
	meta:
...
//===SUCCESS===
rule Neo23x0_apt_laudanum_webshells_php_reverse_shell {
	meta:
...
//===SUCCESS===
rule Neo23x0_apt_laudanum_webshells_php_dns {
	meta:
...
//===SUCCESS===
rule Neo23x0_apt_laudanum_webshells_WEB_INF_web {
	meta:
...
//===SUCCESS===
rule Neo23x0_apt_laudanum_webshells_jsp_cmd {
	meta:
...
//===SUCCESS===
rule Neo23x0_apt_laudanum_webshells_laudanum {
	meta:
...
//===SUCCESS===
rule Neo23x0_apt_laudanum_webshells_php_file {
	meta:
...
//===SUCCESS===
rule Neo23x0_apt_laudanum_webshells_warfiles_cmd {
	meta:
...
//===SUCCESS===
rule Neo23x0_apt_laudanum_webshells_asp_dns {
	meta:
...
//===SUCCESS===
rule Neo23x0_apt_laudanum_webshells_php_reverse_shell_2 {
	meta:
		description = "Laudanum Injector Tools - file php-reverse-shell.php"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
//===SUCCESS===
rule Neo23x0_apt_laudanum_webshells_Laudanum_Tools_Generic {
	meta:

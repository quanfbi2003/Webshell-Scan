...
//===SUCCESS===
rule DarkenCode_crypto_BLOWFISH_Constants {
        meta:
                author = "phoul (@phoul)"
...
//===SUCCESS===
rule DarkenCode_crypto_MD5_Constants {
        meta:
                author = "phoul (@phoul)"
...
//===SUCCESS===
rule DarkenCode_crypto_RC6_Constants {
        meta:
                author = "chort (@chort0)"
...
//===SUCCESS===
rule DarkenCode_crypto_RIPEMD160_Constants {
        meta:
                author = "phoul (@phoul)"
...
//===SUCCESS===
rule DarkenCode_crypto_SHA1_Constants {
        meta:
                author = "phoul (@phoul)"
...
//===SUCCESS===
rule DarkenCode_crypto_SHA512_Constants {
        meta:
                author = "phoul (@phoul)"
...
//===SUCCESS===
rule DarkenCode_crypto_WHIRLPOOL_Constants {
        meta:
                author = "phoul (@phoul)"
...
//===SUCCESS===
rule DarkenCode_crypto_DarkEYEv3_Cryptor {
	meta:

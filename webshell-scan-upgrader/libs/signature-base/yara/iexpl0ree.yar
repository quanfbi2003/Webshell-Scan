...
//===SUCCESS===
rule DarkenCode_iexpl0ree_iexpl0reCode : iexpl0ree Family 
{
    meta:
...
//===SUCCESS===
rule DarkenCode_iexpl0ree_iexpl0reStrings : iexpl0re Family
{
    meta:
...
//===SUCCESS===
rule DarkenCode_iexpl0ree_iexpl0re : Family
{
    meta:
    ...
    condition:
        DarkenCode_iexpl0ree_iexpl0reCode or DarkenCode_iexpl0ree_iexpl0reStrings

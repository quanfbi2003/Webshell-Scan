...
//===SUCCESS===
rule DarkenCode_FiveEyes_FiveEyes_QUERTY_Malwareqwerty_20121 {
	meta:
...
//===SUCCESS===
rule DarkenCode_FiveEyes_FiveEyes_QUERTY_Malwaresig_20123_sys {
	meta:
...
//===SUCCESS===
rule DarkenCode_FiveEyes_FiveEyes_QUERTY_Malwaresig_20123_cmdDef {
	meta:
...
//===SUCCESS===
rule DarkenCode_FiveEyes_FiveEyes_QUERTY_Malwaresig_20121_dll {
	meta:
...
//===SUCCESS===
rule DarkenCode_FiveEyes_FiveEyes_QUERTY_Malwareqwerty_20123 {
	meta:
...
//===SUCCESS===
rule DarkenCode_FiveEyes_FiveEyes_QUERTY_Malwaresig_20120_dll {
	meta:
...
//===SUCCESS===
rule DarkenCode_FiveEyes_FiveEyes_QUERTY_Malwaresig_20120_cmdDef {
	meta:
...
//===SUCCESS===
rule DarkenCode_FiveEyes_FiveEyes_QUERTY_Malwareqwerty_20120 {
	meta:
...
//===SUCCESS===
rule DarkenCode_FiveEyes_FiveEyes_QUERTY_Malwaresig_20121_cmdDef {
	meta:

...
//===SUCCESS===
rule Neo23x0_yara_mixed_ext_vars_Acrotray_Anomaly {
	meta:
...
//===SUCCESS===
rule Neo23x0_yara_mixed_ext_vars_COZY_FANCY_BEAR_modified_VmUpgradeHelper {
	meta:
...
//===SUCCESS===
rule Neo23x0_yara_mixed_ext_vars_IronTiger_Gh0stRAT_variant
{
	meta:
...
//===SUCCESS===
rule Neo23x0_yara_mixed_ext_vars_OpCloudHopper_Cloaked_PSCP {
   meta:
...
//===SUCCESS===
rule Neo23x0_yara_mixed_ext_vars_msi_dll_Anomaly {
   meta:
...
//===SUCCESS===
rule Neo23x0_yara_mixed_ext_vars_PoS_Malware_MalumPOS_Config
{
    meta:
        license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"
...
//===SUCCESS===
rule Neo23x0_yara_mixed_ext_vars_Malware_QA_update_test {
	meta:
...
//===SUCCESS===
rule Neo23x0_yara_mixed_ext_vars_SysInterals_PipeList_NameChanged {
	meta:
...
/* Rule Set ----------------------------------------------------------------- */
//===SUCCESS===
rule Neo23x0_yara_mixed_ext_vars_SCT_Scriptlet_in_Temp_Inet_Files {
	meta:
...
//===SUCCESS===
rule Neo23x0_yara_mixed_ext_vars_GIFCloaked_Webshell_A {
   meta:
...
*/
//===SUCCESS===
rule Neo23x0_yara_mixed_ext_vars_HackTool_Producers {
   meta:
...
//===SUCCESS===
rule Neo23x0_yara_mixed_ext_vars_Exe_Cloaked_as_ThumbsDb
    {
    meta:
...
//===SUCCESS===
rule Neo23x0_yara_mixed_ext_vars_Fake_AdobeReader_EXE
    {
    meta:
...
//===SUCCESS===
rule Neo23x0_yara_mixed_ext_vars_mimikatz_lsass_mdmp
{
   meta:
...
//===SUCCESS===
rule Neo23x0_yara_mixed_ext_vars_lsadump {
   meta:
...
//===SUCCESS===
rule Neo23x0_yara_mixed_ext_vars_SUSP_ServU_SSH_Error_Pattern_Jul21_1 {
   meta:
...
//===SUCCESS===
rule Neo23x0_yara_mixed_ext_vars_SUSP_ServU_Known_Mal_IP_Jul21_1 {
   meta:
...
//===SUCCESS===
rule Neo23x0_yara_mixed_ext_vars_SUSP_EXPL_Confluence_RCE_CVE_2021_26084_Indicators_Sep21 {
   meta:
...
//===SUCCESS===
rule Neo23x0_yara_mixed_ext_vars_SUSP_Blocked_Download_Proxy_Replacement_Jan23_1 {
   meta:
...
*/
//===SUCCESS===
rule Neo23x0_yara_mixed_ext_vars_APT_MAL_RU_Snake_Malware_Queue_File_May23_1 {
   meta:
...
//===SUCCESS===
rule Neo23x0_yara_mixed_ext_vars_SUSP_Password_XLS_Unencrypted {
   meta:
...
//===SUCCESS===
rule Neo23x0_yara_mixed_ext_vars_SUSP_Password_XLS_Encrypted {
   meta:

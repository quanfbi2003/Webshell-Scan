...
//===SUCCESS===
rule DarkenCode_Equation_apt_equation_exploitlib_mutexes {
    meta:
...
//===SUCCESS===
rule DarkenCode_Equation_apt_equation_doublefantasy_genericresource {
    meta:
        copyright = "Kaspersky Lab"
...
//===SUCCESS===
rule DarkenCode_Equation_apt_equation_equationlaser_runtimeclasses {
	meta:
	    copyright = "Kaspersky Lab"
...
//===SUCCESS===
rule DarkenCode_Equation_apt_equation_cryptotable {
	meta:
	    copyright = "Kaspersky Lab"
...
//===SUCCESS===
rule DarkenCode_Equation_Equation_Kaspersky_TripleFantasy_1 {
	meta:
...
//===SUCCESS===
rule DarkenCode_Equation_Equation_Kaspersky_DoubleFantasy_1 {
	meta:
...
//===SUCCESS===
rule DarkenCode_Equation_Equation_Kaspersky_GROK_Keylogger {
	meta:
...
//===SUCCESS===
rule DarkenCode_Equation_Equation_Kaspersky_GreyFishInstaller {
	meta:
...
//===SUCCESS===
rule DarkenCode_Equation_Equation_Kaspersky_EquationDrugInstaller {
	meta:
...
//===SUCCESS===
rule DarkenCode_Equation_Equation_Kaspersky_EquationLaserInstaller {
	meta:
...
//===SUCCESS===
rule DarkenCode_Equation_Equation_Kaspersky_FannyWorm {
	meta:
...
//===SUCCESS===
rule DarkenCode_Equation_Equation_Kaspersky_HDD_reprogramming_module {
	meta:
...
//===SUCCESS===
rule DarkenCode_Equation_Equation_Kaspersky_EOP_Package {
	meta:
...
//===SUCCESS===
rule DarkenCode_Equation_Equation_Kaspersky_TripleFantasy_Loader {
	meta:
...
//===SUCCESS===
rule DarkenCode_Equation_Equation_Kaspersky_SuspiciousString {
	meta:
...
//===SUCCESS===
rule DarkenCode_Equation_EquationDrug_NetworkSniffer1 {
	meta:
...
//===SUCCESS===
rule DarkenCode_Equation_EquationDrug_CompatLayer_UnilayDLL {
	meta:
...
//===SUCCESS===
rule DarkenCode_Equation_EquationDrug_HDDSSD_Op {
	meta:
...
//===SUCCESS===
rule DarkenCode_Equation_EquationDrug_NetworkSniffer2 {
	meta:
...
//===SUCCESS===
rule DarkenCode_Equation_EquationDrug_NetworkSniffer3 {
	meta:
		description = "EquationDrug - Network Sniffer - tdip.sys"
		author = "Florian Roth @4nc4p"
		reference = "http://securelist.com/blog/research/69203/inside-the-equationdrug-espionage-platform/"
...
//===SUCCESS===
rule DarkenCode_Equation_EquationDrug_VolRec_Driver {
	meta:
...
//===SUCCESS===
rule DarkenCode_Equation_EquationDrug_KernelRootkit {
	meta:
...
//===SUCCESS===
rule DarkenCode_Equation_EquationDrug_Keylogger {
	meta:
...
//===SUCCESS===
rule DarkenCode_Equation_EquationDrug_NetworkSniffer4 {
	meta:
...
//===SUCCESS===
rule DarkenCode_Equation_EquationDrug_PlatformOrchestrator {
	meta:
...
//===SUCCESS===
rule DarkenCode_Equation_EquationDrug_NetworkSniffer5 {
	meta:
		description = "EquationDrug - Network-sniffer/patcher - atmdkdrv.sys"
		author = "Florian Roth @4nc4p"
		reference = "http://securelist.com/blog/research/69203/inside-the-equationdrug-espionage-platform/"
...
//===SUCCESS===
rule DarkenCode_Equation_EquationDrug_FileSystem_Filter {
	meta:

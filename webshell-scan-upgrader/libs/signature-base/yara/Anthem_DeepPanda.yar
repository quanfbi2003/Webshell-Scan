...
//===SUCCESS===
rule DarkenCode_Anthem_DeepPanda_Anthem_DeepPanda_sl_txt_packed {
	meta:
...
//===SUCCESS===
rule DarkenCode_Anthem_DeepPanda_Anthem_DeepPanda_lot1 {
	meta:
...
//===SUCCESS===
rule DarkenCode_Anthem_DeepPanda_Anthem_DeepPanda_htran_exe {
	meta:
...
//===SUCCESS===
rule DarkenCode_Anthem_DeepPanda_Anthem_DeepPanda_Trojan_Kakfum {
	meta:

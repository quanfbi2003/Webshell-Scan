...
//===SUCCESS===
rule DarkenCode_LURK0_LURK0Header : Family LURK0 {
	meta:
...
//===SUCCESS===
rule DarkenCode_LURK0_CCTV0Header : Family CCTV0 {
        meta:  
		description = "5 char code for LURK0"
		author = "Katie Kleemola"
		last_updated = "07-21-2014"
...
//===SUCCESS===
rule DarkenCode_LURK0_SharedStrings : Family {
	meta:
...
//===SUCCESS===
rule DarkenCode_LURK0_LURK0 : Family LURK0 {
	...
	condition:
		DarkenCode_LURK0_LURK0Header and DarkenCode_LURK0_SharedStrings

}
//===SUCCESS===
rule DarkenCode_LURK0_CCTV0 : Family CCTV0 {
	...
	condition:
		DarkenCode_LURK0_CCTV0Header and DarkenCode_LURK0_SharedStrings

...
//===SUCCESS===
rule DarkenCode_cxpid_cxpidStrings : cxpid Family
{
    meta:
...
//===SUCCESS===
rule DarkenCode_cxpid_cxpidCode : cxpid Family 
{
    meta:
...
//===SUCCESS===
rule DarkenCode_cxpid_cxpid : Family
{
    meta:
        description = "cxpid"
        author = "Seth Hardy"
    ...
    condition:
        DarkenCode_cxpid_cxpidCode or DarkenCode_cxpid_cxpidStrings
}

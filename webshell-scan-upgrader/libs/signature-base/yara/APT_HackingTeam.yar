...
//===SUCCESS===
rule DarkenCode_APT_HackingTeam_bin_ndisk {
	meta:
...
//===SUCCESS===
rule DarkenCode_APT_HackingTeam_Hackingteam_Elevator_DLL {
	meta:
...
//===SUCCESS===
rule DarkenCode_APT_HackingTeam_HackingTeam_Elevator_EXE {
	meta:

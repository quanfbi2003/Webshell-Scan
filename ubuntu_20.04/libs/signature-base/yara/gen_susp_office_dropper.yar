...
rule Neo23x0_gen_SUSP_Office_Dropper_Strings {
   meta:
...
rule Neo23x0_gen_SUSP_EnableContent_String_Gen {
   meta:
...
rule Neo23x0_gen_SUSP_WordDoc_VBA_Macro_Strings {
   meta:
...
rule Neo23x0_gen_SUSP_OfficeDoc_VBA_Base64Decode {
   meta:
...
rule Neo23x0_gen_SUSP_VBA_FileSystem_Access {
   meta:
...
rule Neo23x0_gen_SUSP_Excel_IQY_RemoteURI_Syntax {
   meta:
...
rule Neo23x0_gen_SUSP_Macro_Sheet_Obfuscated_Char {
   meta:

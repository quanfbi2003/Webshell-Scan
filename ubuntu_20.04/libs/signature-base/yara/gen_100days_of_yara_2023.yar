...
rule Neo23x0_gen_SUSP_LNK_Embedded_WordDoc {
	meta:
...
rule Neo23x0_gen_SUSP_LNK_SmallScreenSize {
	meta:
		author = "Greg Lesnewich"
...
rule Neo23x0_gen_MAL_Janicab_LNK {
	meta:
		author = "Greg Lesnewich"
...
rule Neo23x0_gen_SUSP_ELF_Invalid_Version {
   meta:
...
rule Neo23x0_gen_MAL_ELF_TorchTriton {
	meta:
		author = "Silas Cutler"
...
rule Neo23x0_gen_MAL_GOLDBACKDOOR_LNK {
	meta:
		author = "Greg Lesnewich"
		date = "2023-01-02"
		version = "1.0"
...
rule Neo23x0_gen_MAL_EXE_LockBit_v2
{
	meta:
...
rule Neo23x0_gen_MAL_EXE_PrestigeRansomware {
	meta:
...
rule Neo23x0_gen_MAL_EXE_RoyalRansomware {
	meta:
		author = "Silas Cutler, modfied by Florian Roth"
...
rule Neo23x0_gen_MAL_PY_Dimorf {
	meta:
		author = "Silas Cutler"

...
rule DarkenCode_Xtr_xtreme_rat : Trojan
{
	meta:
		author="Kevin Falcoz"
		date="23/02/2013"
...
rule DarkenCode_Xtr_XtremeRATCode : XtremeRAT Family 
{
    meta:
...
rule DarkenCode_Xtr_XtremeRATStrings : XtremeRAT Family
{
    meta:
...
rule DarkenCode_Xtr_xtremrat : rat
{
	meta:

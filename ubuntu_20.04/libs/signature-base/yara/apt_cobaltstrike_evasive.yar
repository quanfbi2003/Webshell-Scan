...
rule Neo23x0_apt_CobaltStrike_C2_Host_Indicator {
	meta:
...
rule Neo23x0_apt_CobaltStrike_Sleep_Decoder_Indicator {
	meta:
...
rule Neo23x0_apt_CobaltStrike_C2_Encoded_XOR_Config_Indicator {
	meta:
...
rule Neo23x0_apt_CobaltStrike_MZ_Launcher {
	meta:
...
rule Neo23x0_apt_CobaltStrike_Unmodifed_Beacon {
	meta:

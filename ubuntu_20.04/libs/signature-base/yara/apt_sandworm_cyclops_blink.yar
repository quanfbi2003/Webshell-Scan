...
rule Neo23x0_apt_APT_Sandworm_CyclopsBlink_notable_strings {
   meta:
      author = "NCSC"
...
rule Neo23x0_apt_APT_Sandworm_CyclopsBlink_module_initialisation {
   meta:
      author = "NCSC"
...
rule Neo23x0_apt_APT_Sandworm_CyclopsBlink_modified_install_upgrade {
   meta:
      author = "NCSC"
...
rule Neo23x0_apt_APT_Sandworm_CyclopsBlink_core_command_check {
   meta:
      author = "NCSC"
...
rule Neo23x0_apt_APT_Sandworm_CyclopsBlink_config_identifiers {
   meta:
      author = "NCSC"
...
rule Neo23x0_apt_APT_Sandworm_CyclopsBlink_handle_mod_0xf_command {
   meta:
      author = "NCSC"
...
rule Neo23x0_apt_APT_Sandworm_CyclopsBlink_default_config_values {
   meta:
      author = "NCSC"
...
rule Neo23x0_apt_APT_Sandworm_CyclopsBlink_handle_mod_0x51_command {
   meta:
      author = "NCSC"

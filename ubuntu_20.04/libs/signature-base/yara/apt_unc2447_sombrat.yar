...
rule Neo23x0_apt_APT_UNC2447_MAL_SOMBRAT_May21_1 {
   meta:
...
rule Neo23x0_apt_APT_UNC2447_MAL_RANSOM_HelloKitty_May21_1 {
   meta:
...
rule Neo23x0_apt_APT_UNC2447_MAL_RANSOM_HelloKitty_May21_2 {
   meta:
      description = "Detects HelloKitty Ransomware samples from UNC2447 campaign"
      author = "Florian Roth (Nextron Systems)"
      reference = "https://www.fireeye.com/blog/threat-research/2021/04/unc2447-sombrat-and-fivehands-ransomware-sophisticated-financial-threat.html"
...
rule Neo23x0_apt_APT_UNC2447_PS1_WARPRISM_May21_1 {
   meta:
...
rule Neo23x0_apt_APT_UNC2447_BAT_Runner_May21_1 {
   meta:

...
rule Neo23x0_apt_APT28_CHOPSTICK {
	meta:
...
rule Neo23x0_apt_APT28_SourFace_Malware1 {
	meta:
...
rule Neo23x0_apt_APT28_SourFace_Malware2 {
	meta:
		description = "Detects Malware from APT28 incident - SOURFACE is a downloader that obtains a second-stage backdoor from a C2 server."
		author = "Florian Roth (Nextron Systems)"
		reference = "https://www.fireeye.com/blog/threat-research/2014/10/apt28-a-window-into-russias-cyber-espionage-operations.html"
...
rule Neo23x0_apt_APT28_SourFace_Malware3 {
	meta:
		description = "Detects Malware from APT28 incident - SOURFACE is a downloader that obtains a second-stage backdoor from a C2 server."
		author = "Florian Roth (Nextron Systems)"
		reference = "https://www.fireeye.com/blog/threat-research/2014/10/apt28-a-window-into-russias-cyber-espionage-operations.html"
...
rule Neo23x0_apt_APT28_SkinnyBoy_Dropper: RUSSIA {
   meta:
...
rule Neo23x0_apt_APT28_SkinnyBoy_Launcher: RUSSIA {
   meta:
...
rule Neo23x0_apt_APT28_SkinnyBoy_Implanter: RUSSIA {
   meta:

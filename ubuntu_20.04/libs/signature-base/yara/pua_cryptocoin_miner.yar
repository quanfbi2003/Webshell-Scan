...
rule Neo23x0_pua_CoinMiner_Strings : SCRIPT HIGHVOL {
   meta:
...
rule Neo23x0_pua_CoinHive_Javascript_MoneroMiner : HIGHVOL {
   meta:
...
rule Neo23x0_pua_PUA_CryptoMiner_Jan19_1 {
   meta:
...
rule Neo23x0_pua_PUA_Crypto_Mining_CommandLine_Indicators_Oct21 : SCRIPT {
   meta:

...
rule DarkenCode_Wat_WaterBug_wipbot_2013_core_PDF {
	meta:
...
rule DarkenCode_Wat_WaterBug_wipbot_2013_dll {
	meta:
...
rule DarkenCode_Wat_WaterBug_wipbot_2013_core {
	meta:
...
rule DarkenCode_Wat_WaterBug_turla_dropper {
	meta:
...
rule DarkenCode_Wat_WaterBug_fa_malware { 
	meta: 
...
rule DarkenCode_Wat_WaterBug_sav {
	meta: 

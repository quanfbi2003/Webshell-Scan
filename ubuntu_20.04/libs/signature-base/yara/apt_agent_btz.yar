...
rule Neo23x0_apt_Agent_BTZ_Proxy_DLL_1 {
   meta:
...
rule Neo23x0_apt_Agent_BTZ_Proxy_DLL_2 {
   meta:
      description = "Detects Agent-BTZ Proxy DLL - activeds.dll"
      author = "Florian Roth (Nextron Systems)"
      reference = "http://www.intezer.com/new-variants-of-agent-btz-comrat-found/"
...
rule Neo23x0_apt_Agent_BTZ_Aug17 {
   meta:
...
rule Neo23x0_apt_APT_Turla_Agent_BTZ_Gen_1 {
   meta:

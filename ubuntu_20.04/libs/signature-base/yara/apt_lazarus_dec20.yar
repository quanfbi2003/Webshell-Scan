...
rule Neo23x0_apt_HvS_APT37_smb_scanner {
   meta:
...
rule Neo23x0_apt_HvS_APT37_cred_tool {
   meta:
...
rule Neo23x0_apt_HvS_APT37_RAT_loader {
   meta:
...
rule Neo23x0_apt_HvS_APT37_webshell_img_thumbs_asp {
   meta:
...
rule Neo23x0_apt_HvS_APT37_webshell_template_query_asp {
   meta:
...
rule Neo23x0_apt_HvS_APT37_mimikatz_loader_DF012 {
   meta:
...
rule Neo23x0_apt_HvS_APT37_webshell_controllers_asp {
   meta:

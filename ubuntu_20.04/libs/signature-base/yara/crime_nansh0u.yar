...
rule Neo23x0_cri_MAL_XMR_Miner_May19_1 : HIGHVOL {
   meta:
...
rule Neo23x0_cri_HKTL_CN_ProcHook_May19_1 {
   meta:
...
rule Neo23x0_cri_SUSP_PDB_CN_Threat_Actor_May19_1 {
   meta:
...
rule Neo23x0_cri_MAL_Ramnit_May19_1 {
   meta:
...
rule Neo23x0_cri_MAL_Parite_Malware_May19_1 {
   meta:
...
rule Neo23x0_cri_MAL_Parite_Malware_May19_2 {
   meta:
...
rule Neo23x0_cri_EXPL_Strings_CVE_POC_May19_1 {
   meta:

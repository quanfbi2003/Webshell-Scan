...
rule DarkenCode_Roo_RooterCode : Rooter Family 
{
    meta:
...
rule DarkenCode_Roo_RooterStrings : Rooter Family
{
    meta:
...
rule DarkenCode_Roo_RookieStrings : Rookie Family
{
    meta:
...
rule DarkenCode_Roo_RookieCode : Rookie Family 
{
    meta:

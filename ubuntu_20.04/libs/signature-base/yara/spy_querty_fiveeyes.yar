...
rule Neo23x0_spy_FiveEyes_QUERTY_Malwareqwerty_20121 {
	meta:
...
rule Neo23x0_spy_FiveEyes_QUERTY_Malwaresig_20123_sys {
	meta:
...
rule Neo23x0_spy_FiveEyes_QUERTY_Malwaresig_20123_cmdDef {
	meta:
...
rule Neo23x0_spy_FiveEyes_QUERTY_Malwaresig_20121_dll {
	meta:
...
rule Neo23x0_spy_FiveEyes_QUERTY_Malwareqwerty_20123 {
	meta:
...
rule Neo23x0_spy_FiveEyes_QUERTY_Malwaresig_20120_dll {
	meta:
...
rule Neo23x0_spy_FiveEyes_QUERTY_Malwaresig_20120_cmdDef {
	meta:
...
rule Neo23x0_spy_FiveEyes_QUERTY_Malwareqwerty_20120 {
	meta:
...
rule Neo23x0_spy_FiveEyes_QUERTY_Malwaresig_20121_cmdDef {
	meta:

...
rule Neo23x0_apt_APT_HKTL_Wiper_WhisperGate_Jan22_1 {
   meta:
...
rule Neo23x0_apt_APT_HKTL_Wiper_WhisperGate_Jan22_2 {
   meta:
      description = "Detects unknown wiper malware"
      author = "Florian Roth (Nextron Systems)"
      reference = "https://www.microsoft.com/security/blog/2022/01/15/destructive-malware-targeting-ukrainian-organizations/"
...
rule Neo23x0_apt_APT_HKTL_Wiper_WhisperGate_Stage3_Jan22 {
   meta:
...
rule Neo23x0_apt_MAL_OBFUSC_Unknown_Jan22_1 {
   meta:
...
rule Neo23x0_apt_MAL_Unknown_Discord_Characteristics_Jan22_1 {
   meta:

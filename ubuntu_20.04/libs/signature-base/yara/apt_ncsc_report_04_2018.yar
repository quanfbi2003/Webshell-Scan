...
rule Neo23x0_apt_Bytes_used_in_AES_key_generation {
   meta:
      author = "NCSC"
...
rule Neo23x0_apt_Partial_Implant_ID {
   meta:
      author = "NCSC"
...
rule Neo23x0_apt_Sleep_Timer_Choice {
   meta:
      author = "NCSC"
...
rule Neo23x0_apt_User_Function_String {
   meta:
      author = "NCSC"
...
rule Neo23x0_apt_generic_shellcode_downloader_specific {
  meta:
    author = "NCSC"
...
rule Neo23x0_apt_Batch_Script_To_Run_PsExec {
   meta:
      author = "NCSC"
...
rule Neo23x0_apt_Batch_Powershell_Invoke_Inveigh {
   meta:
      author = "NCSC"
      description = "Detects malicious batch file from NCSC report"
      reference = "https://www.ncsc.gov.uk/alerts/hostile-state-actors-compromising-uk-organisations-focus-engineering-and-industrial-control"
...
rule Neo23x0_apt_RDP_Brute_Strings {
   meta:
      author = "NCSC"
...
rule Neo23x0_apt_WEBSHELL_Z_WebShell_1 {
   meta:
      author = "NCSC"

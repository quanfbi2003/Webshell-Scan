...
rule DarkenCode_ant_DebuggerCheck__API : AntiDebug DebuggerCheck {
	meta:
		weight = 1
		Author = "naxonez"
...
rule DarkenCode_ant_DebuggerCheck__PEB : AntiDebug DebuggerCheck {
	meta:
		weight = 1
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
...
rule DarkenCode_ant_DebuggerCheck__GlobalFlags : AntiDebug DebuggerCheck {
	meta:
		weight = 1
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
...
rule DarkenCode_ant_DebuggerCheck__QueryInfo : AntiDebug DebuggerCheck {
	meta:
		weight = 1
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
...
rule DarkenCode_ant_DebuggerCheck__RemoteAPI : AntiDebug DebuggerCheck {
	meta:
		weight = 1
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
...
rule DarkenCode_ant_DebuggerHiding__Thread : AntiDebug DebuggerHiding {
	meta:
	    Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
		weight = 1
...
rule DarkenCode_ant_DebuggerHiding__Active : AntiDebug DebuggerHiding {
	meta:
		weight = 1
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
...
rule DarkenCode_ant_DebuggerTiming__PerformanceCounter : AntiDebug DebuggerTiming {
	meta:
		weight = 1
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
...
rule DarkenCode_ant_DebuggerTiming__Ticks : AntiDebug DebuggerTiming {
	meta:
		weight = 1
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
...
rule DarkenCode_ant_DebuggerOutput__String : AntiDebug DebuggerOutput {
	meta:
		weight = 1
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
...
rule DarkenCode_ant_DebuggerException__UnhandledFilter : AntiDebug DebuggerException {
	meta:
		weight = 1
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
...
rule DarkenCode_ant_DebuggerException__ConsoleCtrl : AntiDebug DebuggerException {
	meta:
		weight = 1
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
...
rule DarkenCode_ant_DebuggerException__SetConsoleCtrl : AntiDebug DebuggerException {
	meta:
		weight = 1
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
...
rule DarkenCode_ant_ThreadControl__Context : AntiDebug ThreadControl {
	meta:
		weight = 1
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
...
rule DarkenCode_ant_DebuggerCheck__DrWatson : AntiDebug DebuggerCheck {
	meta:
		weight = 1
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
...
rule DarkenCode_ant_SEH__v3 : AntiDebug SEH {
	meta:
		weight = 1
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
...
rule DarkenCode_ant_SEH__v4 : AntiDebug SEH {
    // VS 8.0+
	meta:
		weight = 1
		Author = "naxonez"
...
rule DarkenCode_ant_SEH__vba : AntiDebug SEH {
	meta:
		weight = 1
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
...
rule DarkenCode_ant_SEH__vectored : AntiDebug SEH {
	meta:
		weight = 1
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
...
rule DarkenCode_ant_DebuggerPattern__RDTSC : AntiDebug DebuggerPattern {
	meta:
		weight = 1
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
...
rule DarkenCode_ant_DebuggerPattern__CPUID : AntiDebug DebuggerPattern {
	meta:
		weight = 1
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
...
rule DarkenCode_ant_DebuggerPattern__SEH_Saves : AntiDebug DebuggerPattern {
	meta:
		weight = 1
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
...
rule DarkenCode_ant_DebuggerPattern__SEH_Inits : AntiDebug DebuggerPattern {
	meta:
		weight = 1
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
...
rule DarkenCode_ant_Check_Dlls
{
	meta:
		Author = "Nick Hoffman"
...
rule DarkenCode_ant_Check_Qemu_Description
{
	meta:
		Author = "Nick Hoffman"
...
rule DarkenCode_ant_Check_Qemu_DeviceMap
{
	meta:
		Author = "Nick Hoffman"
...
rule DarkenCode_ant_Check_VBox_Description
{
	meta:
		Author = "Nick Hoffman"
...
rule DarkenCode_ant_Check_VBox_DeviceMap
{
	meta:
		Author = "Nick Hoffman"
...
rule DarkenCode_ant_Check_VBox_Guest_Additions
{
	meta:
		Author = "Nick Hoffman"
...
rule DarkenCode_ant_Check_VBox_VideoDrivers
{
	meta:
		Author = "Nick Hoffman"
...
rule DarkenCode_ant_Check_VMWare_DeviceMap
{
	meta:
		Author = "Nick Hoffman"
...
rule DarkenCode_ant_Check_VmTools
{
	meta:
		Author = "Nick Hoffman"
...
rule DarkenCode_ant_Check_Wine
{
	meta:
		Author = "Nick Hoffman"
...
rule DarkenCode_ant_Check_Debugger
{
	meta:
		Author = "Nick Hoffman"
...
rule DarkenCode_ant_Check_DriveSize
{
	meta:
		Author = "Nick Hoffman"
...
rule DarkenCode_ant_Check_file_paths
{
	meta:
		Author = "Nick Hoffman"
		Description = "Checks for file_paths containing popular sandbox names"
		Sample = "de1af0e97e94859d372be7fcf3a5daa5"
	strings: 
...
rule DarkenCode_ant_Check_UserNames
{
	meta:
		Author = "Nick Hoffman"
...
rule DarkenCode_ant_Check_OutputDebugStringA_iat
{
...
rule DarkenCode_ant_Check_unhandledExceptionFiler_iat {
...
rule DarkenCode_ant_check_RaiseException_iat {
...
rule DarkenCode_ant_Check_FindWindowA_iat {
...
rule DarkenCode_ant_DebuggerCheck__MemoryWorkingSet : AntiDebug DebuggerCheck {
	meta:

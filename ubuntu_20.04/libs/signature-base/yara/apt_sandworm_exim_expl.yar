...
rule Neo23x0_apt_APT_Sandworm_Keywords_May20_1 {
   meta:
...
rule Neo23x0_apt_APT_Sandworm_SSH_Key_May20_1 {
   meta:
...
rule Neo23x0_apt_APT_Sandworm_SSHD_Config_Modification_May20_1 {
   meta:
...
rule Neo23x0_apt_APT_Sandworm_InitFile_May20_1 {
   meta:
...
rule Neo23x0_apt_APT_Sandworm_User_May20_1 {
   meta:
...
rule Neo23x0_apt_APT_WEBSHELL_PHP_Sandworm_May20_1 {
   meta:
...
rule Neo23x0_apt_APT_SH_Sandworm_Shell_Script_May20_1 {
   meta:
...
rule Neo23x0_apt_APT_RU_Sandworm_PY_May20_1 {
   meta:
...
rule Neo23x0_apt_APT_RU_Sandworm_PY_May20_2 {
   meta:
      description = "Detects Sandworm Python loader"
      author = "Florian Roth (Nextron Systems)"
      reference = "https://twitter.com/billyleonard/status/1266054881225236482"

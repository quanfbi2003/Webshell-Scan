...
rule Neo23x0_pua_XMRIG_Monero_Miner : HIGHVOL {
   meta:
...
rule Neo23x0_pua_XMRIG_Monero_Miner_Config {
   meta:
...
rule Neo23x0_pua_PUA_LNX_XMRIG_CryptoMiner {
   meta:
...
rule Neo23x0_pua_SUSP_XMRIG_String {
   meta:

...
rule Neo23x0_apt_Sofacy_Malware_StrangeSpaces {
	meta:
...
rule Neo23x0_apt_Sofacy_Malware_AZZY_Backdoor_1 {
	meta:
...
rule Neo23x0_apt_Sofacy_AZZY_Backdoor_Implant_1 {
	meta:
...
rule Neo23x0_apt_Sofacy_AZZY_Backdoor_HelperDLL {
	meta:
...
rule Neo23x0_apt_Sofacy_CollectorStealer_Gen1 {
	meta:
...
rule Neo23x0_apt_Sofacy_CollectorStealer_Gen2 {
	meta:
...
rule Neo23x0_apt_Sofacy_CollectorStealer_Gen3 {
	meta:
		description = "File collectors / USB stealers - Generic"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"

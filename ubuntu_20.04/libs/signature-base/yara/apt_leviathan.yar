...
rule Neo23x0_apt_SeDLL_Javascript_Decryptor {
   meta:
...
rule Neo23x0_apt_Leviathan_CobaltStrike_Sample_1 {
   meta:
...
rule Neo23x0_apt_VBScript_Favicon_File {
   meta:

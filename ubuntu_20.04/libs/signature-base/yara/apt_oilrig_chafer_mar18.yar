...
rule Neo23x0_apt_Chafer_Mimikatz_Custom  {
   meta:
...
rule Neo23x0_apt_Chafer_Exploit_Copyright_2017 {
   meta:
...
rule Neo23x0_apt_Chafer_Portscanner {
   meta:
...
rule Neo23x0_apt_Oilrig_Myrtille {
   meta:
...
rule Neo23x0_apt_Chafer_Packed_Mimikatz {
   meta:
...
rule Neo23x0_apt_Oilrig_PS_CnC {
   meta:

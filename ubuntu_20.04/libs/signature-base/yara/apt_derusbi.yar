...
rule Neo23x0_apt_derusbi_kernel
{
    meta:
...
rule Neo23x0_apt_derusbi_linux
{
    meta:
...
rule Neo23x0_apt_Derusbi_Kernel_Driver_WD_UDFS {
	meta:
...
rule Neo23x0_apt_Derusbi_Code_Signing_Cert {
	meta:
...
rule Neo23x0_apt_XOR_4byte_Key {
	meta:
...
rule Neo23x0_apt_Derusbi_Backdoor_Mar17_1 {
   meta:

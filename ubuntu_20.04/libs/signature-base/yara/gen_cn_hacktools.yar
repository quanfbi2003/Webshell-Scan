...
rule Neo23x0_gen_mswin_check_lm_group {
   meta:
...
rule Neo23x0_gen_Guilin_veterans_cookie_spoofing_tool {
	meta:
...
rule Neo23x0_gen_PLUGIN_TracKid {
	meta:
...
rule Neo23x0_gen_DTools2_02_DTools {
	meta:
...
rule Neo23x0_gen_DUBrute_DUBrute {
	meta:
...
rule Neo23x0_gen_update_PcInit {
	meta:
...
rule Neo23x0_gen_OtherTools_servu {
	meta:
...
rule Neo23x0_gen_IDTools_For_WinXP_IdtTool {
	meta:
...
rule Neo23x0_gen_GoodToolset_ms11046 {
	meta:
...
rule Neo23x0_gen_Sniffer_analyzer_SSClone_1210_full_version {
	meta:
...
rule Neo23x0_gen_MarathonTool_2 {
	meta:
		description = "Chinese Hacktool Set - file MarathonTool.exe"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_gen_scanms_scanms {
	meta:
...
rule Neo23x0_gen_CN_Tools_PcShare {
	meta:
...
rule Neo23x0_gen_SwitchSniffer {
	meta:
...
rule Neo23x0_gen_FreeVersion_debug {
	meta:
...
rule Neo23x0_gen_WebCrack4_RouterPasswordCracking {
	meta:
...
rule Neo23x0_gen_S_MultiFunction_Scanners_s {
	meta:
...
rule Neo23x0_gen_HKTL_CN_Dos_GetPass {
	meta:
...
rule Neo23x0_gen_HKTL_CN_update_PcMain {
   meta:
...
rule Neo23x0_gen_HKTL_CN_Dos_sys {
	meta:
...
rule Neo23x0_gen_HKTL_CN_dat_xpf {
	meta:
...
rule Neo23x0_gen_HKTL_CN_Project1 {
	meta:
...
rule Neo23x0_gen_CN_Tools_MyUPnP {
	meta:
...
rule Neo23x0_gen_CN_Tools_Shiell {
	meta:
...
rule Neo23x0_gen_cndcom_cndcom {
	meta:
...
rule Neo23x0_gen_HScan_v1_20_PipeCmd {
	meta:
...
rule Neo23x0_gen_CN_Tools_xsniff {
	meta:
...
rule Neo23x0_gen_Ms_Viru_racle {
	meta:
...
rule Neo23x0_gen_epathobj_exp32 {
	meta:
...
rule Neo23x0_gen_Tools_unknown {
	meta:
...
rule Neo23x0_gen_IISPutScanner {
	meta:
...
rule Neo23x0_gen_IDTools_For_WinXP_IdtTool_2 {
	meta:
...
rule Neo23x0_gen_x_way2_5_X_way {
	meta:
...
rule Neo23x0_gen_pw_inspector_2 {
	meta:
		description = "Chinese Hacktool Set - file pw-inspector.exe"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_gen_GoodToolset_ms11011 {
	meta:
...
rule Neo23x0_gen_FreeVersion_release {
	meta:
...
rule Neo23x0_gen_CN_Tools_hscan {
	meta:
...
rule Neo23x0_gen_GoodToolset_pr {
	meta:
...
rule Neo23x0_gen_hydra_7_4_1_hydra {
	meta:
...
rule Neo23x0_gen_CN_Tools_srss_2 {
	meta:
...
rule Neo23x0_gen_CN_Tools_VNCLink {
	meta:
...
rule Neo23x0_gen_mysql_pwd_crack {
	meta:
...
rule Neo23x0_gen_CN_Tools_Vscan {
	meta:
...
rule Neo23x0_gen_IISPutScannesr {
	meta:
...
rule Neo23x0_gen_HKTL_Unknown_CN_Generate {
	meta:
...
rule Neo23x0_gen_ms11080_withcmd {
	meta:
...
rule Neo23x0_gen_OtherTools_xiaoa {
	meta:
...
rule Neo23x0_gen_hydra_7_3_hydra {
	meta:
		description = "Chinese Hacktool Set - file hydra.exe"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_gen_HKTL_Portscanner_533_NET_Jun15 {
	meta:
...
rule Neo23x0_gen_ChinaChopper_caidao {
	meta:
...
rule Neo23x0_gen_KiwiTaskmgr_2 {
	meta:
...
rule Neo23x0_gen_x_way2_5_sqlcmd {
	meta:
		description = "Chinese Hacktool Set - file sqlcmd.exe"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_gen_GoodToolset_ms11080 {
	meta:
...
rule Neo23x0_gen_epathobj_exp64 {
	meta:
...
rule Neo23x0_gen_HScan_v1_20_hscan {
	meta:
		description = "Chinese Hacktool Set - file hscan.exe"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_gen__Project1_Generate_rejoice {
	meta:
...
rule Neo23x0_gen__hscan_hscan_hscangui {
	meta:
...
rule Neo23x0_gen_kiwi_tools_gentil_kiwi {
	meta:
		description = "Chinese Hacktool Set"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"

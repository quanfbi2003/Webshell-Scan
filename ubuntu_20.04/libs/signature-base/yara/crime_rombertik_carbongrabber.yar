...
rule Neo23x0_cri_Rombertik_CarbonGrabber {
	meta:
...
rule Neo23x0_cri_Rombertik_CarbonGrabber_Panel_InstallScript {
	meta:
...
rule Neo23x0_cri_Rombertik_CarbonGrabber_Panel {
	meta:
...
rule Neo23x0_cri_Rombertik_CarbonGrabber_Builder {
	meta:
...
rule Neo23x0_cri_Rombertik_CarbonGrabber_Builder_Server {
	meta:

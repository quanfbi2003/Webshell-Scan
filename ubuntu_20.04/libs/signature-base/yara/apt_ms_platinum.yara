...
rule Neo23x0_apt_Trojan_Win32_PlaSrv : Platinum
{
	meta:
		author = "Microsoft"
...
rule Neo23x0_apt_Trojan_Win32_Platual : Platinum
{
	meta:
		author = "Microsoft"
...
rule Neo23x0_apt_Trojan_Win32_Plaplex : Platinum
{
	meta:
		author = "Microsoft"
...
rule Neo23x0_apt_Trojan_Win32_Dipsind_B : Platinum
{
	meta:
		author = "Microsoft"
...
rule Neo23x0_apt_Trojan_Win32_PlaKeylog_B : Platinum
{
	meta:
		author = "Microsoft"
...
rule Neo23x0_apt_Trojan_Win32_Adupib : Platinum
{
	meta:
		author = "Microsoft"
...
rule Neo23x0_apt_Trojan_Win32_PlaLsaLog : Platinum
{
	meta:
		author = "Microsoft"
...
rule Neo23x0_apt_Trojan_Win32_Plagon : Platinum
{
	meta:
		author = "Microsoft"
...
rule Neo23x0_apt_Trojan_Win32_Plakelog : Platinum
{
	meta:
		author = "Microsoft"
...
rule Neo23x0_apt_Trojan_Win32_Plainst : Platinum
{
	meta:
		author = "Microsoft"
		description = "Installer component"
...
rule Neo23x0_apt_Trojan_Win32_Plagicom : Platinum
{
	meta:
		author = "Microsoft"
		description = "Installer component"
...
rule Neo23x0_apt_Trojan_Win32_Plaklog : Platinum
{
	meta:
		author = "Microsoft"
...
rule Neo23x0_apt_Trojan_Win32_Plapiio : Platinum
{
	meta:
		author = "Microsoft"
...
rule Neo23x0_apt_Trojan_Win32_Plabit : Platinum
{
	meta:
		author = "Microsoft"
		description = "Installer component"
...
rule Neo23x0_apt_Trojan_Win32_Placisc2 : Platinum
{
	meta:
		author = "Microsoft"
		description = "Dipsind variant"
...
rule Neo23x0_apt_Trojan_Win32_Placisc3 : Platinum
{
	meta:
		author = "Microsoft"
		description = "Dipsind variant"
...
rule Neo23x0_apt_Trojan_Win32_Placisc4 : Platinum
{
	meta:
		author = "Microsoft"
...
rule Neo23x0_apt_Trojan_Win32_Plakpers : Platinum
{
	meta:
		author = "Microsoft"
...
rule Neo23x0_apt_Trojan_Win32_Plainst2 : Platinum
{
	meta:
		author = "Microsoft"
		description = "Zc tool"
...
rule Neo23x0_apt_Trojan_Win32_Plakpeer : Platinum
{
	meta:
		author = "Microsoft"

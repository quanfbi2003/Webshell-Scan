...
rule Neo23x0_gen_p0wnedPowerCat {
   meta:
...
rule Neo23x0_gen_Hacktool_Strings_p0wnedShell : FILE {
   meta:
...
rule Neo23x0_gen_p0wnedExploits {
   meta:
...
rule Neo23x0_gen_p0wnedShellx64 {
   meta:
...
rule Neo23x0_gen_p0wnedListenerConsole {
   meta:
...
rule Neo23x0_gen_p0wnedBinaries {
   meta:
...
rule Neo23x0_gen_p0wnedAmsiBypass {
   meta:
...
rule Neo23x0_gen_p0wnedShell_outputs {
   meta:

...
rule Neo23x0_gen_Mimikatz_Memory_Rule_1 : APT {
   meta:
      author = "Florian Roth"
      date = "2014-12-22"
      modified = "2023-07-04"
...
rule Neo23x0_gen_Mimikatz_Memory_Rule_2 : APT {
   meta:
...
rule Neo23x0_gen_mimikatz : FILE {
   meta:
...
rule Neo23x0_gen_power_pe_injection
{
   meta:
...
rule Neo23x0_gen_Mimikatz_Logfile
{
   meta:
...
rule Neo23x0_gen_Mimikatz_Strings {
   meta:
...
rule Neo23x0_gen_HKTL_Mimikatz_SkeletonKey_in_memory_Aug20_1 {
   meta:
...
rule Neo23x0_gen_HKTL_mimikatz_memssp_hookfn {
   meta:
...
rule Neo23x0_gen_HKTL_mimikatz_icon {
    meta:

...
rule Neo23x0_apt_KeyBoys_malware_1 {
   meta:
...
rule Neo23x0_apt_KeyBoy_InstallClient {
   meta:
...
rule Neo23x0_apt_KeyBoy_wab32res {
   meta:
...
rule Neo23x0_apt_KeyBoy_rasauto {
   meta:
...
rule Neo23x0_apt_KeyBoy_876_0x4e20000 {
   meta:

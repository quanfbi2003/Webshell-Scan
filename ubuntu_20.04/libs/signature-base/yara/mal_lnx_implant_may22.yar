...
rule Neo23x0_mal_MAL_LNX_RedMenshen_BPFDoor_May23_1 {
   meta:
...
rule Neo23x0_mal_APT_MAL_LNX_RedMenshen_BPFDoor_Controller_May22_1 {
   meta:
...
rule Neo23x0_mal_APT_MAL_LNX_RedMenshen_BPFDoor_Controller_May22_2 {
   meta:
...
rule Neo23x0_mal_APT_MAL_LNX_RedMenshen_BPFDoor_Controller_May22_3 {
   meta:
      description = "Detects BPFDoor implants used by Chinese actor Red Menshen"
      author = "Florian Roth (Nextron Systems)"
      reference = "https://doublepulsar.com/bpfdoor-an-active-chinese-global-surveillance-tool-54b078f1a896"
...
rule Neo23x0_mal_APT_MAL_LNX_RedMenshen_BPFDoor_Controller_Generic_May22_1 {
   meta:
      description = "Detects BPFDoor malware"
      author = "Florian Roth (Nextron Systems)"
      reference = "https://doublepulsar.com/bpfdoor-an-active-chinese-global-surveillance-tool-54b078f1a896"
...
rule Neo23x0_mal_APT_MAL_LNX_RedMenshen_BPFDoor_Tricephalic_Implant_May22 {

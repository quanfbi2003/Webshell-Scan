...
rule Neo23x0_gen_Msfpayloads_msf {
   meta:
...
rule Neo23x0_gen_Msfpayloads_msf_2 {
   meta:
...
rule Neo23x0_gen_Msfpayloads_msf_psh {
   meta:
...
rule Neo23x0_gen_Msfpayloads_msf_exe {
   meta:
...
rule Neo23x0_gen_Msfpayloads_msf_3 {
   meta:
...
rule Neo23x0_gen_Msfpayloads_msf_4 {
   meta:
...
rule Neo23x0_gen_Msfpayloads_msf_exe_2 {
   meta:
...
rule Neo23x0_gen_Msfpayloads_msf_5 {
   meta:
...
rule Neo23x0_gen_Msfpayloads_msf_6 {
   meta:
...
rule Neo23x0_gen_Msfpayloads_msf_7 {
   meta:
...
rule Neo23x0_gen_Msfpayloads_msf_8 {
   meta:
...
rule Neo23x0_gen_Msfpayloads_msf_cmd {
   meta:
...
rule Neo23x0_gen_Msfpayloads_msf_9 {
   meta:
...
rule Neo23x0_gen_Msfpayloads_msf_10 {
   meta:
...
rule Neo23x0_gen_Msfpayloads_msf_svc {
   meta:
...
rule Neo23x0_gen_Msfpayloads_msf_11 {
   meta:
...
rule Neo23x0_gen_Msfpayloads_msf_ref {
   meta:
...
rule Neo23x0_gen_MAL_Metasploit_Framework_UA {
   meta:
...
rule Neo23x0_gen_HKTL_Meterpreter_inMemory {
   meta:

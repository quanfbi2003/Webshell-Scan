...
rule Neo23x0_apt_IronTiger_ASPXSpy : HIGHVOL
{
	meta:
...
rule Neo23x0_apt_IronTiger_ChangePort_Toolkit_driversinstall
{
	meta:
		author = "Cyber Safety Solutions, Trend Micro"
...
rule Neo23x0_apt_IronTiger_ChangePort_Toolkit_ChangePortExe
{
	meta:
		author = "Cyber Safety Solutions, Trend Micro"
...
rule Neo23x0_apt_IronTiger_dllshellexc2010
{
	meta:
		author = "Cyber Safety Solutions, Trend Micro"
...
rule Neo23x0_apt_IronTiger_dnstunnel
{
	meta:
		author = "Cyber Safety Solutions, Trend Micro"
...
rule Neo23x0_apt_IronTiger_EFH3_encoder
{
	meta:
		author = "Cyber Safety Solutions, Trend Micro"
...
rule Neo23x0_apt_IronTiger_GetPassword_x64
{
	meta:
		author = "Cyber Safety Solutions, Trend Micro"
...
rule Neo23x0_apt_IronTiger_GTalk_Trojan
{
	meta:
		author = "Cyber Safety Solutions, Trend Micro"
...
rule Neo23x0_apt_IronTiger_HTTP_SOCKS_Proxy_soexe
{
	meta:
		author = "Cyber Safety Solutions, Trend Micro"
...
rule Neo23x0_apt_IronTiger_NBDDos_Gh0stvariant_dropper
{
	meta:
		author = "Cyber Safety Solutions, Trend Micro"
...
rule Neo23x0_apt_IronTiger_PlugX_DosEmulator
{
	meta:
...
rule Neo23x0_apt_IronTiger_PlugX_FastProxy
{
	meta:
		author = "Cyber Safety Solutions, Trend Micro"
...
rule Neo23x0_apt_IronTiger_PlugX_Server
{
	meta:
		author = "Cyber Safety Solutions, Trend Micro"
...
rule Neo23x0_apt_IronTiger_ReadPWD86
{
	meta:
		author = "Cyber Safety Solutions, Trend Micro"
...
rule Neo23x0_apt_IronTiger_Ring_Gh0stvariant
{
	meta:
		author = "Cyber Safety Solutions, Trend Micro"
...
rule Neo23x0_apt_IronTiger_wmiexec
{
	meta:
		author = "Cyber Safety Solutions, Trend Micro"

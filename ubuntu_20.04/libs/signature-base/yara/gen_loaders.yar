...
rule Neo23x0_gen_ReflectiveLoader {
   meta:
...
rule Neo23x0_gen_Reflective_DLL_Loader_Aug17_1 {
   meta:
...
rule Neo23x0_gen_DLL_Injector_Lynx {
   meta:
...
rule Neo23x0_gen_Reflective_DLL_Loader_Aug17_2 {
   meta:
...
rule Neo23x0_gen_Reflective_DLL_Loader_Aug17_3 {
   meta:
      description = "Detects Reflective DLL Loader"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_gen_Reflective_DLL_Loader_Aug17_4 {
   meta:
      description = "Detects Reflective DLL Loader"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"

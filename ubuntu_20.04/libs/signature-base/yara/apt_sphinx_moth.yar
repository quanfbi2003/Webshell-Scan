...
rule Neo23x0_apt_Sphinx_Moth_cudacrt { 
    meta:
...
rule Neo23x0_apt_Sphinx_Moth_h2t { 
    meta:
...
rule Neo23x0_apt_Sphinx_Moth_iastor32 { 
    meta:
...
rule Neo23x0_apt_Sphinx_Moth_kerberos32 {
    meta:
...
rule Neo23x0_apt_Sphinx_Moth_kerberos64 { 
    meta:
...
rule Neo23x0_apt_Sphinx_Moth_nvcplex { 
    meta:

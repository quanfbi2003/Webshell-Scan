...
rule Neo23x0_apt_TA17_318A_rc4_stack_key_fallchill {
   meta:
...
rule Neo23x0_apt_TA17_318A_success_fail_codes_fallchill {
   meta:
...
rule Neo23x0_apt_HiddenCobra_FallChill_1 {
   meta:
...
rule Neo23x0_apt_HiddenCobra_FallChill_2 {
   meta:
      description = "Auto-generated rule"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"

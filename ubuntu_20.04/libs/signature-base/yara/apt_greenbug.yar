...
rule Neo23x0_apt_Greenbug_Malware_1 {
   meta:
...
rule Neo23x0_apt_Greenbug_Malware_2 {
   meta:
...
rule Neo23x0_apt_Greenbug_Malware_3 {
   meta:
      description = "Detects Backdoor from Greenbug Incident"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_Greenbug_Malware_4 {
   meta:
...
rule Neo23x0_apt_Greenbug_Malware_5 {
   meta:
...
rule Neo23x0_apt_Greenbug_Malware_Nov17_1 {
   meta:

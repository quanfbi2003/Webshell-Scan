...
rule DarkenCode_APT_whosthere_alt {
	meta:
...
rule DarkenCode_APT_iam_alt_iam_alt {
	meta:
...
rule DarkenCode_APT_genhash_genhash {
	meta:
...
rule DarkenCode_APT_iam_iamdll {
	meta:
...
rule DarkenCode_APT_whosthere_alt_pth {
	meta:

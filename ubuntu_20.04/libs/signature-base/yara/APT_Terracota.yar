...
rule DarkenCode_APT_Apolmy_Privesc_Trojan {
	meta:
...
rule DarkenCode_APT_Mithozhan_Trojan {
	meta:
...
rule DarkenCode_APT_RemoteExec_Tool {
	meta:
...
rule DarkenCode_APT_LiuDoor_Malware_1 {
	meta:
...
rule DarkenCode_APT_LiuDoor_Malware_2 {
	meta:
		description = "Liudoor Trojan used in Terracotta APT"
		author = "Florian Roth"
		reference = "https://blogs.rsa.com/terracotta-vpn-enabler-of-advanced-threat-anonymity/"

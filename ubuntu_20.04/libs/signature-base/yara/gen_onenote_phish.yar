...
rule Neo23x0_gen_SUSP_Email_Suspicious_OneNote_Attachment_Jan23_1 {
   meta:
...
rule Neo23x0_gen_SUSP_Email_Suspicious_OneNote_Attachment_Jan23_2 {
   meta:
...
rule Neo23x0_gen_SUSP_OneNote_Embedded_FileDataStoreObject_Type_Jan23_1 {
   meta:
...
rule Neo23x0_gen_SUSP_OneNote_Embedded_FileDataStoreObject_Type_Jan23_2 {
   meta:
      description = "Detects suspicious embedded file types in OneNote files"
      author = "Florian Roth (Nextron Systems)"
      reference = "https://blog.didierstevens.com/"

...
rule DarkenCode_APT_APT_Malware_PutterPanda_Rel {
	meta:
...
rule DarkenCode_APT_APT_Malware_PutterPanda_Rel_2 {
	meta:
...
rule DarkenCode_APT_APT_Malware_PutterPanda_PSAPI {
	meta:
...
rule DarkenCode_APT_APT_Malware_PutterPanda_WUAUCLT {
	meta:
		description = "Detects a malware related to Putter Panda"
		author = "Florian Roth"
		score = 70
...
rule DarkenCode_APT_APT_Malware_PutterPanda_Gen1 {
	meta:
...
rule DarkenCode_APT_Malware_MsUpdater_String_in_EXE {
	meta:
...
rule DarkenCode_APT_APT_Malware_PutterPanda_MsUpdater_3 {
	meta:
...
rule DarkenCode_APT_APT_Malware_PutterPanda_MsUpdater_1 {
	meta:
		description = "Detects Malware related to PutterPanda - MSUpdater"
		author = "Florian Roth"
		score = 70
...
rule DarkenCode_APT_APT_Malware_PutterPanda_MsUpdater_2 {
	meta:
		description = "Detects Malware related to PutterPanda - MSUpdater"
		author = "Florian Roth"
		score = 70
...
rule DarkenCode_APT_APT_Malware_PutterPanda_Gen4 {
	meta:

...
rule Neo23x0_apt_WaterBug_wipbot_2013_core_PDF {
	meta:
...
rule Neo23x0_apt_WaterBug_wipbot_2013_dll {
	meta:
...
rule Neo23x0_apt_WaterBug_wipbot_2013_core {
	meta:
...
rule Neo23x0_apt_WaterBug_turla_dropper {
	meta:
...
rule Neo23x0_apt_WaterBug_fa_malware {
	meta:

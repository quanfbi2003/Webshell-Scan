...
rule Neo23x0_apt_Apolmy_Privesc_Trojan {
	meta:
...
rule Neo23x0_apt_Mithozhan_Trojan {
	meta:
...
rule Neo23x0_apt_RemoteExec_Tool {
	meta:
...
rule Neo23x0_apt_LiuDoor_Malware_1 {
	meta:
...
rule Neo23x0_apt_LiuDoor_Malware_2 {
	meta:
		description = "Liudoor Trojan used in Terracotta APT"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"

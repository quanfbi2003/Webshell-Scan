...
rule Neo23x0_apt_susp_file_enumerator_with_encrypted_resource_101 {
   meta:
...
rule Neo23x0_apt_StoneDrill_main_sub {
   meta:
...
rule Neo23x0_apt_StoneDrill_BAT_1 {
   meta:
...
rule Neo23x0_apt_StoneDrill_Service_Install {
   meta:
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"
      description = "Rule to detect Batch file from StoneDrill report"
...
rule Neo23x0_apt_StoneDrill_ntssrvr32 {
   meta:
...
rule Neo23x0_apt_StoneDrill_Malware_2 {
   meta:
      description = "Detects malware from StoneDrill threat report"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_StoneDrill_VBS_1 {
   meta:
      description = "Detects malware from StoneDrill threat report"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"

...
rule Neo23x0_gen_PS_AMSI_Bypass : FILE {
   meta:
...
rule Neo23x0_gen_JS_Suspicious_Obfuscation_Dropbox {
   meta:
      description = "Detects PowerShell AMSI Bypass"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_gen_JS_Suspicious_MSHTA_Bypass {
   meta:
...
rule Neo23x0_gen_JavaScript_Run_Suspicious {
   meta:
...
rule Neo23x0_gen_Certutil_Decode_OR_Download {
   meta:
...
rule Neo23x0_gen_Suspicious_JS_script_content {
   meta:
...
rule Neo23x0_gen_Universal_Exploit_Strings {
   meta:
...
rule Neo23x0_gen_VBS_Obfuscated_Mal_Feb18_1  {
   meta:

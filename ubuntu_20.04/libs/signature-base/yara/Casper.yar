...
rule DarkenCode_Cas_Casper_Backdoor_x86 {
	meta:
...
rule DarkenCode_Cas_Casper_EXE_Dropper {
	meta:
...
rule DarkenCode_Cas_Casper_Included_Strings {
	meta:
...
rule DarkenCode_Cas_Casper_SystemInformation_Output {
	meta:

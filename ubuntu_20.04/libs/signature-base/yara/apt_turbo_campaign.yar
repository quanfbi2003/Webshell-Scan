...
rule Neo23x0_apt_apt_nix_elf_derusbi {
   meta:
...
rule Neo23x0_apt_apt_nix_elf_derusbi_kernelModule
{
   meta:
...
rule Neo23x0_apt_apt_nix_elf_Derusbi_Linux_SharedMemCreation {
   meta:
...
rule Neo23x0_apt_apt_nix_elf_Derusbi_Linux_Strings {
   meta:
...
rule Neo23x0_apt_apt_win_exe_trojan_derusbi {
   meta:

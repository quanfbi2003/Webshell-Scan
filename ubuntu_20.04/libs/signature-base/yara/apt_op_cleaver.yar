...
rule Neo23x0_apt_OPCLEAVER_BackDoorLogger
{
	meta:
...
rule Neo23x0_apt_OPCLEAVER_Jasus
{
	meta:
...
rule Neo23x0_apt_OPCLEAVER_LoggerModule
{
	meta:
		description = "Keylogger used by attackers in Operation Cleaver"
		reference = "http://cylance.com/assets/Cleaver/Cylance_Operation_Cleaver_Report.pdf"
...
rule Neo23x0_apt_OPCLEAVER_NetC
{
	meta:
...
rule Neo23x0_apt_OPCLEAVER_ShellCreator2
{
	meta:
...
rule Neo23x0_apt_OPCLEAVER_SmartCopy2
{
	meta:
...
rule Neo23x0_apt_OPCLEAVER_SynFlooder
{
	meta:
		description = "Malware or hack tool used by attackers in Operation Cleaver"
		reference = "http://cylance.com/assets/Cleaver/Cylance_Operation_Cleaver_Report.pdf"
...
rule Neo23x0_apt_OPCLEAVER_TinyZBot
{
	meta:
...
rule Neo23x0_apt_OPCLEAVER_ZhoupinExploitCrew
{
	meta:
...
rule Neo23x0_apt_OPCLEAVER_antivirusdetector
{
	meta:
...
rule Neo23x0_apt_OPCLEAVER_csext
{
	meta:
...
rule Neo23x0_apt_OPCLEAVER_kagent
{
	meta:
		description = "Backdoor used by attackers in Operation Cleaver"
		reference = "http://cylance.com/assets/Cleaver/Cylance_Operation_Cleaver_Report.pdf"
...
rule Neo23x0_apt_OPCLEAVER_mimikatzWrapper
{
	meta:
...
rule Neo23x0_apt_OPCLEAVER_pvz_in
{
	meta:
...
rule Neo23x0_apt_OPCLEAVER_pvz_out
{
	meta:
		description = "Parviz tool used by attackers in Operation Cleaver"
		reference = "http://cylance.com/assets/Cleaver/Cylance_Operation_Cleaver_Report.pdf"
...
rule Neo23x0_apt_OPCLEAVER_wndTest
{
	meta:
		description = "Backdoor used by attackers in Operation Cleaver"
		reference = "http://cylance.com/assets/Cleaver/Cylance_Operation_Cleaver_Report.pdf"
...
rule Neo23x0_apt_OPCLEAVER_zhCat
{
	meta:
...
rule Neo23x0_apt_OPCLEAVER_zhLookUp
{
	meta:
		description = "Hack tool used by attackers in Operation Cleaver"
		reference = "http://cylance.com/assets/Cleaver/Cylance_Operation_Cleaver_Report.pdf"
...
rule Neo23x0_apt_OPCLEAVER_zhmimikatz
{
	meta:
		description = "Mimikatz wrapper used by attackers in Operation Cleaver"
		reference = "http://cylance.com/assets/Cleaver/Cylance_Operation_Cleaver_Report.pdf"
...
rule Neo23x0_apt_OPCLEAVER_Parviz_Developer
{
	meta:
...
rule Neo23x0_apt_OPCLEAVER_CCProxy_Config
{
	meta:

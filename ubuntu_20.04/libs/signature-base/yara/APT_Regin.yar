...
rule DarkenCode_APT_Regin_APT_KernelDriver_Generic_A {
	meta:
...
rule DarkenCode_APT_Regin_APT_KernelDriver_Generic_B {
	meta:
		description = "Generic rule for Regin APT kernel driver Malware - Symantec http://t.co/qu53359Cb2"
		author = "@Malwrsignatures - included in APT Scanner THOR"
		date = "23.11.14"
...
rule DarkenCode_APT_Regin_APT_KernelDriver_Generic_C {
	meta:
		description = "Generic rule for Regin APT kernel driver Malware - Symantec http://t.co/qu53359Cb2"
		author = "@Malwrsignatures - included in APT Scanner THOR"
		date = "23.11.14"
...
rule DarkenCode_APT_Regin_sig_svcsstat {
	meta:
...
rule DarkenCode_APT_Regin_Sample_1 {
	meta:
...
rule DarkenCode_APT_Regin_Sample_2 {
	meta:
...
rule DarkenCode_APT_Regin_Sample_3 {
	meta:
...
rule DarkenCode_APT_Regin_Sample_Set_1 {
	meta:
...
rule DarkenCode_APT_Regin_Sample_Set_2 {
	meta:
...
rule DarkenCode_APT_apt_regin_legspin {
	meta:
...
rule DarkenCode_APT_apt_regin_hopscotch {
	meta:
	    copyright = "Kaspersky Lab"
...
rule DarkenCode_APT_apt_regin_2011_32bit_stage1 {
meta:
copyright = "Kaspersky Lab"
...
rule DarkenCode_APT_apt_regin_rc5key {
meta:
copyright = "Kaspersky Lab"
...
rule DarkenCode_APT_apt_regin_vfs {
meta:
	copyright = "Kaspersky Lab"
...
rule DarkenCode_APT_apt_regin_dispatcher_disp_dll {
...
rule DarkenCode_APT_apt_regin_2013_64bit_stage1 {
meta:
copyright = "Kaspersky Lab"

...
rule Neo23x0_apt_APT_APT41_POISONPLUG_3 {
   meta:
...
rule Neo23x0_apt_APT_APT41_POISONPLUG_SHADOW {
   meta:
...
rule Neo23x0_apt_APT_APT41_CRACKSHOT {
   meta:
...
rule Neo23x0_apt_APT_APT41_POISONPLUG_2 {
   meta:
      description = "Detects APT41 malware POISONPLUG"
      author = "Florian Roth (Nextron Systems)"
      reference = "https://www.fireeye.com/blog/threat-research/2019/08/apt41-dual-espionage-and-cyber-crime-operation.html"
...
rule Neo23x0_apt_APT_APT41_POISONPLUG {
   meta:
      description = "Detects APT41 malware POISONPLUG"
      author = "Florian Roth (Nextron Systems)"
      reference = "https://www.fireeye.com/blog/threat-research/2019/08/apt41-dual-espionage-and-cyber-crime-operation.html"
...
rule Neo23x0_apt_APT_APT41_HIGHNOON {
   meta:
...
rule Neo23x0_apt_APT_APT41_HIGHNOON_2 {
   meta:
      description = "Detects APT41 malware HIGHNOON"
      author = "Florian Roth (Nextron Systems)"
      reference = "https://www.fireeye.com/blog/threat-research/2019/08/apt41-dual-espionage-and-cyber-crime-operation.html"
...
rule Neo23x0_apt_APT_APT41_HIGHNOON_BIN {
   meta:
...
rule Neo23x0_apt_APT_APT41_HIGHNOON_BIN_2 {
   meta:
      description = "Detects APT41 malware HIGHNOON.BIN"
      author = "Florian Roth (Nextron Systems)"
      reference = "https://www.fireeye.com/blog/threat-research/2019/08/apt41-dual-espionage-and-cyber-crime-operation.html"
...
rule Neo23x0_apt_APT_APT41_RevokedCert_Aug19_1 {
   meta:
...
rule Neo23x0_apt_APT_APT41_CN_ELF_Speculoos_Backdoor {
   meta:

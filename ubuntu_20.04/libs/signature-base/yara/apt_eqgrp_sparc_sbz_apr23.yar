...
rule Neo23x0_apt_SUSP_ELF_SPARC_Hunting_SBZ_Obfuscation {
   meta:
...
rule Neo23x0_apt_SUSP_ELF_SPARC_Hunting_SBZ_UniqueStrings {
   meta:
      description = "This rule is UNTESTED against a large dataset and is for hunting purposes only."
...
rule Neo23x0_apt_SUSP_ELF_SPARC_Hunting_SBZ_ModuleStruct {
   meta:
      description = "This rule is UNTESTED against a large dataset and is for hunting purposes only."

...
rule Neo23x0_cri_CobaltStrike_CN_Group_BeaconDropper_Aug17 {
   meta:
...
rule Neo23x0_cri_CobaltGang_Malware_Aug17_1 {
   meta:
...
rule Neo23x0_cri_CobaltGang_Malware_Aug17_2 {
   meta:
      description = "Detects a Cobalt Gang malware"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_cri_MAL_CRIME_CobaltGang_Malware_Oct19_1 {
   meta:

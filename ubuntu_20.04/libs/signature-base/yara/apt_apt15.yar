...
rule Neo23x0_apt_APT15_Malware_Mar18_RoyalCli {
   meta:
...
rule Neo23x0_apt_APT15_Malware_Mar18_RoyalDNS {
   meta:
      description = "Detects malware from APT 15 report by NCC Group"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_APT15_Malware_Mar18_BS2005 {
   meta:
      description = "Detects malware from APT 15 report by NCC Group"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_APT15_Malware_Mar18_MSExchangeTool {
   meta:
      description = "Detects malware from APT 15 report by NCC Group"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"
...
rule Neo23x0_apt_clean_apt15_patchedcmd{
   meta:
      author = "Ahmed Zaki"
...
rule Neo23x0_apt_malware_apt15_royalcli_1{
   meta:
...
rule Neo23x0_apt_malware_apt15_royalcli_2{
   meta:
...
rule Neo23x0_apt_malware_apt15_bs2005{
   meta:
      author = "Ahmed Zaki"
...
rule Neo23x0_apt_malware_apt15_royaldll {
   meta:
      author = "David Cannings"
...
rule Neo23x0_apt_malware_apt15_royaldll_2 {
   meta:
      author = "Ahmed Zaki"
      sha256 = "bc937f6e958b339f6925023bc2af375d669084e9551fd3753e501ef26e36b39d"
...
rule Neo23x0_apt_malware_apt15_exchange_tool {
   meta:
      author = "Ahmed Zaki"
...
rule Neo23x0_apt_malware_apt15_generic {
   meta:
      author = "David Cannings"
